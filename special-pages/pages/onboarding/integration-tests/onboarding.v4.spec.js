...
test.describe('onboarding v4', () => {
    ...
    test('shows v4 flow without system settings step', async ({ page }, workerInfo) => {
        const onboarding = OnboardingV4Page.create(page, workerInfo);
        onboarding.withInitData({
            stepDefinitions: null,
            order: 'v4',
    ...
    test('shows v4 flow with ad blocking', async ({ page }, workerInfo) => {
        const onboarding = OnboardingV4Page.create(page, workerInfo);
        onboarding.withInitData({
            stepDefinitions: {
                systemSettings: {
    ...
    test('shows v4 flow with ad blocking disabled', async ({ page }, workerInfo) => {
        const onboarding = OnboardingV4Page.create(page, workerInfo);
        onboarding.withInitData({
            stepDefinitions: {
                systemSettings: {
    ...
    test('shows v4 flow with ad blocking (YouTube variant)', async ({ page }, workerInfo) => {
        const onboarding = OnboardingV4Page.create(page, workerInfo);
        onboarding.withInitData({
            stepDefinitions: {
                systemSettings: {
    ...
    test('shows v4 flow with ad blocking disabled (YouTube variant)', async ({ page }, workerInfo) => {
        const onboarding = OnboardingV4Page.create(page, workerInfo);
        onboarding.withInitData({
            stepDefinitions: {
                systemSettings: {
