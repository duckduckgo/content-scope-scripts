        ...
        <div className={classes}>
            <Stack animate>
                ...
                { content &&
                    <StepGrid
                        progress={progress}
                        dismissButton={dismissButton && <ElasticButton {...dismissButton} elastic={false} variant="secondary" onClick={dismissButton.handler} />}
                        acceptButton={acceptButton && <ElasticButton {...acceptButton} elastic={true} variant="primary" onClick={acceptButton.handler} />}>
                        {content}
                    </StepGrid>}
            </Stack>
        </div>
