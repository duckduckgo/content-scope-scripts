...
import enStrings from '../public/locales/en/set-as-default.json';
...
/**
 * @param {import("../src/index.js").SetAsDefaultPage} messaging
...
export async function init(messaging, baseEnvironment) {
    ...
    const strings =
        environment.locale === 'en'
            ? enStrings
            : await fetch(`./locales/${environment.locale}/set-as-default.json`)
                  .then((resp) => {
                      if (!resp.ok) {
