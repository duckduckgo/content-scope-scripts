...
import { isTabLimitExceeded, selectAttachedOpenTabs } from './tabAttachments.logic.js';
...
export function useTabAttachments(tabId, maxTabs = Number.POSITIVE_INFINITY) {
    ...
    const attachedTabs = useMemo(() => selectAttachedOpenTabs(attachedEntries, openTabs), [attachedEntries, openTabs]);
