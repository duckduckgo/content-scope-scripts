...
export function OpenAIIcon(props) {
    return (
        <svg width="16" height="16" fill="none" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" {...props}>
            <g clip-path="url(#aiModelOpenAI_a)">
                <path
                    fill="currentColor"
...
/**
 * From DesignResourcesKit Ai-Model-Claude-16.svg
 * @param {import('preact').JSX.SVGAttributes<SVGSVGElement>} props
 */
export function ClaudeIcon(props) {
    return (
        <svg width="16" height="16" fill="none" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" {...props}>
            <g clip-path="url(#aiModelClaude_a)">
                <path
                    fill="currentColor"
...
/**
 * From DesignResourcesKit AI-Model-Llama-16.svg
 * @param {import('preact').JSX.SVGAttributes<SVGSVGElement>} props
 */
export function LlamaIcon(props) {
    return (
        <svg width="16" height="16" fill="none" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" {...props}>
            <path fill="currentColor" d="M14 7H7L6 2V0h-.5L5 1H1v2l3 1v12h2v-3h5v3h2v-6h1v1h1V8z" />
        </svg>
    );
}

/**
 * From DesignResourcesKit Ai-Model-Mistral-16.svg
 * @param {import('preact').JSX.SVGAttributes<SVGSVGElement>} props
 */
export function MistralIcon(props) {
    return (
        <svg width="16" height="16" fill="none" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" {...props}>
            <path
                fill="currentColor"
...
/**
 * From DesignResourcesKit AI-Model-OSS-16.svg
 * @param {import('preact').JSX.SVGAttributes<SVGSVGElement>} props
 */
export function OSSIcon(props) {
    return (
        <svg width="16" height="16" fill="none" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" {...props}>
            <g clip-path="url(#aiModelOSS_a)">
                <path
                    fill="currentColor"
