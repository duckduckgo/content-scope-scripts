    ...
    return (
        <svg width="16" height="16" fill="none" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" {...props}>
            <g transform="translate(1, 3)">
                <path
                    d="M0.914 0.137c.327-.136.688-.172 1.035-.103.347.07.667.24.918.49.25.251.421.571.49.918.069.347.033.708-.102 1.035a1.874 1.874 0 0 1-.66.804 1.876 1.876 0 0 1-.993.3H.625A.625.625 0 0 1 0 2.958c0-.345.28-.625.625-.625h.975a.626.626 0 0 0 .5-.866.626.626 0 0 0-1.058-.175.625.625 0 0 1-.932-.868c.197-.294.477-.524.804-.659Z"
                    fill="currentColor"
                    fill-opacity="0.84"
                />
                <path d="M13.375 1.002a.625.625 0 0 1 0 1.25H5.625a.625.625 0 0 1 0-1.25h7.75Z" fill="currentColor" fill-opacity="0.84" />
                <path
                    d="M0.914 7.097c.327-.136.688-.172 1.035-.103.347.069.667.24.918.49.25.251.421.571.49.918.069.347.033.708-.102 1.035a1.874 1.874 0 0 1-.66.804 1.876 1.876 0 0 1-.993.3H.625A.625.625 0 0 1 0 9.918c0-.345.28-.625.625-.625h.975a.626.626 0 0 0 .5-.866.626.626 0 0 0-1.058-.175.625.625 0 0 1-.932-.868c.197-.294.477-.524.804-.659Z"
                    fill="currentColor"
                    fill-opacity="0.84"
                />
                <path d="M10.375 8.001a.625.625 0 0 1 0 1.25H5.625a.625.625 0 0 1 0-1.25h4.75Z" fill="currentColor" fill-opacity="0.84" />
            </g>
        </svg>
    );
}
