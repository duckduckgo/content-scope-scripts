...
/**
 * Custom popover icon from Figma
 * @param {import('preact').JSX.SVGAttributes<SVGSVGElement>} props
 */
export function PopoverCustomizeIcon(props) {
    return (
        <svg fill="none" viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg" {...props}>
            <path fill="url(#NewTab-Options-96_svg__a)" d="M46 78a5 5 0 0 0 5-5v-2c0-11.046 8.954-20 20-20h5a4 4 0 0 0 4-4V26a8 8 0 0 0-8-8H29a8 8 0 0 0-8 8v44a8 8 0 0 0 8 8z"/>
            <path fill="url(#NewTab-Options-96_svg__b)" d="M47 78a4 4 0 0 0 4-4v-3c0-11.046 8.954-20 20-20h4V26a8 8 0 0 0-8-8H24a8 8 0 0 0-8 8v44a8 8 0 0 0 8 8z"/>
            <path fill="url(#NewTab-Options-96_svg__c)" d="M37 32.5a8.5 8.5 0 1 1 17 0 8.5 8.5 0 0 1-17 0"/>
            <path fill="#fff" d="M43.803 38.342c.666.246 2.106.306 2.889.03a39 39 0 0 1-.439-1.023c-.32.076-.742.084-.84-.08-.368.319-1.073.78-1.22.683-.282-.184-.548-1.606-.336-1.907.322-.293 1.001.026 1.477.194.066-.112.237-.193.427-.237-.23-.766-.3-1.384-.002-1.568-.894-.257-1.587-.775-1.41-1.529.145-1.031 2.095-.709 2.967-.825q.011 0 .023-.003c.107-.701-.213-3.252-1.98-3.638-1.843-2.28-3.598.321-2.708.143.71-.177 1.238-.014 1.216-.007-3.904.493-.71 8.01-.48 9.587.085.116.267.115.413.17zm3-8.375c-.325-.174-.608-.085-.762-.036-.087.027-.133.041-.122-.014.128-.265.788-.267.918.01.017.024-.008.051-.034.04m-4.06.388c-.017.028-.084.024-.084-.01.017-.443.77-.657 1.044-.381.033.041-.016.038-.104.031-.123-.009-.323-.023-.488.069-.242.103-.32.215-.367.29Zm3.858 1.13c-.506-.003-.506-.783 0-.787.507.003.507.785 0 .787m-2.57-.12c-.01.602-.893.602-.904 0 .003-.6.901-.6.905 0Z"/>
            <path fill="#fff" d="M47.964 37.2c-.02.127-.064.212-.142.224-.15.023-.815-.13-1.193-.273-.043.198-1.056.385-1.217.12-.368.317-1.072.778-1.22.682-.282-.185-.547-1.607-.335-1.908.323-.293 1.001.026 1.477.194.161-.272.942-.376 1.104-.152.428-.325 1.14-.783 1.21-.7.347.418.39 1.412.316 1.813" opacity=".5"/>
            <path fill="#fff" fillRule="evenodd" d="M44.35 32.905c.145-1.032 2.094-.709 2.966-.825a5.6 5.6 0 0 0 1.42-.352c.721-.296.844-.002.491.46-.995 1.18-3.208.32-3.605.93-.115.181-.026.607.885.74 1.23.181 2.24-.217 2.365.024-.28 1.288-4.95.85-4.523-.977Z" clipRule="evenodd" opacity=".7"/>
            <path fill="#fff" fillRule="evenodd" d="M45.5 26.89a5.61 5.61 0 1 0 0 11.22 5.61 5.61 0 0 0 0-11.22M39 32.5a6.5 6.5 0 1 1 13 0 6.5 6.5 0 0 1-13 0" clipRule="evenodd"/>
            <path fill="#000" fillOpacity=".1" d="M62.273 53a19.9 19.9 0 0 1 6.083-1.825A4 4 0 0 0 65 45H26a4 4 0 0 0 0 8z"/>
            <path fill="#fff" d="M65 51a4 4 0 0 0 0-8H26a4 4 0 0 0 0 8z"/>
            <path fill="#fff" fillOpacity=".6" d="M31 64a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2zm11 0a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2zm10.26 0A20 20 0 0 1 55 58.999V58a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2z"/>
            <path fill="#000" fillOpacity=".1" d="M32 68a1 1 0 1 0 0-2h-6a1 1 0 1 0 0 2zm11 0a1 1 0 1 0 0-2h-6a1 1 0 1 0 0 2zm8.224 0q.153-1.018.407-2H48a1 1 0 1 0 0 2z"/>
            ...
            <path fill="#fff" d="M75.5 72a4.5 4.5 0 1 1-4.242 6H62.5a1.5 1.5 0 0 1 0-3h8.758a4.5 4.5 0 0 1 4.242-3m-9-11a4.5 4.5 0 0 1 4.242 3H79.5a1.5 1.5 0 0 1 0 3h-8.758a4.5 4.5 0 1 1-4.242-6"/>
            <defs>
                <linearGradient id="NewTab-Options-96_svg__a" x1="50.5" x2="50.5" y1="78" y2="18" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#e46f4f"/>
                    <stop offset="1" stopColor="#876ecb"/>
                </linearGradient>
                <linearGradient id="NewTab-Options-96_svg__b" x1="27" x2="67.5" y1="75.5" y2="19" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#f8bbaa"/>
                    <stop offset="1" stopColor="#a591dc"/>
                </linearGradient>
                <linearGradient id="NewTab-Options-96_svg__c" x1="42.667" x2="49.467" y1="41" y2="24.567" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#eb876c"/>
                    <stop offset="1" stopColor="#6b4eba"/>
                </linearGradient>
            </defs>
        </svg>
    );
