...
/**
 * Trash glyph (inlined so it can use `currentColor`).
 * @param {import('preact').JSX.SVGAttributes<SVGSVGElement>} props
 */
export function TrashIcon(props) {
    return (
        <svg fill="none" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" {...props} data-testid="TrashIcon">
            <path
                fill="currentColor"
