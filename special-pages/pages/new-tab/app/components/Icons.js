    ...
    return (
        <svg width="16" height="16" fill="none" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" {...props}>
            <g transform="translate(8,8) rotate(-135) translate(-8.59,-5.34)">
                <path
                    fill="currentColor"
                    d="M0 5.339C0 2.39 2.39 0 5.34 0h6.976l.032.001c.33.018.593.29.593.625 0 .334-.263.607-.593.624l-.032.001H5.34A4.089 4.089 0 0 0 1.25 5.34a4.089 4.089 0 0 0 4.089 4.089h7.92a3.175 3.175 0 0 0 0-6.35H7.605c-.73 0-1.333.569-1.376 1.297a1.376 1.376 0 0 0 1.376 1.46h2.118l.032.001c.33.017.593.29.593.625 0 .334-.263.607-.593.624l-.032.001H7.605a2.625 2.625 0 0 1-.624-5.18 2.625 2.625 0 0 1 .624-.074h5.654a4.425 4.425 0 0 1 0 8.85H5.34C2.39 10.678 0 8.288 0 5.339Z"
                />
            </g>
        </svg>
    );
