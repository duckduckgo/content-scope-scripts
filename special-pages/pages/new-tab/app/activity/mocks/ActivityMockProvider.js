...
import { ActivityContext, ActivityDispatchContext } from '../ActivityProvider.js';
...
export function ActivityMockProvider({
    ...
    return (
        <ActivityContext.Provider value={{ state, toggle }}>
            <ActivityDispatchContext.Provider value={send}>{children}</ActivityDispatchContext.Provider>
