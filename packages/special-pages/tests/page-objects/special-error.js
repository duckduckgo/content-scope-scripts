...
import { sampleData } from '../../pages/special-error/src/js/sampleData.js'
    ...
    async openPage (errorType = 'ssl') {
        ...
        await this.page.route('/**', (route, req) => {
            ...
            if (filepath === '/') {
                ...
                const next = html.replace('$LOAD_TIME_DATA$', JSON.stringify(sampleData[errorType])) // Strings File
