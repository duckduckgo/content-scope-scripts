 ...
 * @property {() => import('./BeforeAfterProvider').BeforeAfter|null} get - Gets current before/after state
 * @property {(value: import('./BeforeAfterProvider').BeforeAfter) => void} set - Sets before/after state
