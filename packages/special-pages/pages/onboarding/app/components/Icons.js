...
export function BounceIn ({ children, delay = 'none' }) {
    return <div className={styles.bounceIn} data-delay={delay}>{children}</div>
}
...
export function FadeIn ({ children, delay = 'none' }) {
    return <div className={styles.fadeIn} data-delay={delay}>{children}</div>
}
...
export function SlideIn ({ children, delay = 'none' }) {
    return <div className={styles.slideIn} data-delay={delay}>{children}</div>
}
...
export function SlideUp ({ children, delay = 'none' }) {
    return <div className={styles.slideUp} data-delay={delay}>{children}</div>
}
        ...
        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg" style={direction === 'forward' ? { transform: 'scale(-1,1)' } : {}}>
            <g clip-path="url(#clip0_10021_2837)">
                <path
                    ...
                    fill="currentColor" fill-opacity="0.84"/>
            </g>
            <defs>
