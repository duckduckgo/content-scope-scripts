...
(() => {
  ...
  var AutofillImport = class extends ActionExecutorBase {
    ...
    get exportButtonLabelTextSelector() {
      return __privateGet(this, _exportButtonSettings)?.labelTexts.map(
        /** @param {string} text */
        (text) => `button[aria-label="${text}"]`
      ).join(",");
    }
    /**
     * @returns {string}
    ...
    get signinLabelTextSelector() {
      return __privateGet(this, _signInButtonSettings)?.labelTexts.map(
        /** @param {string} text */
        (text) => `a[aria-label="${text}"]:not([target="_top"])`
      ).join(",");
    }
    /**
     * @returns {string}
    ...
    get settingsLabelTextSelector() {
      return __privateGet(this, _settingsButtonSettings)?.labelTexts.map(
        /** @param {string} text */
        (text) => `a[aria-label="${text}"]`
      ).join(",");
    }
    /**
     * @returns {string}
