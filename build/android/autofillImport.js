...
(() => {
  ...
  var AutofillImport = class extends ActionExecutorBase {
    constructor() {
      ...
      __privateAdd(this, _elementToCenterOn, null);
      /** @type {HTMLElement|null} */
      __privateAdd(this, _currentOverlay, null);
      /** @type {ElementConfig|null} */
      __privateAdd(this, _currentElementConfig, null);
      /** @type {Promise<void>} */
      __privateAdd(this, _domLoaded, Promise.resolve());
      /** @type {boolean} */
      __privateAdd(this, _processingBookmark, false);
    ...
    get bookmarkImportActionSettings() {
      return (
        /** @type {Array<import('./broker-protection/types.js').PirAction>} */
        this.getFeatureSetting("actions") || []
      );
    }
    /**
    ...
    get signinButtonSelector() {
      return [__privateGet(this, _signInButtonSettings)?.selectors?.join(",") ?? "", this.signinLabelTextSelector].filter(Boolean).join(", ");
    }
    /**
     * @returns {string}
     */
    ...
    get settingsButtonSelector() {
      return [__privateGet(this, _settingsButtonSettings)?.selectors?.join(",") ?? "", this.settingsLabelTextSelector].filter(Boolean).join(", ");
    }
    ...
    async handleBookmarkImportPath(pathname) {
      if (pathname === "/" && !__privateGet(this, _isBookmarkModalVisible)) {
        ...
        if (exportId != null && exportId !== "") {
          ...
          __privateSet(this, _processingBookmark, false);
        }
