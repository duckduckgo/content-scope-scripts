...
(() => {
  ...
  // src/utils/web-interference-detection/detector-service.js
  init_define_import_meta_trackerLookup();

  // src/utils/web-interference-detection/interference-types/bot-detection.js
  init_define_import_meta_trackerLookup();

  // src/utils/web-interference-detection/vendors/cloudflare.js
  init_define_import_meta_trackerLookup();
  var TURNSTILE_SELECTORS = [".cf-turnstile"];
  var TURNSTILE_WINDOW_OBJECTS = ["turnstile"];
  var CHALLENGE_PAGE_SELECTORS = ["#challenge-form", ".cf-browser-verification", "#cf-wrapper"];
  var CHALLENGE_PAGE_WINDOW_OBJECTS = ["_cf_chl_opt", "__CF$cv$params", "cfjsd"];
  function detectCloudflareTurnstile() {
  ...
  function detectCloudflareChallengePage() {
  ...
  // src/utils/web-interference-detection/vendors/hcaptcha.js
  init_define_import_meta_trackerLookup();
  var DOM_SELECTORS = [".h-captcha", "[data-hcaptcha-widget-id]"];
  var SCRIPT_DOMAINS = ["hcaptcha.com", "assets.hcaptcha.com"];
  var WINDOW_OBJECTS = ["hcaptcha"];
  function detectDOM() {
  ...
  // src/utils/web-interference-detection/interference-monitor.js
  init_define_import_meta_trackerLookup();
  var _InterferenceMonitor = class _InterferenceMonitor {
    ...
    static getInstance({ detectFn }) {
      if (!_InterferenceMonitor.instance) {
        _InterferenceMonitor.instance = new _InterferenceMonitor({ detectFn });
      }
      return _InterferenceMonitor.instance;
    }
  ...
  __publicField(_InterferenceMonitor, "instance");
  var InterferenceMonitor = _InterferenceMonitor;
  ...
  function detectTypes(types) {
    return Object.fromEntries(
      types.map((type) => [type, typeDetectorsMap[type]()])
    );
  }
  function detectWebInterference(config) {
