...
(() => {
  ...
  function processConfig(data2, userList, preferences, platformSpecificFeatures2 = []) {
    ...
    output.trackerLookup = define_import_meta_trackerLookup_default;
  ...
  var ContentFeature = class {
    ...
    _createMessagingContext() {
      const injectName = "android-broker-protection";
  ...
  function load(args) {
    ...
    const featureNames = true ? platformSupport["android-broker-protection"] : [];
    for (const featureName of featureNames) {
      const ContentFeature2 = ddg_platformFeatures_default["ddg_feature_" + featureName];
      const featureInstance = new ContentFeature2(featureName);
