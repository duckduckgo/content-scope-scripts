...
(() => {
  ...
  // src/trackers.js
  function isTrackerOrigin(trackerLookup3, originHostname = document.location.hostname) {
    const parts = originHostname.split(".").reverse();
    let node = trackerLookup3;
  ...
  function load(args) {
    ...
    const featureNames = true ? platformSupport["firefox"] : [];
  ...
  var trackerLookup2 = $TRACKER_LOOKUP$;
  load({
    platform: {
      name: "extension"
    },
    trackerLookup: trackerLookup2,
    documentOriginIsTracker: isTrackerOrigin(trackerLookup2),
...
/*# sourceURL=duckduckgo-privacy-protection.js?scope=undefined */
