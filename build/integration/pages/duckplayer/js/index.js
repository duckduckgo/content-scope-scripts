...
(() => {
  ...
  function $(n2, l3, u3, t3, i3, r3, o3, e3, f3, c3, s3) {
    ...
    for (f3 = I(u3, l3, g3, f3), a3 = 0; a3 < m3; a3++) null != (y3 = u3.__k[a3]) && (h3 = -1 === y3.__i ? p : g3[y3.__i] || p, y3.__i = a3, _3 = j(n2, y3, h3, i3, r3, o3, e3, f3, c3, s3), d3 = y3.__e, y3.ref && h3.ref != y3.ref && (h3.ref && V(h3.ref, null, y3), s3.push(y3.ref, y3.__c || d3, y3)), null == w3 && null != d3 && (w3 = d3), 4 & y3.__u || h3.__k === y3.__k ? f3 = H(y3, f3, n2) : "function" == typeof y3.type && void 0 !== _3 ? f3 = _3 : d3 && (f3 = d3.nextSibling), y3.__u &= -7);
    return u3.__e = w3, f3;
  }
  function I(n2, l3, u3, t3) {
    var i3, r3, o3, e3, f3, c3 = l3.length, s3 = u3.length, a3 = s3, h3 = 0;
    for (n2.__k = [], i3 = 0; i3 < c3; i3++) null != (r3 = l3[i3]) && "boolean" != typeof r3 && "function" != typeof r3 ? (e3 = i3 + h3, (r3 = n2.__k[i3] = "string" == typeof r3 || "number" == typeof r3 || "bigint" == typeof r3 || r3.constructor == String ? m(null, r3, null, null, null) : d(r3) ? m(k, { children: r3 }, null, null, null) : void 0 === r3.constructor && r3.__b > 0 ? m(r3.type, r3.props, r3.key, r3.ref ? r3.ref : null, r3.__v) : r3).__ = n2, r3.__b = n2.__b + 1, o3 = null, -1 !== (f3 = r3.__i = T(r3, u3, e3, a3)) && (a3--, (o3 = u3[f3]) && (o3.__u |= 2)), null == o3 || null === o3.__v ? (-1 == f3 && h3--, "function" != typeof r3.type && (r3.__u |= 4)) : f3 !== e3 && (f3 == e3 - 1 ? h3-- : f3 == e3 + 1 ? h3++ : (f3 > e3 ? h3-- : h3++, r3.__u |= 4))) : r3 = n2.__k[i3] = null;
    if (a3) for (i3 = 0; i3 < s3; i3++) null != (o3 = u3[i3]) && 0 == (2 & o3.__u) && (o3.__e == t3 && (t3 = C(o3)), q(o3, o3));
    return t3;
  }
  function H(n2, l3, u3) {
    var t3, i3;
    if ("function" == typeof n2.type) {
      for (t3 = n2.__k, i3 = 0; t3 && i3 < t3.length; i3++) t3[i3] && (t3[i3].__ = n2, l3 = H(t3[i3], l3, u3));
      return l3;
    }
  ...
  function T(n2, l3, u3, t3) {
    var i3 = n2.key, r3 = n2.type, o3 = u3 - 1, e3 = u3 + 1, f3 = l3[u3];
    if (null === f3 || f3 && i3 == f3.key && r3 === f3.type && 0 == (2 & f3.__u)) return u3;
    if (("function" != typeof r3 || r3 === k || i3) && t3 > (null != f3 && 0 == (2 & f3.__u) ? 1 : 0)) for (; o3 >= 0 || e3 < l3.length; ) {
      if (o3 >= 0) {
        if ((f3 = l3[o3]) && 0 == (2 & f3.__u) && i3 == f3.key && r3 === f3.type) return o3;
        o3--;
      }
      if (e3 < l3.length) {
        if ((f3 = l3[e3]) && 0 == (2 & f3.__u) && i3 == f3.key && r3 === f3.type) return e3;
        e3++;
      }
    }
    return -1;
  ...
  function F(n2, l3, u3, t3, i3) {
    ...
    n: if ("style" === l3) if ("string" == typeof u3) n2.style.cssText = u3;
      ...
      if ("string" == typeof t3 && (n2.style.cssText = t3 = ""), t3) for (l3 in t3) u3 && l3 in u3 || A(n2.style, l3, "");
      if (u3) for (l3 in u3) t3 && u3[l3] === t3[l3] || A(n2.style, l3, u3[l3]);
    }
  ...
  function j(n2, u3, t3, i3, r3, o3, e3, f3, c3, s3) {
    var a3, h3, p3, v3, y3, g3, m3, b, C3, S2, M2, P2, I2, H2, L, T3, A3, F2 = u3.type;
    ...
    n: if ("function" == typeof F2) try {
      ...
      if (h3.context = M2, h3.props = b, h3.__P = n2, h3.__e = false, I2 = l.__r, H2 = 0, C3) {
        for (h3.state = h3.__s, h3.__d = false, I2 && I2(u3), a3 = h3.render(h3.props, h3.state, h3.context), L = 0; L < h3._sb.length; L++) h3.__h.push(h3._sb[L]);
        h3._sb = [];
      } else do {
        h3.__d = false, I2 && I2(u3), a3 = h3.render(h3.props, h3.state, h3.context), h3.state = h3.__s;
      } while (h3.__d && ++H2 < 25);
      h3.state = h3.__s, null != h3.getChildContext && (i3 = w(w({}, i3), h3.getChildContext())), C3 && !p3 && null != h3.getSnapshotBeforeUpdate && (g3 = h3.getSnapshotBeforeUpdate(v3, y3)), f3 = $(n2, d(T3 = null != a3 && a3.type === k && null == a3.key ? a3.props.children : a3) ? T3 : [T3], u3, t3, i3, r3, o3, e3, f3, c3, s3), h3.base = u3.__e, u3.__u &= -161, h3.__h.length && e3.push(h3), m3 && (h3.__E = h3.__ = null);
    } catch (n3) {
  ...
  function Background() {
    return /* @__PURE__ */ g("div", { class: Background_default.bg });
  }
  ...
  function MobileApp({ embed }) {
    ...
    return /* @__PURE__ */ g(k, null, /* @__PURE__ */ g(Background, null), features.focusMode(), /* @__PURE__ */ g(
      OrientationProvider,
      {
  ...
  function DesktopApp({ embed }) {
    const settings = useSettings();
    const features = createAppFeaturesFrom(settings);
    return /* @__PURE__ */ g(k, null, /* @__PURE__ */ g(Background, null), features.focusMode(), /* @__PURE__ */ g("main", { class: DesktopApp_default.app }, /* @__PURE__ */ g(DesktopLayout, { embed })));
  }
