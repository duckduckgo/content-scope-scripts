...
(() => {
            ...
            listener: function listener(event) {
              ...
              if (nativeData) {
                for (var _i = 0, _Object$entries = Object.entries(nativeData); _i < _Object$entries.length; _i++) {
                  var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2), key = _Object$entries$_i[0], data2 = _Object$entries$_i[1];
                  event.dataTransfer.setData(key, data2 !== null && data2 !== void 0 ? data2 : "");
                }
              }
  ...
  function PlusIcon({ onClick }) {
    ...
    ))), /* @__PURE__ */ _("div", { class: Tile_default.text, id }, t4("favorites_add")), state.type === "is-dragging-over" && state.closestEdge ? /* @__PURE__ */ _("div", { class: Tile_default.dropper, "data-edge": state.closestEdge }) : null);
  }
  ...
  function DismissButton({ className, onClick }) {
    const { t: t4 } = useTypedTranslation();
    return /* @__PURE__ */ _("button", { class: (0, import_classnames5.default)(DismissButton_default.btn, className), onClick, "aria-label": t4("ntp_dismiss"), "data-testid": "dismissBtn" }, /* @__PURE__ */ _(Cross, null));
  }
  ...
  // pages/new-tab/app/privacy-pro/privacy-pro.service.js
  var PrivacyProService;
  var init_privacy_pro_service = __esm({
    "pages/new-tab/app/privacy-pro/privacy-pro.service.js"() {
      "use strict";
      init_service();
      PrivacyProService = class {
        /**
         * @param {import("../../src/js/index.js").NewTabPage} ntp - The internal data feed, expected to have a `subscribe` method.
         * @internal
         */
        constructor(ntp) {
          ...
          this.configService = new Service({
            ...
            persist: (data2) => ntp.messaging.notify("privacyPro_setConfig", data2)
          });
        }
        name() {
  ...
  // pages/new-tab/app/privacy-pro/PrivacyProProvider.js
  function PrivacyProProvider(props) {
    const initial = (
      /** @type {State} */
      {
        status: "idle",
    ...
    return /* @__PURE__ */ _(PrivacyProContext.Provider, { value: { state, toggle, action } }, /* @__PURE__ */ _(PrivacyProDispatchContext.Provider, { value: dispatch }, props.children));
  }
  function useService3() {
    const service = A2(
      /** @type {PrivacyProService|null} */
      null
    );
    const ntp = useMessaging();
    y2(() => {
  ...
  var PrivacyProContext, PrivacyProDispatchContext;
  var init_PrivacyProProvider = __esm({
    "pages/new-tab/app/privacy-pro/PrivacyProProvider.js"() {
      "use strict";
      init_preact_module();
      init_hooks_module();
      init_types();
      init_privacy_pro_service();
      init_service_hooks();
      PrivacyProContext = G({
        /** @type {State} */
        state: { status: "idle", data: null, config: null },
  ...
  // pages/new-tab/app/privacy-pro/components/PrivacyPro.module.css
  var PrivacyPro_default;
  var init_PrivacyPro = __esm({
    "pages/new-tab/app/privacy-pro/components/PrivacyPro.module.css"() {
      PrivacyPro_default = {
        root: "PrivacyPro_root",
        heading: "PrivacyPro_heading",
        subtitle: "PrivacyPro_subtitle",
        headingIcon: "PrivacyPro_headingIcon",
        title: "PrivacyPro_title",
        buttonBlock: "PrivacyPro_buttonBlock",
        headingBtn: "PrivacyPro_headingBtn",
        visible: "PrivacyPro_visible",
        privProRed: "PrivacyPro_privProRed",
        uppercase: "PrivacyPro_uppercase",
        widgetExpander: "PrivacyPro_widgetExpander",
        body: "PrivacyPro_body",
        panel: "PrivacyPro_panel",
        panelButton: "PrivacyPro_panelButton",
        topSection: "PrivacyPro_topSection",
        middleSection: "PrivacyPro_middleSection",
        bottomSection: "PrivacyPro_bottomSection",
        statusDot: "PrivacyPro_statusDot",
        red: "PrivacyPro_red",
        status: "PrivacyPro_status",
        entering: "PrivacyPro_entering",
        "fade-in": "PrivacyPro_fade-in",
        entered: "PrivacyPro_entered",
        exiting: "PrivacyPro_exiting",
        "fade-out": "PrivacyPro_fade-out",
        icon: "PrivacyPro_icon"
      };
    }
  });
  ...
  // pages/new-tab/app/privacy-pro/components/PrivacyPro.js
  function PrivacyPro({ expansion, data: data2, toggle, animation = "auto-animate", action }) {
    if (animation === "view-transitions") {
      return /* @__PURE__ */ _(WithViewTransitions, { data: data2, expansion, toggle, action });
    }
    return /* @__PURE__ */ _(PrivacyProConfigured, { expansion, data: data2, toggle, action });
  }
  function WithViewTransitions({ expansion, data: data2, toggle, action }) {
    const willToggle = q2(() => {
      viewTransition(toggle);
    }, [toggle]);
    return /* @__PURE__ */ _(PrivacyProConfigured, { expansion, data: data2, toggle: willToggle, action });
  }
  function PrivacyProConfigured({ parentRef, expansion, data: data2, toggle, action }) {
    const expanded = expansion === "expanded";
    const WIDGET_ID = g2();
    const TOGGLE_ID = g2();
    console.log({ data: data2 });
    return /* @__PURE__ */ _("div", { class: PrivacyPro_default.root, ref: parentRef }, /* @__PURE__ */ _(
      Heading,
      {
        onToggle: toggle,
        expansion,
        ...
        action,
        isSubscriber: data2 !== null
      }
    ), expanded && /* @__PURE__ */ _(PrivacyProBody, { data: data2, action, isSubscriber: data2 !== null }));
  }
  function Heading({ expansion, onToggle, buttonAttrs = {}, action, isSubscriber }) {
    const { t: t4 } = useTypedTranslationWith(
      /** @type {enStrings} */
      {}
    );
    return /* @__PURE__ */ _("div", { className: PrivacyPro_default.heading }, /* @__PURE__ */ _("span", { className: PrivacyPro_default.headingIcon }, /* @__PURE__ */ _("img", { src: "./icons/Privacy-Pro-Color-16.svg", alt: "Privacy Shield" })), /* @__PURE__ */ _("h2", { className: PrivacyPro_default.title }, !isSubscriber ? /* @__PURE__ */ _(b, null, "Try ", /* @__PURE__ */ _("span", { class: PrivacyPro_default.privProRed }, "Privacy Pro"), " today for free!") : "Privacy Pro"), /* @__PURE__ */ _("div", { class: (0, import_classnames8.default)(PrivacyPro_default.buttonBlock, expansion === "collapsed" && PrivacyPro_default.visible) }, /* @__PURE__ */ _("button", { className: PrivacyPro_default.headingBtn, onClick: () => action("personalInformationRemoval") }, /* @__PURE__ */ _("p", { class: "sr-only" }, "Personal Information Removal"), /* @__PURE__ */ _("img", { src: "./icons/Identity-Blocked-PIR-Color-16.svg", alt: "Personal Information Removal" })), /* @__PURE__ */ _("button", { className: PrivacyPro_default.headingBtn, onClick: () => action("vpn") }, /* @__PURE__ */ _("p", { class: "sr-only" }, "VPN"), /* @__PURE__ */ _("img", { src: "./icons/VPN-Color-16.svg", alt: "VPN" })), /* @__PURE__ */ _("button", { className: PrivacyPro_default.headingBtn, onClick: () => action("identityRestoration") }, /* @__PURE__ */ _("p", { class: "sr-only" }, "Identity Restoration"), /* @__PURE__ */ _("img", { src: "./icons/Identity-Theft-Restoration-Color-16.svg", alt: "Identity Restoration" }))), /* @__PURE__ */ _("span", { className: PrivacyPro_default.widgetExpander }, /* @__PURE__ */ _(
      ShowHideButton,
      {
        buttonAttrs: {
          ...buttonAttrs,
  ...
  function PrivacyProBody({ data: data2, action, isSubscriber }) {
    ...
    return /* @__PURE__ */ _(b, null, !isSubscriber ? /* @__PURE__ */ _("div", { class: PrivacyPro_default.body }, /* @__PURE__ */ _("div", { class: PrivacyPro_default.panel }, /* @__PURE__ */ _("div", { class: PrivacyPro_default.topSection }, /* @__PURE__ */ _("img", { src: "./icons/Information-Remover-32.svg", alt: "Privacy Shield" }), /* @__PURE__ */ _("p", null, "Information Removal")), /* @__PURE__ */ _("div", { class: PrivacyPro_default.middleSection }, /* @__PURE__ */ _("p", null, "Remove your info from sites that sell it")), /* @__PURE__ */ _("div", { class: PrivacyPro_default.bottomSection }, /* @__PURE__ */ _(Button, { variant: "standard", onClick: () => action("personalInformationRemoval") }, "Learn More"))), /* @__PURE__ */ _("div", { class: PrivacyPro_default.panel }, /* @__PURE__ */ _("div", { class: PrivacyPro_default.topSection }, /* @__PURE__ */ _("img", { src: "./icons/VPN-Color-32.svg", alt: "Privacy Shield" }), /* @__PURE__ */ _("p", null, "VPN")), /* @__PURE__ */ _("div", { class: PrivacyPro_default.middleSection }, /* @__PURE__ */ _("p", null, "Secure connection anytime, anywhere")), /* @__PURE__ */ _("div", { class: PrivacyPro_default.bottomSection }, /* @__PURE__ */ _(Button, { variant: "standard", onClick: () => action("personalInformationRemoval") }, "Learn More"))), /* @__PURE__ */ _("div", { class: PrivacyPro_default.panel }, /* @__PURE__ */ _("div", { class: PrivacyPro_default.topSection }, /* @__PURE__ */ _("img", { src: "./icons/ID-32.svg", alt: "Privacy Shield" }), /* @__PURE__ */ _("p", null, "Identity Restoration")), /* @__PURE__ */ _("div", { class: PrivacyPro_default.middleSection }, /* @__PURE__ */ _("p", null, "Secure connection anytime, anywhere")), /* @__PURE__ */ _("div", { class: PrivacyPro_default.bottomSection }, /* @__PURE__ */ _(Button, { variant: "standard", onClick: () => action("personalInformationRemoval") }, "Learn More")))) : /* @__PURE__ */ _("div", { class: PrivacyPro_default.body }, data2?.personalInformationRemoval && /* @__PURE__ */ _("button", { class: PrivacyPro_default.panelButton, onClick: () => action("personalInformationRemoval") }, /* @__PURE__ */ _("div", { class: PrivacyPro_default.topSection }, /* @__PURE__ */ _("img", { src: "./icons/Information-Remover-32.svg", alt: "Privacy Shield" }), /* @__PURE__ */ _("p", null, "Information Removal")), /* @__PURE__ */ _("div", { class: PrivacyPro_default.middleSection }, /* @__PURE__ */ _("p", null, "Next Scan"), /* @__PURE__ */ _("p", null, formatDates(new Date(data2.personalInformationRemoval.nextScanDate)))), /* @__PURE__ */ _("div", { class: PrivacyPro_default.bottomSection }, /* @__PURE__ */ _("div", { class: PrivacyPro_default.statusDot }), /* @__PURE__ */ _("p", { className: PrivacyPro_default.status }, data2.personalInformationRemoval.status))), data2?.vpn && /* @__PURE__ */ _("button", { class: PrivacyPro_default.panelButton, onClick: () => action("vpn") }, /* @__PURE__ */ _("div", { class: PrivacyPro_default.topSection }, /* @__PURE__ */ _("img", { src: "./icons/VPN-Color-32.svg", alt: "Privacy Shield" }), /* @__PURE__ */ _("p", null, "VPN")), /* @__PURE__ */ _("div", { class: PrivacyPro_default.middleSection }, data2.vpn.location !== "null" ? /* @__PURE__ */ _(b, null, /* @__PURE__ */ _("p", null, "Location"), typeof data2.vpn.location === "object" && /* @__PURE__ */ _("p", null, data2.vpn.location?.name), typeof data2.vpn.location === "string" && /* @__PURE__ */ _("p", null, data2.vpn.location)) : /* @__PURE__ */ _("p", null, "Nearest Location")), /* @__PURE__ */ _("div", { class: PrivacyPro_default.bottomSection }, /* @__PURE__ */ _("div", { class: (0, import_classnames8.default)(PrivacyPro_default.statusDot, data2.vpn.status === "disconnected" && PrivacyPro_default.red) }), /* @__PURE__ */ _("p", { class: PrivacyPro_default.status }, displayVPNStatus(data2.vpn.status)))), data2?.identityRestoration && /* @__PURE__ */ _("button", { class: PrivacyPro_default.panelButton, onClick: () => action("identityRestoration") }, /* @__PURE__ */ _("div", { class: PrivacyPro_default.topSection }, /* @__PURE__ */ _("img", { src: "./icons/ID-32.svg", alt: "Privacy Shield" }), /* @__PURE__ */ _("p", null, "Identity Restoration")), /* @__PURE__ */ _("div", { class: PrivacyPro_default.middleSection }, /* @__PURE__ */ _("p", null, "Covered since"), /* @__PURE__ */ _("p", null, formatDates(new Date(data2.identityRestoration.coveredSinceDate)))), /* @__PURE__ */ _("div", { class: PrivacyPro_default.bottomSection }, /* @__PURE__ */ _("div", { class: PrivacyPro_default.statusDot }), /* @__PURE__ */ _("p", { class: PrivacyPro_default.status }, "available")))));
  }
  function PrivacyProCustomized() {
    const { t: t4 } = useTypedTranslationWith(
      /** @type {enStrings} */
      {}
    );
    const { visibility, id, toggle, index } = useVisibility();
    const title = t4("privacyPro_menuTitle");
    useCustomizer({ title, id, icon: "shield", toggle, visibility: visibility.value, index });
    if (visibility.value === "hidden") {
      return null;
    }
    return /* @__PURE__ */ _(PrivacyProProvider, null, /* @__PURE__ */ _(PrivacyProConsumer, null));
  }
  function PrivacyProConsumer() {
    const { state, toggle, action } = x2(PrivacyProContext);
    if (state.status === "ready") {
      return /* @__PURE__ */ _(
        PrivacyPro,
        {
  ...
  var init_PrivacyPro2 = __esm({
    "pages/new-tab/app/privacy-pro/components/PrivacyPro.js"() {
      ...
      init_utils();
      init_widget_config_provider();
      init_PrivacyProProvider();
      init_PrivacyPro();
      init_Button2();
    }
  });

  // pages/new-tab/app/entry-points/privacyPro.js
  var privacyPro_exports = {};
  __export(privacyPro_exports, {
    factory: () => factory3
  });
  function factory3() {
    return /* @__PURE__ */ _(Centered, { "data-entry-point": "privacyPro" }, /* @__PURE__ */ _(PrivacyProCustomized, null));
  }
  var init_privacyPro = __esm({
    "pages/new-tab/app/entry-points/privacyPro.js"() {
      "use strict";
  ...
  function PrivacyStats({ expansion, data: data2, toggle, animation = "auto-animate" }) {
    if (animation === "view-transitions") {
      return /* @__PURE__ */ _(WithViewTransitions2, { data: data2, expansion, toggle });
    }
    return /* @__PURE__ */ _(PrivacyStatsConfigured, { expansion, data: data2, toggle });
  }
  function WithViewTransitions2({ expansion, data: data2, toggle }) {
    const willToggle = q2(() => {
      viewTransition(toggle);
    }, [toggle]);
    return /* @__PURE__ */ _(PrivacyStatsConfigured, { expansion, data: data2, toggle: willToggle });
  }
  function PrivacyStatsConfigured({ parentRef, expansion, data: data2, toggle }) {
    const expanded = expansion === "expanded";
    const someCompanies = data2.trackerCompanies.length > 0;
    const WIDGET_ID = g2();
    const TOGGLE_ID = g2();
    return /* @__PURE__ */ _("div", { class: PrivacyStats_default.root, ref: parentRef }, /* @__PURE__ */ _(
      Heading2,
      {
        trackerCompanies: data2.trackerCompanies,
        onToggle: toggle,
        expansion,
        buttonAttrs: {
          "aria-controls": WIDGET_ID,
    ...
    ), expanded && someCompanies && /* @__PURE__ */ _(PrivacyStatsBody, { trackerCompanies: data2.trackerCompanies, listAttrs: { id: WIDGET_ID } }));
  }
  function Heading2({ expansion, trackerCompanies, onToggle, buttonAttrs = {} }) {
    const { t: t4 } = useTypedTranslationWith(
      /** @type {enStrings} */
      {}
    );
    ...
    )), recent === 0 && /* @__PURE__ */ _("p", { className: PrivacyStats_default.subtitle }, t4("stats_noActivity")), recent > 0 && /* @__PURE__ */ _("p", { className: (0, import_classnames9.default)(PrivacyStats_default.subtitle, PrivacyStats_default.uppercase) }, t4("stats_feedCountBlockedPeriod")));
  }
  ...
  function UpdateNotification({ notes, dismiss, version }) {
    return /* @__PURE__ */ _("div", { class: UpdateNotification_default.root, "data-reset-layout": "true" }, /* @__PURE__ */ _("div", { class: (0, import_classnames11.default)("layout-centered", UpdateNotification_default.body) }, notes.length > 0 ? /* @__PURE__ */ _(WithNotes, { notes, version }) : /* @__PURE__ */ _(WithoutNotes, { version })), /* @__PURE__ */ _(DismissButton, { onClick: dismiss, className: UpdateNotification_default.dismiss }));
  }
  ...
  function CustomizerDrawerInner() {
    ...
    return /* @__PURE__ */ _("div", { class: CustomizerDrawerInner_default.root }, /* @__PURE__ */ _("h2", null, "Customize"), /* @__PURE__ */ _("br", null), /* @__PURE__ */ _(VisibilityMenu, { rows: rowData, variant: "embedded" }));
  }
  ...
  var globImport_entry_points_js = __glob({
    ...
    "../entry-points/privacyPro.js": () => Promise.resolve().then(() => (init_privacyPro(), privacyPro_exports)),
  ...
  init_compat_module();
  init_hooks_module();
  var CustomizerDrawerInner2 = O2(() => Promise.resolve().then(() => (init_CustomizerDrawerInner2(), CustomizerDrawerInner_exports)).then((x4) => x4.CustomizerDrawerInner));
  function CustomizerDrawer({ onClose, displayChildren }) {
    ...
    return /* @__PURE__ */ _("div", { class: CustomizerDrawer_default.root }, /* @__PURE__ */ _("button", { onClick: onClose }, "Close"), displayChildren.value && /* @__PURE__ */ _(D3, { fallback: /* @__PURE__ */ _("div", null, "Loading...") }, /* @__PURE__ */ _(CustomizerDrawerInner2, null)));
  }
  ...
  function App({ children }) {
    ...
    return /* @__PURE__ */ _("div", { class: (0, import_classnames12.default)(App_default.layout), ref: wrapperRef, "data-drawer-visibility": visibility }, /* @__PURE__ */ _("main", { class: (0, import_classnames12.default)(App_default.main), "data-customizer-kind": customizerKind }, /* @__PURE__ */ _("div", { class: App_default.tube, "data-platform": platformName }, /* @__PURE__ */ _(WidgetList, null), /* @__PURE__ */ _(CustomizerMenuPositionedFixed, null, customizerKind === "menu" && /* @__PURE__ */ _(Customizer, null), customizerKind === "drawer" && /* @__PURE__ */ _(
      CustomizerButton,
      {
        buttonId,
        menuId: drawerId,
    ...
    )), children)), customizerKind === "drawer" && /* @__PURE__ */ _("aside", { id: drawerId, class: App_default.aside, "aria-hidden": hidden }, /* @__PURE__ */ _("div", { class: App_default.asideContent }, /* @__PURE__ */ _(CustomizerDrawer, { onClose: close, wrapperRef, displayChildren }))));
  }
  ...
  var new_tab_default = {
    ...
    privacyPro_menuTitle: {
      title: "Privacy Pro",
      note: "Used as a label in a customization menu"
    },
    privacyPro_widgetTitle: {
      title: "Privacy Pro",
      note: "Used as text in heading"
    },
    privacyPro_signedOutSubtext: {
      title: "Blocked tracking attempts will appear here. Keep browsing to see how many we block.",
      note: "Placeholder for when we cannot report any blocked trackers yet"
    },
    privacyPro_feedCountBlockedPlural: {
      title: "{count} tracking attempts blocked",
      note: "A summary description of how many tracking attempts were blocked by DuckDuckGo in the last 7 days when there is more than one. E.g., '1,028 tracking attempts blocked."
    },
    privacyPro_nonsubscriber_subtext: {
      title: "Try PrivacyPro for free today!",
      note: "Used when user is not a subscriber"
    },
    privacyPro_otherCompanyName: {
      title: "Other",
      note: "A placeholder to represent an aggregated count of entries, not present in the rest of the list. For example, 'Other: 200', which would mean 200 entries excluding the ones already shown"
    },
    privacyPro_otherCount: {
      title: "{count} attempts from other networks",
      note: "An aggregated count of blocked entries not present in the main list. For example, '200 attempts from other networks'"
    },
  ...
  var privacyStatsExamples = {
    ...
    "stats.heading": {
      factory: () => /* @__PURE__ */ _(Heading2, { trackerCompanies: stats.few.trackerCompanies, expansion: "expanded", onToggle: noop("stats.heading onToggle") })
    },
    "stats.heading.none": {
      factory: () => /* @__PURE__ */ _(Heading2, { trackerCompanies: stats.none.trackerCompanies, expansion: "expanded", onToggle: noop("stats.heading onToggle") })
    }
  };
  ...
  // pages/new-tab/app/privacy-pro/components/PrivacyPro.examples.js
  init_preact_module();

  // pages/new-tab/app/privacy-pro/mocks/PrivacyProMockProvider.js
  init_hooks_module();
  init_preact_module();
  init_PrivacyProProvider();

  // pages/new-tab/app/privacy-pro/mocks/stats.js
  var data = {
    basic: {
      personalInformationRemoval: {
        nextScanDate: `${/* @__PURE__ */ new Date("9/27/2024")}`,
        status: "active"
      },
      identityRestoration: {
        coveredSinceDate: `${/* @__PURE__ */ new Date("9/27/2024")}`
      },
      vpn: {
        location: {
          countryCode: "us",
    ...
    locationString: {
      personalInformationRemoval: {
        nextScanDate: `${/* @__PURE__ */ new Date("8/11/2024")}`,
        status: "active"
      },
      identityRestoration: {
        coveredSinceDate: `${/* @__PURE__ */ new Date("8/11/2024")}`
      },
      vpn: {
        location: null,
        status: "disconnected"
  ...
  // pages/new-tab/app/privacy-pro/mocks/PrivacyProMockProvider.js
  init_service_hooks();
  function PrivacyProMockProvider({
    data: data2 = data.basic,
    config = { expansion: "expanded", animation: { kind: "auto-animate" } },
    children
  }) {
    const initial = (
      /** @type {import('../PrivacyProProvider.js').State} */
      {
        status: "ready",
        data: data2,
        config
    ...
    return /* @__PURE__ */ _(PrivacyProContext.Provider, { value: { state, toggle, action } }, /* @__PURE__ */ _(PrivacyProDispatchContext.Provider, { value: send }, children));
  }

  // pages/new-tab/app/privacy-pro/components/PrivacyPro.examples.js
  init_PrivacyPro2();
  var privacyProExamples = {
    "privacyPro.loggedInVPNOff": {
      factory: () => /* @__PURE__ */ _(PrivacyProMockProvider, { ticker: true, data: data.locationString }, /* @__PURE__ */ _(PrivacyProConsumer, null))
    },
    "privacyPro.nonsubscriber": {
      factory: () => /* @__PURE__ */ _(PrivacyProMockProvider, { config: { expansion: "collapsed" }, data: data.unsubscribed }, /* @__PURE__ */ _(PrivacyProConsumer, null))
    },
    "privacyPro.loggedIn": {
      factory: () => /* @__PURE__ */ _(PrivacyProMockProvider, { data: data.basic, config: { expansion: "collapsed" } }, /* @__PURE__ */ _(PrivacyProConsumer, null))
    }
  };
  ...
  // pages/new-tab/app/privacy-pro/privacy-pro.data.js
  var variants2 = {
    /** @type {PrivacyProData} */
    basic: {
      personalInformationRemoval: {
        nextScanDate: `${/* @__PURE__ */ new Date()}`,
        status: (
          /** type {const} */
          "inactive"
        )
      ...
      identityRestoration: {
        coveredSinceDate: `${/* @__PURE__ */ new Date()}`
      },
      vpn: {
        location: {
          countryCode: "us",
        ...
        switch (msg.method) {
          ...
          case "favorites_getData": {
            ...
            if (param && param in favorites) {
              ...
              data2 = param ? gen(Number(url2.searchParams.get("favorites"))) : read("favorites_data") || favorites.many;
            }
