...
(() => {
  ...
  function W(n2) {
    ...
    } }), B(_(V2, { context: e3.context }, n2.__v), e3.l);
  }
  function P3(n2, e3) {
    var r3 = _(W, { __v: n2, i: e3 });
  ...
  // pages/new-tab/app/favorites/Tile.js
  function Tile({ data, favicon, title, id, prefix }) {
    ...
    return /* @__PURE__ */ _(b, null, /* @__PURE__ */ _(
      ...
      /* @__PURE__ */ _("div", { class: (0, import_classnames2.default)(Favorites_default.icon, Favorites_default.draggable) }, /* @__PURE__ */ _("span", { class: Favorites_default.favicon, style: { backgroundImage: `url(${favicon})` } })),
    ...
    ), state.type === "preview" && state.container ? P3(/* @__PURE__ */ _(DragPreview, { data, title }), state.container) : null);
  }
  ...
  function DragPreview({ data, title }) {
    return /* @__PURE__ */ _("div", { class: Favorites_default.preview }, /* @__PURE__ */ _("p", null, title), /* @__PURE__ */ _("p", null, data));
  }
  ...
  function FavoritesProvider({ children }) {
    ...
    return /* @__PURE__ */ _(InstanceIdContext.Provider, { value: instanceId }, /* @__PURE__ */ _(FavoritesContext.Provider, { value: { state, toggle, listDidReOrder, openContextMenu } }, /* @__PURE__ */ _(FavoritesDispatchContext.Provider, { value: dispatch }, children)));
  }
  ...
  function Favorites(props) {
    if (props.animation === "view-transitions") {
      return /* @__PURE__ */ _(WithViewTransitions2, { ...props });
    }
    return /* @__PURE__ */ _(
      FavoritesConfigured,
      {
  ...
  function WithViewTransitions2(props) {
    const willToggle = q2(() => {
      viewTransition(props.toggle);
    }, [props.toggle]);
    return /* @__PURE__ */ _(FavoritesConfigured, { ...props, toggle: willToggle, animateItems: "view-transitions" });
  }
  function FavoritesConfigured({ gridRef, favorites: favorites2, listDidReOrder, expansion, toggle, animateItems, openContextMenu }) {
    ...
    const items = T2(() => {
      return favorites2.map((item) => /* @__PURE__ */ _(
        TileMemo,
        {
          data: item.data,
        ...
        if (index === 0) {
          return /* @__PURE__ */ _(PlusIcon, { key: "placeholder-plus" });
        }
        return /* @__PURE__ */ _("div", { key: `placeholder-${index}`, class: (0, import_classnames3.default)(Favorites_default.icon, Favorites_default.placeholder) });
      }));
    }, [favorites2, placeholders, ITEM_PREFIX]);
    ...
    return /* @__PURE__ */ _("div", { class: Favorites_default.root }, /* @__PURE__ */ _(
      "div",
      {
    ...
    return /* @__PURE__ */ _(
      "div",
      {
        className: (0, import_classnames3.default)({
          ...
          [Favorites_default.showhideVisible]: itemCount > capacity
        })
      },
      /* @__PURE__ */ _(
        "button",
        {
          ...
          "aria-label": expansion === "expanded" ? t3("favorites_show_less") : t3("favorites_show_more"),
          onClick: toggle
        },
        /* @__PURE__ */ _(ChevronButton, null)
      )
  ...
  var PlusIcon = C3(function PlusIcon2() {
    const labelId = g2();
    return /* @__PURE__ */ _("div", { class: Favorites_default.item }, /* @__PURE__ */ _("button", { class: (0, import_classnames3.default)(Favorites_default.icon, Favorites_default.placeholder, Favorites_default.plus), "aria-labelledby": labelId }, /* @__PURE__ */ _("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none" }, /* @__PURE__ */ _(
      "path",
      {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
  ...
  function FavoritesConsumer() {
    const { state, toggle, listDidReOrder, openContextMenu } = x2(FavoritesContext);
    if (state.status === "ready") {
      return /* @__PURE__ */ _(
        Favorites,
        {
