...
(() => {
  ...
  // pages/new-tab/app/favorites/Tile.js
  var DDG_MIME_TYPE = "application/vnd.duckduckgo.bookmark";
  function Tile({ data, visible, favicon, index, title, id }) {
    ...
    return /* @__PURE__ */ _(
      ...
      /* @__PURE__ */ _("div", { class: (0, import_classnames2.default)(Favorites_default.icon, Favorites_default.draggable) }, visible && /* @__PURE__ */ _("img", { src: favicon, loading: "lazy", class: Favorites_default.favicon, alt: `favicon for ${title}` })),
  ...
  function FavoritesProvider({ children }) {
    ...
    const openFavorite = q2((id, target2) => {
      if (!service.current)
        return;
    ...
    return /* @__PURE__ */ _(InstanceIdContext.Provider, { value: instanceId }, /* @__PURE__ */ _(FavoritesContext.Provider, { value: { state, toggle, listDidReOrder, openFavorite, openContextMenu, add: add2 } }, /* @__PURE__ */ _(FavoritesDispatchContext.Provider, { value: dispatch }, children)));
  }
  ...
  function FavoritesConfigured({ gridRef, favorites: favorites2, listDidReOrder, expansion, toggle, animateItems, openContextMenu, openFavorite, add: add2 }) {
  ...
  function PlusIcon({ onClick }) {
    ...
    return /* @__PURE__ */ _("div", { class: Favorites_default.item }, /* @__PURE__ */ _(
      "button",
      {
        class: (0, import_classnames3.default)(Favorites_default.icon, Favorites_default.placeholder, Favorites_default.plus),
  ...
  function FavoritesConsumer() {
    const { state, toggle, listDidReOrder, openContextMenu, openFavorite, add: add2 } = x2(FavoritesContext);
    if (state.status === "ready") {
      return /* @__PURE__ */ _(
        Favorites,
        {
  ...
  function MockFavoritesProvider({
    ...
    return /* @__PURE__ */ _(InstanceIdContext.Provider, { value: instanceId }, /* @__PURE__ */ _(FavoritesContext.Provider, { value: { state, toggle, listDidReOrder, openContextMenu, openFavorite, add: add2 } }, /* @__PURE__ */ _(FavoritesDispatchContext.Provider, { value: dispatch }, children)));
  }
