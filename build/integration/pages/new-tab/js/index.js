...
(() => {
  ...
  function FavoritesProvider({ children }) {
    ...
    return /* @__PURE__ */ _(FavoritesContext.Provider, { value: { state, toggle, favoritesDidReOrder, openFavorite, openContextMenu, add } }, /* @__PURE__ */ _(FavoritesDispatchContext.Provider, { value: dispatch }, children));
  }
  function useService() {
    const service = A2(
  ...
  function ShowHideButton({ text, onClick, buttonAttrs = {}, shape = "none" }) {
    return /* @__PURE__ */ _("button", { ...buttonAttrs, class: (0, import_classnames3.default)(ShowHide_default.button, shape === "round" && ShowHide_default.round), "aria-label": text, onClick }, /* @__PURE__ */ _(ChevronButton, null));
  }
  ...
  function Favorites({ gridRef, favorites: favorites2, expansion, toggle, openContextMenu, openFavorite, add }) {
    ...
    }, [favorites2, placeholders, ITEM_PREFIX, add]);
    ...
    return /* @__PURE__ */ _("div", { class: (0, import_classnames4.default)(Favorites_default.root, !canToggleExpansion && Favorites_default.bottomSpace), "data-testid": "FavoritesConfigured" }, /* @__PURE__ */ _("div", { class: Favorites_default.grid, id: WIDGET_ID, ref: safeArea, onContextMenu, onClick }, items.slice(0, expansion === "expanded" ? void 0 : ROW_CAPACITY)), canToggleExpansion && /* @__PURE__ */ _(
      "div",
      {
  ...
  var import_classnames4, FavoritesMemo;
  ...
  function Heading({ expansion, trackerCompanies, onToggle, buttonAttrs = {} }) {
    ...
    )), recent === 0 && /* @__PURE__ */ _("p", { className: PrivacyStats_default.subtitle }, t3("stats_noActivity")), recent > 0 && /* @__PURE__ */ _("p", { className: PrivacyStats_default.subtitle }, t3("stats_feedCountBlockedPeriod")));
  }
  function PrivacyStatsBody({ trackerCompanies, listAttrs = {} }) {
    ...
    return /* @__PURE__ */ _(b, null, /* @__PURE__ */ _("ul", { ...listAttrs, class: PrivacyStats_default.list, "data-testid": "CompanyList" }, sorted.slice(0, visible).map((company) => {
      ...
      if (company.displayName === DDG_STATS_OTHER_COMPANY_IDENTIFIER) {
        ...
        return /* @__PURE__ */ _("li", { key: company.displayName }, /* @__PURE__ */ _("div", { class: PrivacyStats_default.textRow }, otherText2));
      }
    ...
    })), hasmore && visible < sorted.length && /* @__PURE__ */ _("button", { onClick: () => setVisible(sorted.length) }, t3("ntp_show_more")), visible > 5 && visible === sorted.length && /* @__PURE__ */ _("button", { onClick: () => setVisible(5) }, t3("ntp_show_less")));
  }
  ...
  function UpdateNotification({ notes, dismiss, version }) {
    return /* @__PURE__ */ _("div", { class: UpdateNotification_default.root, "data-reset-layout": "true" }, /* @__PURE__ */ _("div", { class: (0, import_classnames8.default)("layout-centered", UpdateNotification_default.body) }, notes.length > 0 ? /* @__PURE__ */ _(WithNotes, { notes, version }) : /* @__PURE__ */ _(WithoutNotes, { version })), /* @__PURE__ */ _(DismissButton, { onClick: dismiss, className: UpdateNotification_default.dismiss }));
  }
  ...
  function MockFavoritesProvider({ data = favorites.many, config = DEFAULT_CONFIG, children }) {
    ...
    return /* @__PURE__ */ _(FavoritesContext.Provider, { value: { state, toggle, favoritesDidReOrder, openContextMenu, openFavorite, add } }, /* @__PURE__ */ _(FavoritesDispatchContext.Provider, { value: dispatch }, children));
  }
  ...
  async function init(root2, messaging2, telemetry2, baseEnvironment2) {
    const result = await callWithRetry(() => messaging2.init());
    if ("error" in result) {
