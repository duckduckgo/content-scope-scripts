...
(() => {
  ...
  function WidgetConfigProvider(props) {
    ...
    function toggle(id2) {
      props.api.toggleVisibility(id2);
    }
  ...
  function Body({ trackerCompanies, id: id2 }) {
    const max = trackerCompanies[0]?.count ?? 0;
    const [formatter] = h2(() => new Intl.NumberFormat());
    const bodyClasses = (0, import_classnames.default)({
      [PrivacyStats_default.list]: true
    });
    return /* @__PURE__ */ _("ul", { className: bodyClasses, id: id2 }, trackerCompanies.map((company) => {
  ...
  function FavoritesCustomized() {
    const { id: id2, visibility } = useVisibility();
    if (visibility === "hidden") {
      return null;
    }
    return /* @__PURE__ */ _("p", null, "Favourites here... (id: ", /* @__PURE__ */ _("code", null, id2), ")");
  }
  ...
  function Components() {
    ...
    return /* @__PURE__ */ _("div", null, /* @__PURE__ */ _(DebugBar, { id, entries }), /* @__PURE__ */ _(Stage, { entries: filtered }));
  }
  function Stage({ entries }) {
    return /* @__PURE__ */ _("div", { class: Components_default.componentList, "data-testid": "stage" }, entries.map(([id2, item]) => {
      const next = new URL(url);
      next.searchParams.set("isolate", "true");
      next.searchParams.set("id", id2);
      const selected = new URL(url);
      selected.searchParams.set("id", id2);
      const e2e2 = new URL(url);
      e2e2.searchParams.set("isolate", "true");
      e2e2.searchParams.set("id", id2);
      e2e2.searchParams.set("e2e", "true");
      const without = new URL(url);
      const current = without.searchParams.getAll("id");
      const others = current.filter((x3) => x3 !== id2);
      const matching = current.filter((x3) => x3 === id2);
      ...
      return /* @__PURE__ */ _(b, null, /* @__PURE__ */ _("div", { class: Components_default.itemInfo }, /* @__PURE__ */ _("code", null, id2), " ", /* @__PURE__ */ _("a", { href: without.toString(), hidden: current.length === 0 }, "Remove"), /* @__PURE__ */ _("div", null, /* @__PURE__ */ _(
        "a",
        {
        ...
        "edge-to-edge"
      ))), /* @__PURE__ */ _("div", { className: Components_default.item, key: id2 }, item.factory()));
    }));
  }
  function Isolated({ entries, e2e: e2e2 }) {
    if (e2e2) {
      return /* @__PURE__ */ _("div", null, entries.map(([id2, item]) => {
        return /* @__PURE__ */ _(b, { key: id2 }, item.factory());
      }));
    }
    return /* @__PURE__ */ _("div", { class: Components_default.componentList, "data-testid": "stage" }, entries.map(([id2, item], index) => {
      return /* @__PURE__ */ _("div", { key: id2 + index }, item.factory());
    }));
  }
  function DebugBar({ entries, id: id2, ids }) {
    return /* @__PURE__ */ _("div", { class: Components_default.debugBar, "data-testid": "selector" }, /* @__PURE__ */ _(ExampleSelector, { entries, id: id2 }), ids.length > 0 && /* @__PURE__ */ _(Append, { entries, id: id2 }), /* @__PURE__ */ _(TextLength, null), /* @__PURE__ */ _(Isolate, null));
  }
  function TextLength() {
    function onClick() {
  ...
  function ExampleSelector({ entries, id: id2 }) {
    function onReset() {
    ...
    return /* @__PURE__ */ _(b, null, /* @__PURE__ */ _("div", { class: Components_default.buttonRow }, /* @__PURE__ */ _("label", null, "Single:", " ", /* @__PURE__ */ _("select", { value: id2 || "none", onChange }, /* @__PURE__ */ _("option", { value: "none" }, "Select an example"), entries.map(([id3]) => /* @__PURE__ */ _("option", { key: id3, value: id3 }, id3)))), /* @__PURE__ */ _("button", { onClick: onReset }, "RESET \u{1F501}")));
  }
  function Append({ entries, id: id2 }) {
    function onReset() {
      const url3 = new URL(window.location.href);
      url3.searchParams.delete("id");
      window.location.href = url3.toString();
    ...
    return /* @__PURE__ */ _(b, null, /* @__PURE__ */ _("form", { class: Components_default.buttonRow, onSubmit }, /* @__PURE__ */ _("label", null, "Append:", " ", /* @__PURE__ */ _("select", { value: "none", name: "add-id" }, /* @__PURE__ */ _("option", { value: "none" }, "Select an example"), entries.map(([id3]) => /* @__PURE__ */ _("option", { key: id3, value: id3 }, id3)))), /* @__PURE__ */ _("button", null, "Confirm")));
  }
  ...
  var AndroidMessagingConfig = class {
    ...
    subscribe(id2, callback) {
      this.listeners.set(id2, callback);
      return () => {
  ...
  var Messaging = class {
     ...
     */
    request(name, data = {}) {
      const id2 = globalThis?.crypto?.randomUUID?.() || name + ".response";
