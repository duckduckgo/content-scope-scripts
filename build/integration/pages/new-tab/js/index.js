...
(() => {
      ...
      if ("function" == typeof T4)
        try {
          ...
          if (h3.context = S2, h3.props = m3, h3.__P = n2, h3.__e = false, $2 = l.__r, I2 = 0, x4) {
            for (h3.state = h3.__s, h3.__d = false, $2 && $2(u3), a3 = h3.render(h3.props, h3.state, h3.context), H3 = 0; H3 < h3._sb.length; H3++)
  ...
  function z(u3, t3, i4, o3, r3, f3, e3, c3, s3) {
    ...
    if (null === C4)
      ...
      for (a3 in k3)
        _3 = k3[a3], "children" == a3 ? d3 = _3 : "dangerouslySetInnerHTML" == a3 ? v3 = _3 : "value" == a3 ? g4 = _3 : "checked" == a3 ? m3 = _3 : c3 && "function" != typeof _3 || b2[a3] === _3 || A(u3, a3, _3, b2[a3], r3);
      if (v3)
        c3 || p3 && (v3.__html === p3.__html || v3.__html === u3.innerHTML) || (u3.innerHTML = v3.__html), t3.__k = [];
      else if (p3 && (u3.innerHTML = ""), P(u3, y(d3) ? d3 : [d3], t3, i4, o3, "foreignObject" === C4 ? "http://www.w3.org/1999/xhtml" : r3, f3, e3, f3 ? f3[0] : i4.__k && x(i4, 0), c3, s3), null != f3)
        for (a3 = f3.length; a3--; )
          w(f3[a3]);
    ...
    if (null != t3) {
      ...
      try {
        if (i4 = (t3 = t3.call(r3)).next, 0 === l3) {
          ...
          for (; !(f3 = (e3 = i4.call(t3)).done) && (a3.push(e3.value), a3.length !== l3); f3 = true)
            ;
      } catch (r4) {
        o3 = true, n2 = r4;
      } finally {
  ...
  function attachClosestEdge(userData, _ref) {
    ...
    var addClosestEdge = (_entries$sort$0$edge = (_entries$sort$ = entries.sort(function(a3, b2) {
  ...
  var InstanceIdContext = G(getInstanceId());
  function useGridState(favorites2, setFavorites, animation) {
    ...
    y2(() => {
      return monitorForElements({
        ...
        onDrop({ source, location: location2 }) {
          ...
          const startIndex = favorites2.findIndex((item) => item.data === startSrc);
          const indexOfTarget = favorites2.findIndex((item) => item.data === destinationSrc);
    ...
    }, [instanceId, favorites2, animation]);
  }

  // pages/new-tab/app/favorites/Tile.js
  function Tile({ data, visible, favicon, index, title, id }) {
    ...
    return /* @__PURE__ */ _(
      ...
      /* @__PURE__ */ _("div", { class: (0, import_classnames.default)(Favorites_default.icon, Favorites_default.draggable) }, visible && /* @__PURE__ */ _("img", { src: favicon, loading: "lazy", class: Favorites_default.favicon, alt: `favicon for ${title}` })),
      /* @__PURE__ */ _("div", { class: Favorites_default.text }, title),
      state.type === "is-dragging-over" && state.closestEdge ? /* @__PURE__ */ _("div", { class: Favorites_default.dropper, "data-edge": state.closestEdge }) : null
    );
  }
  function useTileState(url3, id) {
    const ref = A2(null);
    ...
    y2(() => {
      ...
      return combine(
        ...
        dropTargetForElements({
          element: el,
          getData: ({ input }) => {
            return attachClosestEdge({ url: url3, id }, {
              element: el,
              input,
  ...
  var FavoritesDispatchContext = G(
    /** @type {import("preact/hooks").Dispatch<Events>} */
    {}
  );
  ...
  function FavoritesProvider({ children }) {
    ...
    useDataSubscription({ dispatch, service });
    const { toggle } = useConfigSubscription({ dispatch, service });
    const listDidReOrder = q2((favorites2, id, targetIndex) => {
      if (!service.current)
        return;
      service.current.setFavoritesOrder({ favorites: favorites2 }, id, targetIndex);
    }, [service]);
    const openContextMenu = q2((id) => {
      if (!service.current)
        return;
    ...
    return /* @__PURE__ */ _(InstanceIdContext.Provider, { value: instanceId }, /* @__PURE__ */ _(FavoritesContext.Provider, { value: { state, toggle, listDidReOrder, openContextMenu, add: add2 } }, /* @__PURE__ */ _(FavoritesDispatchContext.Provider, { value: dispatch }, children)));
  }
  ...
  function FavoritesConfigured({ gridRef, favorites: favorites2, listDidReOrder, expansion, toggle, animateItems, openContextMenu, add: add2 }) {
    useGridState(favorites2, listDidReOrder, animateItems);
    const { t: t3 } = useTypedTranslation();
    ...
    const items = T2(() => {
      return favorites2.map((item, index) => {
        ...
        return /* @__PURE__ */ _("div", { key: `placeholder-${index}`, class: (0, import_classnames2.default)(Favorites_default.icon, Favorites_default.placeholder) });
      }));
    ...
    return /* @__PURE__ */ _("div", { class: Favorites_default.root, "data-testid": "FavoritesConfigured" }, /* @__PURE__ */ _(
      "div",
      {
        class: Favorites_default.grid,
        id: WIDGET_ID,
        ref: gridRef,
        onContextMenu
      },
      items.slice(0, expansion === "expanded" ? void 0 : ROW_CAPACITY)
    ), /* @__PURE__ */ _(
      "div",
      {
  ...
  function PlusIcon({ onClick }) {
    const labelId = g2();
    return /* @__PURE__ */ _("div", { class: Favorites_default.item }, /* @__PURE__ */ _(
      "button",
      {
        class: (0, import_classnames2.default)(Favorites_default.icon, Favorites_default.placeholder, Favorites_default.plus),
        "aria-labelledby": labelId,
        onClick
      },
      /* @__PURE__ */ _("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none" }, /* @__PURE__ */ _(
        "path",
        {
          "fill-rule": "evenodd",
          "clip-rule": "evenodd",
    ...
    ), /* @__PURE__ */ _("div", { class: Favorites_default.text, id: labelId }, "Add Favorite"));
  }
  ...
  function FavoritesConsumer() {
    const { state, toggle, listDidReOrder, openContextMenu, add: add2 } = x2(FavoritesContext);
    if (state.status === "ready") {
      return /* @__PURE__ */ _(
        Favorites,
        {
  ...
  var Customizer_default = {
    ...
    lowerRight: "Customizer_lowerRight",
    ...
    menuItem: "Customizer_menuItem",
    menuItemLabel: "Customizer_menuItemLabel",
    svg: "Customizer_svg",
    checkbox: "Customizer_checkbox"
  };
  ...
  function CustomizerMenu({ widgets, widgetConfigItems, toggle, metaData }) {
    ...
    return /* @__PURE__ */ _("div", { class: Customizer_default.root, ref: dropdownRef }, /* @__PURE__ */ _(
      ...
      {
        id: MENU_ID,
        class: (0, import_classnames3.default)(Customizer_default.dropdownMenu, { [Customizer_default.show]: isOpen }),
        "aria-labelledby": BUTTON_ID
      },
      /* @__PURE__ */ _("h2", { class: "sr-only" }, "Customize New Tab Page"),
      /* @__PURE__ */ _("ul", { class: Customizer_default.list }, widgets.map((widget) => {
        ...
        return /* @__PURE__ */ _("li", { key: widget.id }, /* @__PURE__ */ _("label", { className: Customizer_default.menuItemLabel }, /* @__PURE__ */ _(
          "input",
          {
            type: "checkbox",
            checked: matchingConfig.visibility === "visible",
            onChange: () => toggle(widget.id),
            className: Customizer_default.checkbox
          }
        ), /* @__PURE__ */ _("span", { class: Customizer_default.svg }, meta?.icon === "star" && /* @__PURE__ */ _(DuckFoot, null), meta?.icon === "shield" && /* @__PURE__ */ _(Shield, null)), /* @__PURE__ */ _("span", null, meta?.title ?? widget.id)));
      }))
    ));
  }
  ...
  function CustomizerMenuPositioned({ children }) {
    return /* @__PURE__ */ _("div", { class: Customizer_default.lowerRight }, children);
  }
  ...
  function MockFavoritesProvider({
    data = favorites.many,
    ...
    const listDidReOrder = q2((newList) => {
  ...
  var otherExamples = {
    ...
    "customizer-menu": {
      factory: () => /* @__PURE__ */ _("div", { style: { minHeight: "300px", position: "relative" } }, /* @__PURE__ */ _(CustomizerMenuPositioned, null, /* @__PURE__ */ _(
        CustomizerMenu,
        {
          toggle: noop("toggle"),
      ...
      request(_msg) {
        ...
        switch (msg.method) {
          ...
          case "favorites_getData": {
            const dataToWrite = url2.searchParams.has("favorites") ? gen(Number(url2.searchParams.get("favorites"))) : read("favorites_data") || favorites.many;
