...
(() => {
  ...
  // pages/new-tab/app/remote-messaging-framework/RemoteMessagingFramework.js
  function RemoteMessagingFramework({ id, messageType, titleText, descriptionText, icon, primaryActionText = "", primaryAction, secondaryActionText = "", secondaryAction }) {
    return /* @__PURE__ */ _("div", { id, class: (0, import_classnames2.default)(RemoteMessagingFramework_default.root, icon && RemoteMessagingFramework_default.icon) }, icon && /* @__PURE__ */ _("span", { class: RemoteMessagingFramework_default.iconBlock }, /* @__PURE__ */ _(MessageIcons, { name: icon })), /* @__PURE__ */ _("div", { class: RemoteMessagingFramework_default.content }, /* @__PURE__ */ _("p", { class: RemoteMessagingFramework_default.title }, titleText), /* @__PURE__ */ _("p", null, descriptionText), messageType === "big_two_action" && /* @__PURE__ */ _("div", { className: "buttonRow" }, primaryActionText.length && /* @__PURE__ */ _("button", { class: (0, import_classnames2.default)(RemoteMessagingFramework_default.btn, RemoteMessagingFramework_default.primary), onClick: primaryAction }, primaryActionText), secondaryActionText.length > 0 && /* @__PURE__ */ _("button", { class: (0, import_classnames2.default)(RemoteMessagingFramework_default.btn, RemoteMessagingFramework_default.secondary), onClick: secondaryAction }, secondaryActionText))), messageType === "big_single_action" && primaryActionText && primaryAction && /* @__PURE__ */ _("button", { class: (0, import_classnames2.default)(RemoteMessagingFramework_default.btn), onClick: primaryAction }, primaryActionText));
  }
