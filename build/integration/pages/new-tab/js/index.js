...
(() => {
  ...
  var InitialSetupContext = G(
    /** @type {InitialSetupResponse} */
    {}
  );
  var useInitialSetupData = () => x2(InitialSetupContext);
  ...
  function PrivacyStatsConfigured({ parentRef, expansion, data, toggle }) {
    ...
    const WIDGET_ID = g2();
    const TOGGLE_ID = g2();
    return /* @__PURE__ */ _("div", { class: (0, import_classnames2.default)("layout-centered", PrivacyStats_default.root), ref: parentRef }, /* @__PURE__ */ _(
      Heading,
      {
  ...
  function FavoritesCustomized() {
    ...
    return /* @__PURE__ */ _("div", { class: "layout-centered" }, /* @__PURE__ */ _("p", null, "Favourites here... (id: ", /* @__PURE__ */ _("code", null, id), ")"));
  }
  ...
  var UpdateNotificationService = class {
    /**
     * @param {import("../../src/js/index.js").NewTabPage} ntp - The internal data feed, expected to have a `subscribe` method.
  ...
  var UpdateNotificationContext = G({
    /** @type {State} */
    state: { status: "idle", data: null, config: null },
    /** @type {() => void} */
    dismiss: () => {
  ...
  var UpdateNotificationDispatchContext = G(
    /** @type {import("preact/hooks").Dispatch<Events>} */
    {}
  );
  ...
  function UpdateNotificationConsumer() {
    ...
    if (state.status === "ready" && state.data.content) {
      return /* @__PURE__ */ _(PulledUp, null, /* @__PURE__ */ _(
        UpdateNotification,
        {
  ...
  var widgetMap = {
    ...
    updateNotification: () => /* @__PURE__ */ _(UpdateNotificationProvider, null, /* @__PURE__ */ _(UpdateNotificationConsumer, null))
  };
  function WidgetList() {
  ...
  function createSpecialPageMessaging(opts) {
    ...
    try {
      if (opts.injectName === "windows") {
        ...
        return opts2.intoMessaging(messageContext);
