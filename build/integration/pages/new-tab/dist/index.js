...
(() => {
  ...
  function Tile_({ url: url4, etldPlusOne, faviconSrc, faviconMax, index, title, id, dropped, visibility, theme }) {
    ...
    return /* @__PURE__ */ g(
      ...
      /* @__PURE__ */ g("div", { class: (0, import_classnames4.default)(Tile_default.icon, Tile_default.draggable) }, visibility === "visible" && /* @__PURE__ */ g(
        ImageWithState,
        {
          faviconSrc,
  ...
  function ImageWithState({ faviconSrc, faviconMax, title, etldPlusOne, theme }) {
    ...
    switch (state) {
      ...
      case states2.using_fallback_text: {
        ...
        return /* @__PURE__ */ g("div", { class: (0, import_classnames4.default)(Tile_default.favicon, Tile_default.faviconText), style, "data-state": state }, /* @__PURE__ */ g("span", null, chars[0]), /* @__PURE__ */ g("span", null, chars[1]));
      }
      /**
  ...
  function Placeholder() {
    ...
    return /* @__PURE__ */ g("div", { class: Tile_default.item, ref, "data-edge": "closestEdge" in state && state.closestEdge }, /* @__PURE__ */ g("div", { class: (0, import_classnames4.default)(Tile_default.icon, Tile_default.placeholder) }), state.type === "is-dragging-over" && state.closestEdge ? /* @__PURE__ */ g("div", { class: Tile_default.dropper, "data-edge": state.closestEdge }) : null);
  }
  function PlusIconWrapper({ onClick }) {
    ...
    const { state, ref } = useItemState(`PLACEHOLDER-URL-${id}`, `PLACEHOLDER-ID-${id}`, { kind: "target" });
    return /* @__PURE__ */ g("div", { class: Tile_default.item, ref, "data-edge": "closestEdge" in state && state.closestEdge }, /* @__PURE__ */ g("button", { class: (0, import_classnames4.default)(Tile_default.icon, Tile_default.plus, Tile_default.draggable), "aria-labelledby": id, onClick }, /* @__PURE__ */ g(PlusIcon, null)), /* @__PURE__ */ g("div", { class: Tile_default.text, id }, t4("favorites_add")), state.type === "is-dragging-over" && state.closestEdge ? /* @__PURE__ */ g("div", { class: Tile_default.dropper, "data-edge": state.closestEdge }) : null);
  }
  ...
  function Favorites({ gridRef, favorites: favorites2, expansion, toggle, openContextMenu, openFavorite, add }) {
    ...
    return /* @__PURE__ */ g(FavoritesThemeContext.Provider, { value: main.value }, /* @__PURE__ */ g(
      "div",
      {
  ...
  function Inner({ rows, safeAreaRef, rowHeight, add }) {
    ...
    return /* @__PURE__ */ g(k, null, subsetOfRowsToRender.map((items, rowIndex) => {
      ...
      return /* @__PURE__ */ g(TileRow, { key: keyed, dropped, items, topOffset, add, visibility: documentVisibility });
    }));
  }
  ...
  function DismissButton({ className, onClick, buttonProps = {} }) {
    const { t: t4 } = useTypedTranslation();
    return /* @__PURE__ */ g("button", { class: (0, import_classnames7.default)(DismissButton_default.btn, className), onClick, "aria-label": t4("ntp_dismiss"), "data-testid": "dismissBtn", ...buttonProps }, /* @__PURE__ */ g(Cross, null));
  }
  ...
  function WithNotes({ notes, version }) {
    ...
    return /* @__PURE__ */ g("details", { ref }, /* @__PURE__ */ g("summary", { tabIndex: -1, className: UpdateNotification_default.summary }, t4("updateNotification_updated_version", { version }), " ", inlineLink), /* @__PURE__ */ g("div", { id, class: UpdateNotification_default.detailsContent }, chunks.map((chunk, index2) => {
  ...
  function DefaultPanel({ checked, onClick }) {
    ...
    ), /* @__PURE__ */ g("span", { id }, t4("customizer_background_selection_default")));
  }
  function ColorPanel(props) {
    ...
    ), /* @__PURE__ */ g("span", { id }, t4("customizer_background_selection_color")));
  }
  function GradientPanel(props) {
    ...
    return /* @__PURE__ */ g(k, null, /* @__PURE__ */ g(
      ...
      props.checked && /* @__PURE__ */ g(CircleCheck, null)
    ), /* @__PURE__ */ g("span", { id }, t4("customizer_background_selection_gradient")));
  }
  function BackgroundImagePanel(props) {
    ...
    const label = empty.value === true ? /* @__PURE__ */ g("span", { id }, t4("customizer_background_selection_image_add")) : /* @__PURE__ */ g("span", { id }, t4("customizer_background_selection_image_existing"));
    if (empty.value === true) {
      return /* @__PURE__ */ g(k, null, /* @__PURE__ */ g(
        "button",
        {
  ...
  function ColorSelection({ data, select, back }) {
    ...
    return /* @__PURE__ */ g("div", null, /* @__PURE__ */ g("button", { type: "button", onClick: back, class: (0, import_classnames16.default)(CustomizerDrawerInner_default.backBtn, CustomizerDrawerInner_default.sectionTitle) }, /* @__PURE__ */ g(BackChevron, null), t4("customizer_background_selection_color")), /* @__PURE__ */ g("div", { class: CustomizerDrawerInner_default.sectionBody }, /* @__PURE__ */ g(InlineErrorBoundary, { format: (message) => `Customizer section 'ColorGrid' threw an exception: ` + message }, /* @__PURE__ */ g("div", { class: (0, import_classnames16.default)(CustomizerDrawerInner_default.bgList), role: "radiogroup", onClick }, /* @__PURE__ */ g(PickerPanel, { data, select }), /* @__PURE__ */ g(ColorGrid, { data })))));
  }
  ...
  function PickerPanel({ data, select }) {
    ...
    ), /* @__PURE__ */ g("span", { class: (0, import_classnames16.default)(CustomizerDrawerInner_default.colorInputIcon, CustomizerDrawerInner_default.dynamicPickerIconColor), "data-color-mode": modeSelected }, /* @__PURE__ */ g(Picker, null)));
  }
  ...
  function GradientSelection({ data, select, back }) {
    ...
    return /* @__PURE__ */ g("div", null, /* @__PURE__ */ g("button", { type: "button", onClick: back, class: (0, import_classnames17.default)(CustomizerDrawerInner_default.backBtn, CustomizerDrawerInner_default.sectionTitle) }, /* @__PURE__ */ g(BackChevron, null), t4("customizer_background_selection_gradient")), /* @__PURE__ */ g("div", { className: CustomizerDrawerInner_default.sectionBody, onClick }, /* @__PURE__ */ g(InlineErrorBoundary, { format: (message) => `Customizer section 'GradientSelection' threw an exception: ` + message }, /* @__PURE__ */ g(GradientGrid, { data }))));
  }
  ...
  function GradientGrid({ data }) {
    ...
    return /* @__PURE__ */ g("ul", { className: (0, import_classnames17.default)(CustomizerDrawerInner_default.bgList) }, entries2.map((key) => {
  ...
  function ImageGrid({ data, deleteImage, onUpload }) {
    ...
    return /* @__PURE__ */ g("ul", { className: (0, import_classnames18.default)(CustomizerDrawerInner_default.bgList) }, entries4.value.map((entry, index) => {
      $INTEGRATION: (() => {
      ...
      return /* @__PURE__ */ g("li", { className: CustomizerDrawerInner_default.bgListItem, key: entry.id }, /* @__PURE__ */ g(
        ...
        /* @__PURE__ */ g("span", { class: "sr-only" }, t4("customizer_image_select", { number: String(index + 1) }))
      ), /* @__PURE__ */ g(
        DismissButton,
        {
          ...
          buttonProps: {
            ...
            "aria-label": t4("customizer_image_delete", { number: String(index + 1) })
          }
        }
      ));
      ...
      return /* @__PURE__ */ g("li", { className: CustomizerDrawerInner_default.bgListItem, key: `placeholder-${diff}-${index}` }, /* @__PURE__ */ g(
        ...
        /* @__PURE__ */ g(PlusIcon, null),
        /* @__PURE__ */ g("span", { class: "sr-only" }, t4("customizer_background_selection_image_add"))
      ));
    }));
  }
  ...
  function BorderedSection({ children }) {
    return /* @__PURE__ */ g("div", { class: (0, import_classnames19.default)(CustomizerDrawerInner_default.section, CustomizerDrawerInner_default.borderedSection) }, children);
  }
  ...
  function SettingsLink() {
    ...
    return /* @__PURE__ */ g("a", { href: "duck://settings", class: (0, import_classnames20.default)(CustomizerDrawerInner_default.settingsLink), onClick }, /* @__PURE__ */ g("span", null, t4("customizer_settings_link")), /* @__PURE__ */ g(Open, null));
  }
  ...
  function CustomizerDrawerInner({ data, select, onUpload, setTheme, deleteImage, customizerContextMenu }) {
    ...
    return /* @__PURE__ */ g("div", { class: CustomizerDrawerInner_default.root }, /* @__PURE__ */ g("header", { class: (0, import_classnames21.default)(CustomizerDrawerInner_default.header, CustomizerDrawerInner_default.internal) }, /* @__PURE__ */ g("h2", null, t4("customizer_drawer_title")), /* @__PURE__ */ g(
      DismissButton,
      {
        onClick: close,
      ...
      /* @__PURE__ */ g(
        TwoCol,
        {
          left: ({ push }) => /* @__PURE__ */ g("div", { class: CustomizerDrawerInner_default.sections }, /* @__PURE__ */ g(CustomizerSection, { title: t4("customizer_section_title_background") }, /* @__PURE__ */ g(BackgroundSection, { data, onNav: push, onUpload, select })), /* @__PURE__ */ g(CustomizerSection, { title: t4("customizer_section_title_theme") }, /* @__PURE__ */ g(BrowserThemeSection, { data, setTheme })), /* @__PURE__ */ g(CustomizerSection, { title: t4("customizer_section_title_sections") }, /* @__PURE__ */ g(VisibilityMenuSection, null)), /* @__PURE__ */ g(BorderedSection, null, /* @__PURE__ */ g(SettingsLink, null))),
  ...
  function TwoCol({ left: left2, right: right2 }) {
    ...
    return /* @__PURE__ */ g("div", { class: CustomizerDrawerInner_default.colwrap }, /* @__PURE__ */ g("div", { class: CustomizerDrawerInner_default.cols, "data-sub": visibleScreen, onTransitionEnd: transitionEnded }, /* @__PURE__ */ g("div", { class: (0, import_classnames21.default)(CustomizerDrawerInner_default.col, CustomizerDrawerInner_default.col1) }, col1.value && left2({ push })), /* @__PURE__ */ g("div", { class: (0, import_classnames21.default)(CustomizerDrawerInner_default.col, CustomizerDrawerInner_default.col2) }, renderedScreen.value !== "home" && right2({ id: renderedScreen.value, pop }))));
  }
  ...
  function App() {
    ...
    return /* @__PURE__ */ g(k, null, /* @__PURE__ */ g(BackgroundConsumer, { browser }), /* @__PURE__ */ g("div", { class: App_default.layout, "data-animating": animating, "data-drawer-visibility": visibility }, /* @__PURE__ */ g("main", { class: (0, import_classnames22.default)(App_default.main, App_default.mainLayout, App_default.mainScroller), "data-main-scroller": true, "data-theme": main }, /* @__PURE__ */ g("div", { class: App_default.content }, /* @__PURE__ */ g("div", { className: App_default.tube, "data-content-tube": true, "data-platform": platformName }, /* @__PURE__ */ g(WidgetList, null)))), /* @__PURE__ */ g("div", { class: App_default.themeContext, "data-theme": main }, /* @__PURE__ */ g(CustomizerMenuPositionedFixed, null, customizerKind === "menu" && /* @__PURE__ */ g(CustomizerMenu, null), customizerKind === "drawer" && /* @__PURE__ */ g(
      CustomizerButton,
      {
        buttonId,
        menuId: drawerId,
