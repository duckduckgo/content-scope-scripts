...
(() => {
  ...
  function BackgroundConsumer({ browser }) {
    ...
    switch (background.kind) {
      ...
      case "gradient": {
        const gradient = values.gradients[background.value];
        return /* @__PURE__ */ g(k, { key: "gradient" }, /* @__PURE__ */ g(ImageCrossFade, { src: gradient.path }), /* @__PURE__ */ g(
          "div",
          {
  ...
  function ImageCrossFade({ src }) {
    ...
    return /* @__PURE__ */ g(k, null, /* @__PURE__ */ g("img", { src: stable, class: BackgroundReceiver_default.root, style: { display: src === stable ? "none" : "block" } }), /* @__PURE__ */ g(
      "img",
      {
        src,
  ...
  function VisibilityMenu({ rows }) {
    const MENU_ID = g2();
    return /* @__PURE__ */ g("ul", { className: (0, import_classnames2.default)(VisibilityMenu_default.list) }, rows.map((row) => {
  ...
  function EmbeddedVisibilityMenu({ rows }) {
    ...
    return /* @__PURE__ */ g("ul", { className: (0, import_classnames2.default)(VisibilityMenu_default.list, VisibilityMenu_default.embedded) }, rows.map((row) => {
      return /* @__PURE__ */ g("li", { key: row.id }, /* @__PURE__ */ g("div", { class: (0, import_classnames2.default)(VisibilityMenu_default.menuItemLabel, VisibilityMenu_default.menuItemLabelEmbedded) }, /* @__PURE__ */ g("span", { className: VisibilityMenu_default.svg }, row.icon === "shield" && /* @__PURE__ */ g(DuckFoot, null), row.icon === "star" && /* @__PURE__ */ g(Shield, null)), /* @__PURE__ */ g("span", null, row.title ?? row.id), /* @__PURE__ */ g(
        Switch,
        {
          theme: browser.value,
          platformName,
  ...
  function Customizer() {
    ...
    const MENU_ID = g2();
    const BUTTON_ID = g2();
    return /* @__PURE__ */ g("div", { class: Customizer_default.root, ref: dropdownRef }, /* @__PURE__ */ g(CustomizerButton, { buttonId: BUTTON_ID, menuId: MENU_ID, toggleMenu, buttonRef, isOpen }), /* @__PURE__ */ g("div", { id: MENU_ID, class: (0, import_classnames3.default)(Customizer_default.dropdownMenu, { [Customizer_default.show]: isOpen }), "aria-labelledby": BUTTON_ID }, /* @__PURE__ */ g(VisibilityMenuPopover, null, /* @__PURE__ */ g(VisibilityMenu, { rows: rowData }))));
  }
  function getItems() {
    const next = [];
    const detail = {
  ...
  var T3, A3, F3, U, H2, q3, G2, J2, K, Q, X, en, cn4, ln, fn, an, sn;
  var init_compat_module = __esm({
    "../node_modules/preact/compat/dist/compat.module.js"() {
      ...
      l.diffed = function(n3) {
        ...
        null != e4 && "textarea" === n3.type && "value" in t4 && t4.value !== e4.value && (e4.value = null == t4.value ? "" : t4.value), cn4 = null;
      };
    }
  });
  ...
  function Tile_({ url: url4, faviconSrc, faviconMax, index, title, id, dropped }) {
    ...
    return /* @__PURE__ */ g(
      ...
      /* @__PURE__ */ g("div", { class: (0, import_classnames5.default)(Tile_default.icon, Tile_default.draggable) }, /* @__PURE__ */ g(ImageLoader, { faviconSrc: faviconSrc || "n/a", faviconMax: faviconMax || DDG_DEFAULT_ICON_SIZE, title, url: url4 })),
  ...
  function Placeholder() {
    ...
    return /* @__PURE__ */ g("div", { className: Tile_default.item, ref, "data-edge": "closestEdge" in state && state.closestEdge }, /* @__PURE__ */ g("div", { className: (0, import_classnames5.default)(Tile_default.icon, Tile_default.placeholder) }), state.type === "is-dragging-over" && state.closestEdge ? /* @__PURE__ */ g("div", { class: Tile_default.dropper, "data-edge": state.closestEdge }) : null);
  }
  function PlusIconWrapper({ onClick }) {
    ...
    const { state, ref } = useItemState(`PLACEHOLDER-URL-${id}`, `PLACEHOLDER-ID-${id}`);
    return /* @__PURE__ */ g("div", { class: Tile_default.item, ref, "data-edge": "closestEdge" in state && state.closestEdge }, /* @__PURE__ */ g("button", { class: (0, import_classnames5.default)(Tile_default.icon, Tile_default.plus, Tile_default.draggable), "aria-labelledby": id, onClick }, /* @__PURE__ */ g(PlusIcon, null)), /* @__PURE__ */ g("div", { class: Tile_default.text, id }, t4("favorites_add")), state.type === "is-dragging-over" && state.closestEdge ? /* @__PURE__ */ g("div", { class: Tile_default.dropper, "data-edge": state.closestEdge }) : null);
  }
  ...
  function NextStepsCardGroup({ types, expansion, toggle, action, dismiss }) {
    ...
    return /* @__PURE__ */ g("div", { class: (0, import_classnames11.default)(NextSteps_default.cardGroup, types.length <= 2 && NextSteps_default.noExpansionBtn), id: WIDGET_ID }, /* @__PURE__ */ g(NextStepsBubbleHeader, null), /* @__PURE__ */ g("div", { class: NextSteps_default.cardGrid }, alwaysShown.map((type) => /* @__PURE__ */ g(NextStepsCard, { key: type, type, dismiss, action })), expansion === "expanded" && types.length > 2 && types.slice(2).map((type) => /* @__PURE__ */ g(NextStepsCard, { key: type, type, dismiss, action }))), types.length > 2 && /* @__PURE__ */ g(
      "div",
      {
  ...
  function Heading({ expansion, trackerCompanies, onToggle, buttonAttrs = {} }) {
    ...
    )), recent === 0 && /* @__PURE__ */ g("p", { className: PrivacyStats_default.subtitle }, t4("stats_noActivity")), recent > 0 && /* @__PURE__ */ g("p", { className: (0, import_classnames12.default)(PrivacyStats_default.subtitle, PrivacyStats_default.uppercase) }, t4("stats_feedCountBlockedPeriod")));
  }
  ...
  function UpdateNotification({ notes, dismiss, version }) {
    return /* @__PURE__ */ g("div", { class: UpdateNotification_default.root, "data-reset-layout": "true" }, /* @__PURE__ */ g("div", { class: (0, import_classnames14.default)("layout-centered", UpdateNotification_default.body) }, notes.length > 0 ? /* @__PURE__ */ g(WithNotes, { notes, version }) : /* @__PURE__ */ g(WithoutNotes, { version })), /* @__PURE__ */ g(DismissButton, { onClick: dismiss, className: UpdateNotification_default.dismiss }));
  }
  ...
  function BackgroundSection({ data, onNav, onUpload, select }) {
    ...
    return /* @__PURE__ */ g("ul", { class: (0, import_classnames15.default)(CustomizerDrawerInner_default.bgList), role: "radiogroup" }, /* @__PURE__ */ g("li", { class: CustomizerDrawerInner_default.bgListItem }, /* @__PURE__ */ g(
      DefaultPanel,
      {
  ...
  function BrowserThemeSection(props) {
    ...
    return /* @__PURE__ */ g("ul", { class: BrowserThemeSection_default.themeList }, /* @__PURE__ */ g("li", { class: BrowserThemeSection_default.themeItem }, /* @__PURE__ */ g(
    ...
    ), "Light"), /* @__PURE__ */ g("li", { class: BrowserThemeSection_default.themeItem }, /* @__PURE__ */ g(
      "button",
      {
      ...
      /* @__PURE__ */ g("span", { class: "sr-only" }, "Select dark theme")
    ), "Dark"), /* @__PURE__ */ g("li", { class: BrowserThemeSection_default.themeItem }, /* @__PURE__ */ g(
      "button",
      {
      ...
      /* @__PURE__ */ g("span", { class: "sr-only" }, "Select system theme")
    ), "System"));
  }
  ...
  function InlineError({ children, named, fallback }) {
    ...
    const fallbackElement = fallback?.(inlineMessage) || /* @__PURE__ */ g("p", null, inlineMessage);
    return /* @__PURE__ */ g(ErrorBoundary, { didCatch: (error) => didCatch(error, named), fallback: fallbackElement }, children);
  }
  ...
  function ColorSelection({ data, select, back }) {
    ...
    return /* @__PURE__ */ g("div", null, /* @__PURE__ */ g("button", { type: "button", onClick: back, class: (0, import_classnames17.default)(CustomizerDrawerInner_default.backBtn, CustomizerDrawerInner_default.sectionTitle) }, /* @__PURE__ */ g(BackChevron, null), "Solid Colors"), /* @__PURE__ */ g("div", { class: CustomizerDrawerInner_default.sectionBody }, /* @__PURE__ */ g(InlineError, { named: "ColorGrid" }, /* @__PURE__ */ g("div", { class: (0, import_classnames17.default)(CustomizerDrawerInner_default.bgList), role: "radiogroup", onClick }, /* @__PURE__ */ g(PickerPanel, { data, select }), /* @__PURE__ */ g(ColorGrid, { data })))));
  }
  ...
  function GradientSelection({ data, select, back }) {
    ...
    return /* @__PURE__ */ g("div", null, /* @__PURE__ */ g("button", { type: "button", onClick: back, class: (0, import_classnames18.default)(CustomizerDrawerInner_default.backBtn, CustomizerDrawerInner_default.sectionTitle) }, /* @__PURE__ */ g(BackChevron, null), "Gradients"), /* @__PURE__ */ g("div", { className: CustomizerDrawerInner_default.sectionBody, onClick }, /* @__PURE__ */ g(InlineError, { named: "GradientSelection" }, /* @__PURE__ */ g(GradientGrid, { data }))));
  }
  ...
  function GradientGrid({ data }) {
    ...
    return /* @__PURE__ */ g("ul", { className: (0, import_classnames18.default)(CustomizerDrawerInner_default.bgList) }, entries2.map(([key, entry]) => {
  ...
  function ImageSelection({ data, select, back, onUpload, deleteImage }) {
    ...
    return /* @__PURE__ */ g("div", null, /* @__PURE__ */ g("button", { type: "button", onClick: back, class: (0, import_classnames19.default)(CustomizerDrawerInner_default.backBtn, CustomizerDrawerInner_default.sectionTitle) }, /* @__PURE__ */ g(BackChevron, null), "My Backgrounds"), /* @__PURE__ */ g("div", { className: CustomizerDrawerInner_default.sectionBody, onClick }, /* @__PURE__ */ g(InlineError, { named: "Image Selection" }, /* @__PURE__ */ g(ImageGrid, { data, deleteImage, onUpload }))), /* @__PURE__ */ g("div", { className: CustomizerDrawerInner_default.sectionBody }, /* @__PURE__ */ g("p", null, t4("customizer_image_privacy"))));
  }
  function ImageGrid({ data, deleteImage, onUpload }) {
    ...
    return /* @__PURE__ */ g("ul", { className: (0, import_classnames19.default)(CustomizerDrawerInner_default.bgList) }, entries4.value.map((entry, index) => {
      $INTEGRATION: (() => {
      ...
      return /* @__PURE__ */ g("li", { className: CustomizerDrawerInner_default.bgListItem, key: entry.id }, /* @__PURE__ */ g(
        ...
        /* @__PURE__ */ g("span", { class: "sr-only" }, "Select image ", index + 1)
      ), /* @__PURE__ */ g(
        DismissButton,
        {
      ...
      return /* @__PURE__ */ g("li", { className: CustomizerDrawerInner_default.bgListItem, key: `placeholder-${diff}-${index}` }, /* @__PURE__ */ g(
        ...
        /* @__PURE__ */ g(PlusIcon, null),
        /* @__PURE__ */ g("span", { class: "sr-only" }, "Add Background")
      ));
    }));
  }
  ...
  function SettingsLink() {
    ...
    return /* @__PURE__ */ g("a", { href: "duck://settings", class: (0, import_classnames21.default)(CustomizerDrawerInner_default.settingsLink), onClick }, /* @__PURE__ */ g("span", null, "Go to Settings"), /* @__PURE__ */ g(Open, null));
  }
  ...
  function CustomizerDrawerInner({ data, select, onUpload, setTheme, deleteImage }) {
    ...
    return /* @__PURE__ */ g("div", { class: CustomizerDrawerInner_default.root }, /* @__PURE__ */ g("header", { class: (0, import_classnames22.default)(CustomizerDrawerInner_default.header, CustomizerDrawerInner_default.internal) }, /* @__PURE__ */ g("h2", null, "Customize"), /* @__PURE__ */ g(
      DismissButton,
      {
        onClick: close,
      ...
      /* @__PURE__ */ g(
        TwoCol,
        {
          left: ({ push }) => /* @__PURE__ */ g("div", { class: CustomizerDrawerInner_default.sections }, /* @__PURE__ */ g(CustomizerSection, { title: "Background" }, /* @__PURE__ */ g(BackgroundSection, { data, onNav: push, onUpload, select })), /* @__PURE__ */ g(CustomizerSection, { title: "Browser Theme" }, /* @__PURE__ */ g(BrowserThemeSection, { data, setTheme })), /* @__PURE__ */ g(CustomizerSection, { title: "Sections" }, /* @__PURE__ */ g(VisibilityMenuSection, null)), /* @__PURE__ */ g(BorderedSection, null, /* @__PURE__ */ g(SettingsLink, null))),
          right: ({ id, pop }) => /* @__PURE__ */ g(k, null, id === "color" && /* @__PURE__ */ g(ColorSelection, { data, select, back: pop }), id === "gradient" && /* @__PURE__ */ g(GradientSelection, { data, select, back: pop }), id === "image" && /* @__PURE__ */ g(ImageSelection, { data, select, back: pop, onUpload, deleteImage }))
        }
      )
    ));
  }
  ...
  function App() {
    ...
    return /* @__PURE__ */ g(k, null, /* @__PURE__ */ g(BackgroundConsumer, { browser }), /* @__PURE__ */ g("div", { class: App_default.layout, ref: wrapperRef, "data-animating": animating, "data-drawer-visibility": visibility }, /* @__PURE__ */ g("main", { class: (0, import_classnames23.default)(App_default.main, App_default.mainScroller), "data-main-scroller": true, "data-theme": main }, /* @__PURE__ */ g("div", { class: App_default.content }, /* @__PURE__ */ g("div", { className: App_default.tube, "data-content-tube": true, "data-platform": platformName }, /* @__PURE__ */ g(WidgetList, null))), /* @__PURE__ */ g(CustomizerMenuPositionedFixed, null, customizerKind === "menu" && /* @__PURE__ */ g(Customizer, null), customizerKind === "drawer" && /* @__PURE__ */ g(
      CustomizerButton,
      {
        buttonId,
        menuId: drawerId,
      ...
      /* @__PURE__ */ g("div", { class: App_default.asideContent }, /* @__PURE__ */ g(CustomizerDrawer, { displayChildren }))
    )));
  }
  ...
  var customizerExamples = {
    ...
    "customizer-menu": {
      factory: () => /* @__PURE__ */ g(MaxContent, null, /* @__PURE__ */ g(CustomizerButton, { isOpen: true }), /* @__PURE__ */ g("br", null), /* @__PURE__ */ g(
        VisibilityMenu,
        {
          rows: [
            {
