...
(() => {
  ...
  var init_Activity = __esm({
    "pages/new-tab/app/activity/components/Activity.module.css"() {
      Activity_default = {
        ...
        headingIcon: "Activity_headingIcon",
        heart02: "Activity_heart02",
        heart01: "Activity_heart01",
        title: "Activity_title",
        widgetExpander: "Activity_widgetExpander",
        subtitle: "Activity_subtitle",
        uppercase: "Activity_uppercase",
        list: "Activity_list",
        entering: "Activity_entering",
        "fade-in": "Activity_fade-in",
        entered: "Activity_entered",
        exiting: "Activity_exiting",
        "fade-out": "Activity_fade-out",
        row: "Activity_row",
        otherTrackersRow: "Activity_otherTrackersRow",
        company: "Activity_company",
        icon: "Activity_icon",
        companyImgIcon: "Activity_companyImgIcon",
        name: "Activity_name",
  ...
  function ActivityProvider(props) {
    ...
    return /* @__PURE__ */ _(ActivityContext.Provider, { value: { state, toggle } }, /* @__PURE__ */ _(ActivityDispatchContext.Provider, { value: dispatch }, props.children));
  }
  function useService() {
    const service = A2(
  ...
  var ActivityContext, ActivityDispatchContext;
  ...
  function Heading({ expansion, canExpand, recent, onToggle, buttonAttrs = {} }) {
    ...
    )), recent === 0 && /* @__PURE__ */ _("p", { className: PrivacyStats_default.subtitle }, t4("stats_noActivity")), recent > 0 && /* @__PURE__ */ _("p", { className: (0, import_classnames4.default)(PrivacyStats_default.subtitle, PrivacyStats_default.uppercase) }, t4("stats_feedCountBlockedPeriod")));
  }
  ...
  function Activity({ expansion, data, toggle, animation = "auto-animate" }) {
    if (animation === "view-transitions") {
      return /* @__PURE__ */ _(WithViewTransitions2, { data, expansion, toggle });
    }
    return /* @__PURE__ */ _(ActivityConfigured, { expansion, data, toggle });
  }
  function WithViewTransitions2({ expansion, data, toggle }) {
    const willToggle = q2(() => {
      viewTransition(toggle);
    }, [toggle]);
    return /* @__PURE__ */ _(ActivityConfigured, { expansion, data, toggle: willToggle });
  }
  function ActivityConfigured({ parentRef, expansion, data, toggle }) {
    ...
    const WIDGET_ID = g2();
    const TOGGLE_ID = g2();
    return /* @__PURE__ */ _("div", { class: Activity_default.root, ref: parentRef }, /* @__PURE__ */ _(
      Heading,
      {
        recent,
        onToggle: toggle,
  ...
  function ActivityCustomized() {
    ...
    const drawer = useCustomizerDrawerSettings();
    const sectionTitle = drawer.state === "enabled" ? t4("activity_menuTitle_v2") : t4("activity_menuTitle");
    const { visibility, id, toggle, index } = useVisibility();
    useCustomizer({ title: sectionTitle, id, icon: "shield", toggle, visibility: visibility.value, index });
    if (visibility.value === "hidden") {
      return null;
  ...
  function ActivityConsumer() {
    ...
    if (state.status === "ready") {
      return /* @__PURE__ */ _(Activity, { expansion: state.config.expansion, animation: state.config.animation?.kind, data: state.data, toggle });
    }
    return null;
  }
  ...
  function Tile_({ url: url5, etldPlusOne, faviconSrc, faviconMax, index, title, id, dropped, visibility, theme }) {
  ...
  function ImageWithState({ faviconSrc, faviconMax, title, etldPlusOne, theme }) {
    ...
    switch (state) {
      ...
      case states2.using_fallback_text: {
        ...
        return /* @__PURE__ */ _("div", { class: (0, import_classnames5.default)(Tile_default.favicon, Tile_default.faviconText), style, "data-state": state }, /* @__PURE__ */ _("span", null, chars[0]), /* @__PURE__ */ _("span", null, chars[1]));
      }
      /**
  ...
  var import_classnames5, Tile, states2, PlusIconMemo;
  ...
  function ColorGrid({ data }) {
    ...
    return /* @__PURE__ */ _(b, null, entries.map((key) => {
  ...
  function ImageGrid({ data, deleteImage, onUpload }) {
    ...
    return /* @__PURE__ */ _("ul", { className: (0, import_classnames18.default)(CustomizerDrawerInner_default.bgList) }, entries4.value.map((entry, index) => {
      ...
      return /* @__PURE__ */ _("li", { className: CustomizerDrawerInner_default.bgListItem, key: entry.id }, /* @__PURE__ */ _(
        ...
        /* @__PURE__ */ _("span", { class: "sr-only" }, t4("customizer_image_select", { number: String(index + 1) }))
      ), /* @__PURE__ */ _(
        DismissButton,
        {
  ...
  var new_tab_default = {
    ...
    activity_feedCountBlockedSingular: {
      title: "1 attempt blocked by DuckDuckGo in the last 7 days",
      note: "A summary description of how many tracking attempts where blocked, when only one exists."
    },
    activity_feedCountBlockedPeriod: {
      title: "Past 7 days",
      note: "A summary description indicating the time period of the blocked tracking attempts, which is the past 7 days."
    },
    activity_feedCountBlockedPlural: {
      title: "{count} tracking attempts blocked",
      note: "A summary description of how many tracking attempts were blocked by DuckDuckGo in the last 7 days when there is more than one. E.g., '1,028 tracking attempts blocked."
    },
    activity_toggleLabel: {
      title: "Show recent activity",
      note: "The aria-label text for a toggle button that shows the detailed activity feed"
    },
    activity_hideLabel: {
