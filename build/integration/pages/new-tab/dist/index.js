...
(() => {
  ...
  function ImageWithState({ faviconSrc, faviconMax, title, etldPlusOne, theme, displayKind }) {
    ...
    switch (state) {
      ...
      case states2.using_fallback_text: {
        ...
        return /* @__PURE__ */ g("div", { class: (0, import_classnames4.default)(Tile_default.favicon, sizeClass, Tile_default.faviconText), style, "data-state": state }, /* @__PURE__ */ g("span", null, chars[0]), /* @__PURE__ */ g("span", null, chars[1]));
      }
      /**
  ...
  function Placeholder() {
    ...
    return /* @__PURE__ */ g("div", { class: Tile_default.item, ref, "data-edge": "closestEdge" in state && state.closestEdge }, /* @__PURE__ */ g("div", { class: (0, import_classnames5.default)(Tile_default.icon, Tile_default.placeholder) }, "\xA0"), state.type === "is-dragging-over" && state.closestEdge ? /* @__PURE__ */ g("div", { class: Tile_default.dropper, "data-edge": state.closestEdge }) : null);
  }
      ...
      Tile = M2(
        ...
        function Tile2({ url: url4, etldPlusOne, faviconSrc, faviconMax, theme, index, title, id, visibility, animateItems }) {
          ...
          return /* @__PURE__ */ g(
            ...
            /* @__PURE__ */ g("div", { class: (0, import_classnames5.default)(Tile_default.icon, Tile_default.draggable) }, visibility === "visible" && /* @__PURE__ */ g(
              ImageWithState,
              {
                faviconSrc,
  ...
  function GradientSelection({ data, select, back }) {
    ...
    return /* @__PURE__ */ g("div", null, /* @__PURE__ */ g("button", { type: "button", onClick: back, class: (0, import_classnames18.default)(CustomizerDrawerInner_default.backBtn, CustomizerDrawerInner_default.sectionTitle) }, /* @__PURE__ */ g(BackChevron, null), t4("customizer_background_selection_gradient")), /* @__PURE__ */ g("div", { className: CustomizerDrawerInner_default.sectionBody, onClick }, /* @__PURE__ */ g(InlineErrorBoundary, { format: (message) => `Customizer section 'GradientSelection' threw an exception: ` + message }, /* @__PURE__ */ g(GradientGrid, { data }))));
  }
  ...
  function GradientGrid({ data }) {
    ...
    return /* @__PURE__ */ g("ul", { className: (0, import_classnames18.default)(CustomizerDrawerInner_default.bgList) }, entries2.map((key) => {
      ...
      request(_msg) {
        ...
        switch (msg.method) {
          ...
          case "favorites_getConfig": {
            ...
            if (url3.searchParams.get("favorites.animation") === "view-transitions") {
              fromStorage.animation = { kind: "view-transitions" };
            }
            return Promise.resolve(fromStorage);
          }
