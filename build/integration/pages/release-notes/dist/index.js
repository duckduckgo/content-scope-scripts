...
(() => {
  ...
  function UpdateButton({ releaseData }) {
    ...
    if (status === "loadingError") {
      button = /* @__PURE__ */ g(Button, { onClick: () => messages?.retryFetchReleaseNotes(), variant: "accentBrand" }, "Reload Summary");
    }
  ...
  function App({ children }) {
    ...
    return /* @__PURE__ */ g("main", { className: App_default.main, "data-theme": isDarkMode ? "dark" : "light", "data-platform-name": "windows" }, /* @__PURE__ */ g(ErrorBoundary, { didCatch: ({ error }) => didCatch(error), fallback: /* @__PURE__ */ g(ErrorFallback, null) }, /* @__PURE__ */ g("header", { className: App_default.header }, /* @__PURE__ */ g(DuckDuckGoLogo, null)), /* @__PURE__ */ g("div", { class: App_default.core }, releaseData && /* @__PURE__ */ g(ReleaseNotes, { releaseData })), /* @__PURE__ */ g(WillThrow, null), children));
  }
  function WillThrow() {
    const env = useEnv();
    if (env.willThrow) {
