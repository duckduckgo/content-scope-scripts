...
(() => {
  ...
  function App({ children }) {
    ...
    return /* @__PURE__ */ g("main", { className: App_default.main, "data-theme": isDarkMode ? "dark" : "light" }, /* @__PURE__ */ g(ErrorBoundary, { didCatch, fallback: /* @__PURE__ */ g(ErrorFallback, null) }, /* @__PURE__ */ g("header", { className: App_default.header }, /* @__PURE__ */ g(DuckDuckGoLogo, null)), /* @__PURE__ */ g("div", { class: App_default.core }, releaseData && /* @__PURE__ */ g(ReleaseNotes, { releaseData })), /* @__PURE__ */ g(WillThrow, null), children));
  }
  function WillThrow() {
    const env = useEnv();
    if (env.willThrow) {
