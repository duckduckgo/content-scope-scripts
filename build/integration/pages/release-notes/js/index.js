...
(() => {
  ...
  function StatusText({ status: status2, version }) {
    const { t: t3 } = useTypedTranslation();
    const statusTexts = {
    ...
    return /* @__PURE__ */ y(Text, { variant: "title-2", className: ReleaseNotes_default.statusText }, t3("versionNumber", { version: `${version}` }), " \u2014 ", statusTexts[status2]);
  }
  function StatusIcon({ status: status2, className }) {
    const iconClasses = {
      loaded: ReleaseNotes_default.checkIcon,
      loading: ReleaseNotes_default.spinnerIcon,
      updateReady: ReleaseNotes_default.alertIcon
    };
    return /* @__PURE__ */ y("div", { className: (0, import_classnames5.default)(ReleaseNotes_default.statusIcon, iconClasses[status2], className) });
  }
  ...
  function UpdateStatus({ status: status2, timestamp, version }) {
    return /* @__PURE__ */ y("div", { className: ReleaseNotes_default.statusContainer }, /* @__PURE__ */ y(StatusIcon, { status: status2, className: ReleaseNotes_default.gridIcon }), /* @__PURE__ */ y(StatusText, { status: status2, version }), /* @__PURE__ */ y(StatusTimestamp, { timestamp }));
  }
  function ReleaseNotesHeading({ title, version }) {
    const { t: t3 } = useTypedTranslation();
    return /* @__PURE__ */ y("header", { className: ReleaseNotes_default.notesHeading }, /* @__PURE__ */ y("h2", { className: ReleaseNotes_default.releaseTitle }, title, /* @__PURE__ */ y("span", { className: ReleaseNotes_default.newTag }, t3("new"))), /* @__PURE__ */ y(Text, { variant: "title-2", className: ReleaseNotes_default.releaseVersion }, t3("versionNumber", { version: `${version}` })));
  }
  ...
  function ReleaseNotesContent({ title: releaseTitle, version: releaseVersion, notes: releaseNotes }) {
    if (!releaseTitle || !releaseNotes.length)
      return null;
    return /* @__PURE__ */ y(g, null, /* @__PURE__ */ y(ReleaseNotesHeading, { title: releaseTitle, version: releaseVersion }), /* @__PURE__ */ y("div", { className: ReleaseNotes_default.listGrid }, releaseNotes.map(({ icon, title, notes }) => /* @__PURE__ */ y("div", { class: ReleaseNotes_default.listContainer }, title && /* @__PURE__ */ y(ReleaseNotesSubheading, { title, icon }), /* @__PURE__ */ y(ReleaseNotesList, { notes })))));
  }
  function ReleaseNotes({ releaseData }) {
    ...
    const { status: status2, currentVersion, lastUpdate, latestVersion, releaseTitle, releaseNotes, releaseNotesPrivacyPro } = releaseData;
    ...
    return /* @__PURE__ */ y("article", { className: ReleaseNotes_default.article }, /* @__PURE__ */ y("header", { className: ReleaseNotes_default.heading }, /* @__PURE__ */ y(PageTitle, { title: t3("browserReleaseNotes") }), /* @__PURE__ */ y(UpdateStatus, { status: status2, timestamp: timestampInMilliseconds, version: currentVersion }), status2 === "updateReady" && /* @__PURE__ */ y("div", { className: ReleaseNotes_default.buttonContainer }, /* @__PURE__ */ y(Button, { onClick: onRestartButtonClick }, t3("restartToUpdate")))), /* @__PURE__ */ y(Card, { className: ReleaseNotes_default.card }, status2 === "loading" ? /* @__PURE__ */ y(ContentPlaceholder, null) : /* @__PURE__ */ y(
      ReleaseNotesContent,
      {
        title: releaseTitle,
  ...
  async function init(messages2, baseEnvironment2) {
    const init2 = await messages2.initialSetup();
  ...
  var WindowsNotification = class {
     ...
     */
    constructor(params2) {
      this.Feature = params2.Feature;
      this.SubFeatureName = params2.SubFeatureName;
  ...
  var RequestMessage = class {
     ...
     */
    constructor(params2) {
      this.context = params2.context;
      this.featureName = params2.featureName;
      this.method = params2.method;
      this.id = params2.id;
      this.params = params2.params;
    }
  };
  ...
  var Subscription = class {
    ...
    constructor(params2) {
      this.context = params2.context;
      this.featureName = params2.featureName;
      this.subscriptionName = params2.subscriptionName;
    }
  };
  ...
  var WebkitMessagingConfig = class {
     ...
     */
    constructor(params2) {
      this.hasModernWebkitAPI = params2.hasModernWebkitAPI;
      this.webkitMessageHandlerNames = params2.webkitMessageHandlerNames;
      this.secret = params2.secret;
    }
  };
  var SecureMessagingParams = class {
     ...
     */
    constructor(params2) {
      this.methodName = params2.methodName;
      this.secret = params2.secret;
  ...
  var AndroidMessagingConfig = class {
     ...
     */
    constructor(params2) {
      this.target = params2.target;
      this.debug = params2.debug;
      this.javascriptInterface = params2.javascriptInterface;
      this.messageSecret = params2.messageSecret;
      this.messageCallback = params2.messageCallback;
  ...
  var Environment = class _Environment {
    ...
    withDisplay(display2) {
      if (!display2)
        return this;
      if (display2 !== "app" && display2 !== "components")
        return this;
      return new _Environment({
        ...this,
        display: display2
  ...
  var ReleaseNotesPage = class {
     ...
     * @internal
     */
    constructor(messaging2, injectName, status2 = "loaded") {
      this.messaging = createTypedMessages(this, messaging2);
      this.injectName = injectName;
      this.setupIntegration(status2);
    }
    /**
     * Sets up integration environment
     * @param {UpdateMessage['status']} status
     */
    setupIntegration(status2) {
      if (this.injectName !== "integration")
        return;
      const allowedStates = Object.keys(sampleData);
      this.integrationState = status2 && allowedStates.includes(status2) ? status2 : "loaded";
    }
    /**
     ...
     */
    reportPageException(params2) {
      this.messaging.notify("reportPageException", params2);
    }
    /**
     * This will be sent if the application fails to load.
     * @param {{message: string}} params
     */
    reportInitException(params2) {
      this.messaging.notify("reportInitException", params2);
    }
    /**
  ...
  var status = (
    /** @type {UpdateMessage['status']} */
    params.state || "loaded"
  );
  var baseEnvironment = new Environment().withPlatform(document.documentElement.dataset.platform).withEnv("production").withDisplay(display);
  var messaging = createSpecialPageMessaging({
    injectName: baseEnvironment.platform,
    env: "production",
    pageName: "releaseNotes"
  });
  var messages = new ReleaseNotesPage(messaging, baseEnvironment.platform, status);
