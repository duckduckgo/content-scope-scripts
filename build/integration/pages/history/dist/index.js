...
(() => {
  ...
  function g3(i5) {
    var n3 = this, r4 = i5.data, f4 = useSignal(r4);
    f4.value = r4;
    var e4 = T2(function() {
      var i6 = n3, r5 = n3.__v;
  ...
  y4("__r", function(i5, n3) {
    if ("function" == typeof n3.type && "undefined" != typeof window && window.__PREACT_SIGNALS_DEVTOOLS__) window.__PREACT_SIGNALS_DEVTOOLS__.enterComponent(n3.type.displayName || n3.type.name || "Unknown");
    if (n3.type !== k) {
      _4();
      var t4, o4 = n3.__c;
      if (o4) {
  ...
  function b2(i5, n3, t4, r4) {
    var o4 = n3 in i5 && void 0 === i5.ownerSVGElement, f4 = d3(t4);
    return { o: function(i6, n4) {
      f4.value = i6;
      r4 = n4;
    }, d: E2(function() {
      this.N = F2;
      var t5 = f4.value.value;
      if (r4[n3] !== t5) {
        r4[n3] = t5;
        if (o4) i5[n3] = t5;
  ...
  function A3() {
    r3(function() {
      var i5;
      while (i5 = l4.shift()) h4.call(i5);
    });
  }
  function T3() {
    if (1 === l4.push(this)) (l.requestAnimationFrame || k3)(A3);
  }
  function x3() {
    r3(function() {
      var i5;
  ...
  function F2() {
    if (1 === m3.push(this)) (l.requestAnimationFrame || q3)(x3);
  }
