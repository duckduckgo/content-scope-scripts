...
(() => {
  ...
  function Sidebar({ ranges }) {
    ...
    return /* @__PURE__ */ g("div", { class: Sidebar_default.stack }, /* @__PURE__ */ g("h1", { class: Sidebar_default.pageTitle }, t4("page_title")), /* @__PURE__ */ g("nav", { class: (0, import_classnames4.default)(Sidebar_default.nav, App_default.customScroller) }, ranges.value.map((range) => {
