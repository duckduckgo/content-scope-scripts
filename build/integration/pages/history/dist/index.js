...
(() => {
  ...
  function $() {
    for (var n3, u4, t4, r4, o4, f4, c4, s5 = 1; i.length; ) i.length > s5 && i.sort(e), n3 = i.shift(), s5 = i.length, n3.__d && (t4 = void 0, o4 = (r4 = (u4 = n3).__v).__e, f4 = [], c4 = [], u4.__P && ((t4 = w({}, r4)).__v = r4.__v + 1, l.vnode && l.vnode(t4), j(u4.__P, t4, r4, u4.__n, u4.__P.namespaceURI, 32 & r4.__u ? [o4] : null, f4, null == o4 ? S(r4) : o4, !!(32 & r4.__u), c4), t4.__v = r4.__v, t4.__.__k[t4.__i] = t4, z(f4, t4, c4), t4.__e != o4 && C(t4)));
    $.__r = 0;
  }
  function I(n3, l5, u4, t4, i5, r4, o4, e4, f4, c4, s5) {
    var a4, h5, y5, d5, w5, g6, _5 = t4 && t4.__k || v, m4 = l5.length;
  ...
  function P(n3, l5, u4, t4, i5) {
    ...
    if (a4) for (r4 = 0; r4 < s5; r4++) null != (e4 = u4[r4]) && 0 == (2 & e4.__u) && (e4.__e == t4 && (t4 = S(e4)), q(e4, e4));
    return t4;
  }
  function A(n3, l5, u4) {
    var t4, i5;
  ...
  function j(n3, u4, t4, i5, r4, o4, e4, f4, c4, s5) {
    var a4, h5, p5, v4, y5, _5, m4, b4, S2, C3, M3, $2, P4, A5, H3, L2, T4, F4, O2 = u4.type;
    if (void 0 !== u4.constructor) return null;
    128 & t4.__u && (c4 = !!(32 & t4.__u), o4 = [f4 = u4.__e = t4.__e]), (a4 = l.__b) && a4(u4);
    n: if ("function" == typeof O2) try {
      if (b4 = u4.props, S2 = "prototype" in O2 && O2.prototype.render, C3 = (a4 = O2.contextType) && i5[a4.__c], M3 = a4 ? C3 ? C3.props.value : a4.__ : i5, t4.__c ? m4 = (h5 = u4.__c = t4.__c).__ = h5.__E : (S2 ? u4.__c = h5 = new O2(b4, M3) : (u4.__c = h5 = new x(b4, M3), h5.constructor = O2, h5.render = B), C3 && C3.sub(h5), h5.props = b4, h5.state || (h5.state = {}), h5.context = M3, h5.__n = i5, p5 = h5.__d = true, h5.__h = [], h5._sb = []), S2 && null == h5.__s && (h5.__s = h5.state), S2 && null != O2.getDerivedStateFromProps && (h5.__s == h5.state && (h5.__s = w({}, h5.__s)), w(h5.__s, O2.getDerivedStateFromProps(b4, h5.__s))), v4 = h5.props, y5 = h5.state, h5.__v = u4, p5) S2 && null == O2.getDerivedStateFromProps && null != h5.componentWillMount && h5.componentWillMount(), S2 && null != h5.componentDidMount && h5.__h.push(h5.componentDidMount);
      else {
        if (S2 && null == O2.getDerivedStateFromProps && b4 !== v4 && null != h5.componentWillReceiveProps && h5.componentWillReceiveProps(b4, M3), !h5.__e && (null != h5.shouldComponentUpdate && false === h5.shouldComponentUpdate(b4, h5.__s, M3) || u4.__v == t4.__v)) {
      ...
      h5.state = h5.__s, null != h5.getChildContext && (i5 = w(w({}, i5), h5.getChildContext())), S2 && !p5 && null != h5.getSnapshotBeforeUpdate && (_5 = h5.getSnapshotBeforeUpdate(v4, y5)), T4 = (L2 = null != a4 && a4.type === k && null == a4.key) ? a4.props.children : a4, L2 && (a4.props.children = null), f4 = I(n3, d(T4) ? T4 : [T4], u4, t4, i5, r4, o4, e4, f4, c4, s5), h5.base = u4.__e, u4.__u &= -161, h5.__h.length && e4.push(h5), m4 && (h5.__E = h5.__ = null);
    } catch (n4) {
      ...
      } else for (F4 = o4.length; F4--; ) g(o4[F4]);
  ...
  function N(u4, t4, i5, r4, o4, e4, f4, c4, s5) {
    var a4, h5, v4, y5, w5, _5, m4, b4 = i5.props, k4 = t4.props, x4 = t4.type;
    ...
    if (null === x4) b4 === k4 || c4 && u4.data === k4 || (u4.data = k4);
      ...
      if (e4 = e4 && n.call(u4.childNodes), b4 = i5.props || p, !c4 && null != e4) for (b4 = {}, a4 = 0; a4 < u4.attributes.length; a4++) b4[(w5 = u4.attributes[a4]).name] = w5.value;
      ...
      for (a4 in k4) w5 = k4[a4], "children" == a4 ? y5 = w5 : "dangerouslySetInnerHTML" == a4 ? h5 = w5 : "value" == a4 ? _5 = w5 : "checked" == a4 ? m4 = w5 : c4 && "function" != typeof w5 || b4[a4] === w5 || F(u4, a4, w5, b4[a4], o4);
      if (h5) c4 || v4 && (h5.__html === v4.__html || h5.__html === u4.innerHTML) || (u4.innerHTML = h5.__html), t4.__k = [];
      else if (v4 && (u4.innerHTML = ""), I("template" === t4.type ? u4.content : u4, d(y5) ? y5 : [y5], t4, i5, r4, "foreignObject" == x4 ? "http://www.w3.org/1999/xhtml" : o4, e4, f4, e4 ? e4[0] : i5.__k && S(i5, 0), c4, s5), null != e4) for (a4 = e4.length; a4--; ) g(e4[a4]);
      c4 || (a4 = "value", "progress" == x4 && null == _5 ? u4.removeAttribute("value") : void 0 !== _5 && (_5 !== u4[a4] || "progress" == x4 && !_5 || "option" == x4 && _5 !== b4[a4]) && F(u4, a4, _5, b4[a4], o4), a4 = "checked", void 0 !== m4 && m4 !== u4[a4] && F(u4, a4, m4, b4[a4], o4));
    }
    return u4;
  }
  function V(n3, u4, t4) {
  ...
  function D(u4, t4, i5) {
    var r4, o4, e4, f4;
    t4 == document && (t4 = document.documentElement), l.__ && l.__(u4, t4), o4 = (r4 = "function" == typeof i5) ? null : i5 && i5.__k || t4.__k, e4 = [], f4 = [], j(t4, u4 = (!r4 && i5 || t4).__k = _(k, null, [u4]), o4 || p, p, t4.namespaceURI, !r4 && i5 ? [i5] : o4 ? null : t4.firstChild ? n.call(t4.childNodes) : null, e4, !r4 && i5 ? i5 : o4 ? o4.__e : t4.firstChild, r4, f4), z(e4, u4, f4);
  }
  function J(n3) {
    function l5(n4) {
      var u4, t4;
  ...
  var i2;
  null != (i2 = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : void 0) && i2.__PREACT_DEVTOOLS__ && i2.__PREACT_DEVTOOLS__.attachPreact("10.26.2", l, { Fragment: k, Component: x });
