...
(() => {
  ...
  function g(l5, u4, t4) {
    var i4, r3, o4, e4 = {};
    for (o4 in u4) "key" == o4 ? i4 = u4[o4] : "ref" == o4 ? r3 = u4[o4] : e4[o4] = u4[o4];
  ...
  function m(n2, t4, i4, r3, o4) {
    var e4 = { type: n2, props: t4, key: i4, ref: r3, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: null == o4 ? ++u : o4, __i: -1, __u: 0 };
  ...
  function P() {
    var n2, u4, t4, r3, o4, f4, c4, s5;
    for (i.sort(e); n2 = i.shift(); ) n2.__d && (u4 = i.length, r3 = void 0, f4 = (o4 = (t4 = n2).__v).__e, c4 = [], s5 = [], t4.__P && ((r3 = w({}, o4)).__v = o4.__v + 1, l.vnode && l.vnode(r3), j(t4.__P, r3, o4, t4.__n, t4.__P.namespaceURI, 32 & o4.__u ? [f4] : null, c4, null == f4 ? C(o4) : f4, !!(32 & o4.__u), s5), r3.__v = o4.__v, r3.__.__k[r3.__i] = r3, z(c4, r3, s5), r3.__e != f4 && S(r3)), i.length > u4 && i.sort(e));
    P.__r = 0;
  }
  function $(n2, l5, u4, t4, i4, r3, o4, e4, f4, c4, s5) {
    var a4, h4, y4, d5, w4, _4, g3 = t4 && t4.__k || v, m3 = l5.length;
    for (f4 = I(u4, l5, g3, f4, m3), a4 = 0; a4 < m3; a4++) null != (y4 = u4.__k[a4]) && (h4 = -1 === y4.__i ? p : g3[y4.__i] || p, y4.__i = a4, _4 = j(n2, y4, h4, i4, r3, o4, e4, f4, c4, s5), d5 = y4.__e, y4.ref && h4.ref != y4.ref && (h4.ref && V(h4.ref, null, y4), s5.push(y4.ref, y4.__c || d5, y4)), null == w4 && null != d5 && (w4 = d5), 4 & y4.__u || h4.__k === y4.__k ? f4 = A(y4, f4, n2) : "function" == typeof y4.type && void 0 !== _4 ? f4 = _4 : d5 && (f4 = d5.nextSibling), y4.__u &= -7);
    return u4.__e = w4, f4;
  }
  function I(n2, l5, u4, t4, i4) {
    var r3, o4, e4, f4, c4, s5 = u4.length, a4 = s5, h4 = 0;
    for (n2.__k = new Array(i4), r3 = 0; r3 < i4; r3++) null != (o4 = l5[r3]) && "boolean" != typeof o4 && "function" != typeof o4 ? (f4 = r3 + h4, (o4 = n2.__k[r3] = "string" == typeof o4 || "number" == typeof o4 || "bigint" == typeof o4 || o4.constructor == String ? m(null, o4, null, null, null) : d(o4) ? m(k, { children: o4 }, null, null, null) : void 0 === o4.constructor && o4.__b > 0 ? m(o4.type, o4.props, o4.key, o4.ref ? o4.ref : null, o4.__v) : o4).__ = n2, o4.__b = n2.__b + 1, e4 = null, -1 !== (c4 = o4.__i = L(o4, u4, f4, a4)) && (a4--, (e4 = u4[c4]) && (e4.__u |= 2)), null == e4 || null === e4.__v ? (-1 == c4 && h4--, "function" != typeof o4.type && (o4.__u |= 4)) : c4 != f4 && (c4 == f4 - 1 ? h4-- : c4 == f4 + 1 ? h4++ : (c4 > f4 ? h4-- : h4++, o4.__u |= 4))) : n2.__k[r3] = null;
    if (a4) for (r3 = 0; r3 < s5; r3++) null != (e4 = u4[r3]) && 0 == (2 & e4.__u) && (e4.__e == t4 && (t4 = C(e4)), q(e4, e4));
    return t4;
  }
  function A(n2, l5, u4) {
    var t4, i4;
  ...
  function L(n2, l5, u4, t4) {
    var i4, r3, o4 = n2.key, e4 = n2.type, f4 = l5[u4];
    if (null === f4 || f4 && o4 == f4.key && e4 === f4.type && 0 == (2 & f4.__u)) return u4;
    if (t4 > (null != f4 && 0 == (2 & f4.__u) ? 1 : 0)) for (i4 = u4 - 1, r3 = u4 + 1; i4 >= 0 || r3 < l5.length; ) {
      if (i4 >= 0) {
        if ((f4 = l5[i4]) && 0 == (2 & f4.__u) && o4 == f4.key && e4 === f4.type) return i4;
        i4--;
      }
      if (r3 < l5.length) {
        if ((f4 = l5[r3]) && 0 == (2 & f4.__u) && o4 == f4.key && e4 === f4.type) return r3;
        r3++;
      }
    }
    return -1;
  ...
  function F(n2, l5, u4, t4, i4) {
    ...
    else if ("o" == l5[0] && "n" == l5[1]) r3 = l5 != (l5 = l5.replace(f, "$1")), l5 = l5.toLowerCase() in n2 || "onFocusOut" == l5 || "onFocusIn" == l5 ? l5.toLowerCase().slice(2) : l5.slice(2), n2.l || (n2.l = {}), n2.l[l5 + r3] = u4, u4 ? t4 ? u4.u = t4.u : (u4.u = c, n2.addEventListener(l5, r3 ? a : s, r3)) : n2.removeEventListener(l5, r3 ? a : s, r3);
    else {
  ...
  function j(n2, u4, t4, i4, r3, o4, e4, f4, c4, s5) {
    var a4, h4, p5, v5, y4, g3, m3, b2, C3, S2, M2, P2, I2, A3, H, L2, T3, F2 = u4.type;
    if (void 0 !== u4.constructor) return null;
    128 & t4.__u && (c4 = !!(32 & t4.__u), o4 = [f4 = u4.__e = t4.__e]), (a4 = l.__b) && a4(u4);
    n: if ("function" == typeof F2) try {
      if (b2 = u4.props, C3 = "prototype" in F2 && F2.prototype.render, S2 = (a4 = F2.contextType) && i4[a4.__c], M2 = a4 ? S2 ? S2.props.value : a4.__ : i4, t4.__c ? m3 = (h4 = u4.__c = t4.__c).__ = h4.__E : (C3 ? u4.__c = h4 = new F2(b2, M2) : (u4.__c = h4 = new x(b2, M2), h4.constructor = F2, h4.render = B), S2 && S2.sub(h4), h4.props = b2, h4.state || (h4.state = {}), h4.context = M2, h4.__n = i4, p5 = h4.__d = true, h4.__h = [], h4._sb = []), C3 && null == h4.__s && (h4.__s = h4.state), C3 && null != F2.getDerivedStateFromProps && (h4.__s == h4.state && (h4.__s = w({}, h4.__s)), w(h4.__s, F2.getDerivedStateFromProps(b2, h4.__s))), v5 = h4.props, y4 = h4.state, h4.__v = u4, p5) C3 && null == F2.getDerivedStateFromProps && null != h4.componentWillMount && h4.componentWillMount(), C3 && null != h4.componentDidMount && h4.__h.push(h4.componentDidMount);
      else {
        if (C3 && null == F2.getDerivedStateFromProps && b2 !== v5 && null != h4.componentWillReceiveProps && h4.componentWillReceiveProps(b2, M2), !h4.__e && (null != h4.shouldComponentUpdate && false === h4.shouldComponentUpdate(b2, h4.__s, M2) || u4.__v == t4.__v)) {
          for (u4.__v != t4.__v && (h4.props = b2, h4.state = h4.__s, h4.__d = false), u4.__e = t4.__e, u4.__k = t4.__k, u4.__k.some(function(n3) {
            n3 && (n3.__ = u4);
        ...
        null != h4.componentWillUpdate && h4.componentWillUpdate(b2, h4.__s, M2), C3 && null != h4.componentDidUpdate && h4.__h.push(function() {
          h4.componentDidUpdate(v5, y4, g3);
        });
      }
      if (h4.context = M2, h4.props = b2, h4.__P = n2, h4.__e = false, I2 = l.__r, A3 = 0, C3) {
        for (h4.state = h4.__s, h4.__d = false, I2 && I2(u4), a4 = h4.render(h4.props, h4.state, h4.context), H = 0; H < h4._sb.length; H++) h4.__h.push(h4._sb[H]);
        h4._sb = [];
      } else do {
        h4.__d = false, I2 && I2(u4), a4 = h4.render(h4.props, h4.state, h4.context), h4.state = h4.__s;
      } while (h4.__d && ++A3 < 25);
      h4.state = h4.__s, null != h4.getChildContext && (i4 = w(w({}, i4), h4.getChildContext())), C3 && !p5 && null != h4.getSnapshotBeforeUpdate && (g3 = h4.getSnapshotBeforeUpdate(v5, y4)), f4 = $(n2, d(L2 = null != a4 && a4.type === k && null == a4.key ? a4.props.children : a4) ? L2 : [L2], u4, t4, i4, r3, o4, e4, f4, c4, s5), h4.base = u4.__e, u4.__u &= -161, h4.__h.length && e4.push(h4), m3 && (h4.__E = h4.__ = null);
    } catch (n3) {
    ...
    else null == o4 && u4.__v == t4.__v ? (u4.__k = t4.__k, u4.__e = t4.__e) : f4 = u4.__e = N(t4.__e, u4, t4, i4, r3, o4, e4, c4, s5);
  ...
  function N(u4, t4, i4, r3, o4, e4, f4, c4, s5) {
    var a4, h4, v5, y4, w4, g3, m3, b2 = i4.props, k3 = t4.props, x3 = t4.type;
    ...
    if (null === x3) b2 === k3 || c4 && u4.data === k3 || (u4.data = k3);
    else {
      if (e4 = e4 && n.call(u4.childNodes), b2 = i4.props || p, !c4 && null != e4) for (b2 = {}, a4 = 0; a4 < u4.attributes.length; a4++) b2[(w4 = u4.attributes[a4]).name] = w4.value;
      ...
      for (a4 in k3) w4 = k3[a4], "children" == a4 ? y4 = w4 : "dangerouslySetInnerHTML" == a4 ? h4 = w4 : "value" == a4 ? g3 = w4 : "checked" == a4 ? m3 = w4 : c4 && "function" != typeof w4 || b2[a4] === w4 || F(u4, a4, w4, b2[a4], o4);
      if (h4) c4 || v5 && (h4.__html === v5.__html || h4.__html === u4.innerHTML) || (u4.innerHTML = h4.__html), t4.__k = [];
      else if (v5 && (u4.innerHTML = ""), $(u4, d(y4) ? y4 : [y4], t4, i4, r3, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o4, e4, f4, e4 ? e4[0] : i4.__k && C(i4, 0), c4, s5), null != e4) for (a4 = e4.length; a4--; ) _(e4[a4]);
      c4 || (a4 = "value", "progress" == x3 && null == g3 ? u4.removeAttribute("value") : void 0 !== g3 && (g3 !== u4[a4] || "progress" == x3 && !g3 || "option" == x3 && g3 !== b2[a4]) && F(u4, a4, g3, b2[a4], o4), a4 = "checked", void 0 !== m3 && m3 !== u4[a4] && F(u4, a4, m3, b2[a4], o4));
    }
    return u4;
  }
  function V(n2, u4, t4) {
  ...
  function q(n2, u4, t4) {
    ...
    if (i4 = n2.__k) for (r3 = 0; r3 < i4.length; r3++) i4[r3] && q(i4[r3], u4, t4 || "function" != typeof n2.type);
  ...
  function D(u4, t4, i4) {
    var r3, o4, e4, f4;
    t4 == document && (t4 = document.documentElement), l.__ && l.__(u4, t4), o4 = (r3 = "function" == typeof i4) ? null : i4 && i4.__k || t4.__k, e4 = [], f4 = [], j(t4, u4 = (!r3 && i4 || t4).__k = g(k, null, [u4]), o4 || p, p, t4.namespaceURI, !r3 && i4 ? [i4] : o4 ? null : t4.firstChild ? n.call(t4.childNodes) : null, e4, !r3 && i4 ? i4 : o4 ? o4.__e : t4.firstChild, r3, f4), z(e4, u4, f4);
  }
  function J(n2, l5) {
  ...
  n = v.slice, l = { __e: function(n2, l5, u4, t4) {
    for (var i4, r3, o4; l5 = l5.__; ) if ((i4 = l5.__c) && !i4.__) try {
      if ((r3 = i4.constructor) && null != r3.getDerivedStateFromError && (i4.setState(r3.getDerivedStateFromError(n2)), o4 = i4.__d), null != i4.componentDidCatch && (i4.componentDidCatch(n2, t4 || {}), o4 = i4.__d), o4) return i4.__E = i4;
    } catch (l6) {
      n2 = l6;
    }
    throw n2;
  ...
  function p2(n2, u4, i4) {
    ...
    if (o4.t = n2, !o4.__c && (o4.__ = [i4 ? i4(u4) : D2(void 0, u4), function(n3) {
      var t4 = o4.__N ? o4.__N[0] : o4.__[0], r3 = o4.t(t4, n3);
  ...
  var s4;
  function l4(n2, i4) {
    l[n2] = i4.bind(null, l[n2] || function() {
    });
  }
  function d4(n2) {
    if (s4) s4();
  ...
  function p4(n2) {
    var r3 = this, f4 = n2.data, o4 = useSignal(f4);
    o4.value = f4;
    var e4 = T2(function() {
      var n3 = r3.__v;
      ...
      r3.__$u.c = function() {
        var n4, t4 = r3.__$u.S(), f5 = e4.value;
        t4();
        if (t(f5) || 3 !== (null == (n4 = r3.base) ? void 0 : n4.nodeType)) {
          r3.__$f |= 1;
          r3.setState({});
        } else r3.base.data = f5;
      };
      return w3(function() {
  ...
  l4("__r", function(n2, r3) {
    ...
    if (t4) {
      t4.__$f &= -2;
      if (void 0 === (i4 = t4.__$u)) t4.__$u = i4 = function(n3) {
        var r4;
        E(function() {
          r4 = this;
        });
  ...
  l4("diffed", function(n2, r3) {
    ...
    v4 = void 0;
    var i4;
    if ("string" == typeof r3.type && (i4 = r3.__e)) {
      var t4 = r3.__np, f4 = r3.props;
      if (t4) {
        var o4 = i4.U;
  ...
  function _3(n2, r3, i4, t4) {
    var f4 = r3 in n2 && void 0 === n2.ownerSVGElement, o4 = d3(i4);
    return { o: function(n3, r4) {
      ...
      if (t4[r3] !== i5) {
        t4[r3] = i5;
        if (f4) n2[r3] = i5;
        else if (i5) n2.setAttribute(r3, i5);
  ...
  l4("__h", function(n2, r3, i4, t4) {
    if (t4 < 3 || 9 === t4) r3.__$f |= 2;
    n2(r3, i4, t4);
  });
  x.prototype.shouldComponentUpdate = function(n2, r3) {
    var i4 = this.__$u;
    if (!(i4 && void 0 !== i4.s || 4 & this.__$f)) return true;
    if (3 & this.__$f) return true;
    for (var t4 in r3) return true;
    for (var f4 in n2) if ("__source" !== f4 && n2[f4] !== this.props[f4]) return true;
        ...
        switch (msg.method) {
          ...
          case "query": {
            ...
            if (term === "") {
              ...
              const filtered = historyMocks.few.value.filter((x3) => {
                const lowerTerm = term.trim().toLowerCase();
                return x3.title.trim().toLowerCase().includes(lowerTerm) || x3.url.trim().toLowerCase().includes(lowerTerm);
              });
              const next = {
