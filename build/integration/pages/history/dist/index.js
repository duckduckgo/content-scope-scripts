...
(() => {
  ...
  function $() {
    for (var n3, t4, u4, r4, o4, f4, c4, s5 = 1; i.length; ) i.length > s5 && i.sort(e), n3 = i.shift(), s5 = i.length, n3.__d && (u4 = void 0, o4 = (r4 = (t4 = n3).__v).__e, f4 = [], c4 = [], t4.__P && ((u4 = w({}, r4)).__v = r4.__v + 1, l.vnode && l.vnode(u4), O(t4.__P, u4, r4, t4.__n, t4.__P.namespaceURI, 32 & r4.__u ? [o4] : null, f4, null == o4 ? S(r4) : o4, !!(32 & r4.__u), c4), u4.__v = r4.__v, u4.__.__k[u4.__i] = u4, z(f4, u4, c4), u4.__e != o4 && C(u4)));
    $.__r = 0;
  }
  function I(n3, l5, t4, u4, i5, r4, o4, e4, f4, c4, s5) {
    var a4, h5, y5, d5, w5, g6, _5 = u4 && u4.__k || v, m4 = l5.length;
    for (f4 = P(t4, l5, _5, f4, m4), a4 = 0; a4 < m4; a4++) null != (y5 = t4.__k[a4]) && (h5 = -1 === y5.__i ? p : _5[y5.__i] || p, y5.__i = a4, g6 = O(n3, y5, h5, i5, r4, o4, e4, f4, c4, s5), d5 = y5.__e, y5.ref && h5.ref != y5.ref && (h5.ref && q(h5.ref, null, y5), s5.push(y5.ref, y5.__c || d5, y5)), null == w5 && null != d5 && (w5 = d5), 4 & y5.__u || h5.__k === y5.__k ? f4 = A(y5, f4, n3) : "function" == typeof y5.type && void 0 !== g6 ? f4 = g6 : d5 && (f4 = d5.nextSibling), y5.__u &= -7);
    return t4.__e = w5, f4;
  }
  function P(n3, l5, t4, u4, i5) {
    var r4, o4, e4, f4, c4, s5 = t4.length, a4 = s5, h5 = 0;
    for (n3.__k = new Array(i5), r4 = 0; r4 < i5; r4++) null != (o4 = l5[r4]) && "boolean" != typeof o4 && "function" != typeof o4 ? (f4 = r4 + h5, (o4 = n3.__k[r4] = "string" == typeof o4 || "number" == typeof o4 || "bigint" == typeof o4 || o4.constructor == String ? m(null, o4, null, null, null) : d(o4) ? m(k, { children: o4 }, null, null, null) : void 0 === o4.constructor && o4.__b > 0 ? m(o4.type, o4.props, o4.key, o4.ref ? o4.ref : null, o4.__v) : o4).__ = n3, o4.__b = n3.__b + 1, e4 = null, -1 !== (c4 = o4.__i = L(o4, t4, f4, a4)) && (a4--, (e4 = t4[c4]) && (e4.__u |= 2)), null == e4 || null === e4.__v ? (-1 == c4 && (i5 > s5 ? h5-- : i5 < s5 && h5++), "function" != typeof o4.type && (o4.__u |= 4)) : c4 != f4 && (c4 == f4 - 1 ? h5-- : c4 == f4 + 1 ? h5++ : (c4 > f4 ? h5-- : h5++, o4.__u |= 4))) : n3.__k[r4] = null;
    if (a4) for (r4 = 0; r4 < s5; r4++) null != (e4 = t4[r4]) && 0 == (2 & e4.__u) && (e4.__e == u4 && (u4 = S(e4)), B(e4, e4));
    return u4;
  }
  function A(n3, l5, t4) {
    var u4, i5;
  ...
  function L(n3, l5, t4, u4) {
    ...
    if (null === f4 && null == n3.key || f4 && o4 == f4.key && e4 === f4.type && 0 == (2 & f4.__u)) return t4;
  ...
  function O(n3, t4, u4, i5, r4, o4, e4, f4, c4, s5) {
    var a4, h5, p5, v4, y5, _5, m4, b4, S2, C3, M3, $2, P4, A5, H3, L2, T4, j4 = t4.type;
    ...
    n: if ("function" == typeof j4) try {
      if (b4 = t4.props, S2 = "prototype" in j4 && j4.prototype.render, C3 = (a4 = j4.contextType) && i5[a4.__c], M3 = a4 ? C3 ? C3.props.value : a4.__ : i5, u4.__c ? m4 = (h5 = t4.__c = u4.__c).__ = h5.__E : (S2 ? t4.__c = h5 = new j4(b4, M3) : (t4.__c = h5 = new x(b4, M3), h5.constructor = j4, h5.render = D), C3 && C3.sub(h5), h5.props = b4, h5.state || (h5.state = {}), h5.context = M3, h5.__n = i5, p5 = h5.__d = true, h5.__h = [], h5._sb = []), S2 && null == h5.__s && (h5.__s = h5.state), S2 && null != j4.getDerivedStateFromProps && (h5.__s == h5.state && (h5.__s = w({}, h5.__s)), w(h5.__s, j4.getDerivedStateFromProps(b4, h5.__s))), v4 = h5.props, y5 = h5.state, h5.__v = t4, p5) S2 && null == j4.getDerivedStateFromProps && null != h5.componentWillMount && h5.componentWillMount(), S2 && null != h5.componentDidMount && h5.__h.push(h5.componentDidMount);
      else {
        if (S2 && null == j4.getDerivedStateFromProps && b4 !== v4 && null != h5.componentWillReceiveProps && h5.componentWillReceiveProps(b4, M3), !h5.__e && (null != h5.shouldComponentUpdate && false === h5.shouldComponentUpdate(b4, h5.__s, M3) || t4.__v == u4.__v)) {
      ...
      h5.state = h5.__s, null != h5.getChildContext && (i5 = w(w({}, i5), h5.getChildContext())), S2 && !p5 && null != h5.getSnapshotBeforeUpdate && (_5 = h5.getSnapshotBeforeUpdate(v4, y5)), L2 = a4, null != a4 && a4.type === k && null == a4.key && (L2 = N(a4.props.children)), f4 = I(n3, d(L2) ? L2 : [L2], t4, u4, i5, r4, o4, e4, f4, c4, s5), h5.base = t4.__e, t4.__u &= -161, h5.__h.length && e4.push(h5), m4 && (h5.__E = h5.__ = null);
    } catch (n4) {
    ...
    else null == o4 && t4.__v == u4.__v ? (t4.__k = u4.__k, t4.__e = u4.__e) : f4 = t4.__e = V(u4.__e, t4, u4, i5, r4, o4, e4, c4, s5);
    return (a4 = l.diffed) && a4(t4), 128 & t4.__u ? void 0 : f4;
  }
  function z(n3, t4, u4) {
    for (var i5 = 0; i5 < u4.length; i5++) q(u4[i5], u4[++i5], u4[++i5]);
  ...
  function V(t4, u4, i5, r4, o4, e4, f4, c4, s5) {
    ...
    if (null === x4) b4 === k4 || c4 && t4.data === k4 || (t4.data = k4);
      ...
      for (a4 in k4) w5 = k4[a4], "children" == a4 ? y5 = w5 : "dangerouslySetInnerHTML" == a4 ? h5 = w5 : "value" == a4 ? _5 = w5 : "checked" == a4 ? m4 = w5 : c4 && "function" != typeof w5 || b4[a4] === w5 || j(t4, a4, w5, b4[a4], o4);
      ...
      c4 || (a4 = "value", "progress" == x4 && null == _5 ? t4.removeAttribute("value") : void 0 !== _5 && (_5 !== t4[a4] || "progress" == x4 && !_5 || "option" == x4 && _5 !== b4[a4]) && j(t4, a4, _5, b4[a4], o4), a4 = "checked", void 0 !== m4 && m4 !== t4[a4] && j(t4, a4, m4, b4[a4], o4));
    }
    return t4;
  }
  function q(n3, t4, u4) {
  ...
  function B(n3, t4, u4) {
    ...
    if (i5 = n3.__k) for (r4 = 0; r4 < i5.length; r4++) i5[r4] && B(i5[r4], t4, u4 || "function" != typeof n3.type);
  ...
  function E(t4, u4, i5) {
    var r4, o4, e4, f4;
    u4 == document && (u4 = document.documentElement), l.__ && l.__(t4, u4), o4 = (r4 = "function" == typeof i5) ? null : i5 && i5.__k || u4.__k, e4 = [], f4 = [], O(u4, t4 = (!r4 && i5 || u4).__k = _(k, null, [t4]), o4 || p, p, u4.namespaceURI, !r4 && i5 ? [i5] : o4 ? null : u4.firstChild ? n.call(u4.childNodes) : null, e4, !r4 && i5 ? i5 : o4 ? o4.__e : u4.firstChild, r4, f4), z(e4, t4, f4);
  }
  function K(n3) {
    function l5(n4) {
      var t4, u4;
  ...
  var i2;
  null != (i2 = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : void 0) && i2.__PREACT_DEVTOOLS__ && i2.__PREACT_DEVTOOLS__.attachPreact("10.26.4", l, { Fragment: k, Component: x });
  ...
  function EmptyState() {
    ...
    if (hasSearch) {
      return /* @__PURE__ */ _(Empty, { title: t4("no_results_title", { term: `"${query.value.term}"` }), text: t4("no_results_text") });
    }
  ...
  function Item3({ current, range, onClick, onDelete, ranges, count }) {
    ...
    return /* @__PURE__ */ _("div", { class: classNames, key: range }, /* @__PURE__ */ _(
      ...
      titleMap[range](t4)
    ), /* @__PURE__ */ _(DeleteAllButton, { onClick: onDelete, ariaLabel: buttonLabel, range, ranges, count }));
  }
