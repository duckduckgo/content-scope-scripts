...
(() => {
  ...
  function A(n3, l4, u4, t4) {
    ...
    if ("function" == typeof n3.type) {
      for (i5 = n3.__k, r4 = 0; i5 && r4 < i5.length; r4++) i5[r4] && (i5[r4].__ = n3, l4 = A(i5[r4], l4, u4, t4));
      return l4;
    }
  ...
  function L(n3, l4, u4, t4) {
    var i5, r4, o4, e4 = n3.key, f4 = n3.type, c4 = l4[u4], s4 = null != c4 && 0 == (2 & c4.__u);
    if (null === c4 && null == e4 || s4 && e4 == c4.key && f4 == c4.type) return u4;
    if (t4 > (s4 ? 1 : 0)) {
      for (i5 = u4 - 1, r4 = u4 + 1; i5 >= 0 || r4 < l4.length; ) if (null != (c4 = l4[o4 = i5 >= 0 ? i5-- : r4++]) && 0 == (2 & c4.__u) && e4 == c4.key && f4 == c4.type) return o4;
    }
    return -1;
  }
  function T(n3, l4, u4) {
  ...
  function q(u4, t4, i5, r4, o4, e4, f4, c4, s4) {
    var a4, h5, v4, y5, d5, _5, m4, b4 = i5.props || p, k4 = t4.props, x4 = t4.type;
    ...
    if (null == x4) b4 === k4 || c4 && u4.data == k4 || (u4.data = k4);
      ...
      if (e4 = e4 && n.call(u4.childNodes), !c4 && null != e4) for (b4 = {}, a4 = 0; a4 < u4.attributes.length; a4++) b4[(d5 = u4.attributes[a4]).name] = d5.value;
