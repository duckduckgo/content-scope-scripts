...
(() => {
  ...
  function _(l5, u4, t4) {
    var i4, o4, r3, f4 = {};
    for (r3 in u4) "key" == r3 ? i4 = u4[r3] : "ref" == r3 ? o4 = u4[r3] : f4[r3] = u4[r3];
    if (arguments.length > 2 && (f4.children = arguments.length > 3 ? n.call(arguments, 2) : t4), "function" == typeof l5 && null != l5.defaultProps) for (r3 in l5.defaultProps) void 0 === f4[r3] && (f4[r3] = l5.defaultProps[r3]);
    return g(l5, f4, i4, o4, null);
  }
  function g(n2, t4, i4, o4, r3) {
    var f4 = { type: n2, props: t4, key: i4, ref: o4, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, constructor: void 0, __v: null == r3 ? ++u : r3, __i: -1, __u: 0 };
  ...
  function M() {
    var n2, u4, t4, o4, r3, e4, c4, s5;
    for (i.sort(f); n2 = i.shift(); ) n2.__d && (u4 = i.length, o4 = void 0, e4 = (r3 = (t4 = n2).__v).__e, c4 = [], s5 = [], t4.__P && ((o4 = d({}, r3)).__v = r3.__v + 1, l.vnode && l.vnode(o4), O(t4.__P, o4, r3, t4.__n, t4.__P.namespaceURI, 32 & r3.__u ? [e4] : null, c4, null == e4 ? x(r3) : e4, !!(32 & r3.__u), s5), o4.__v = r3.__v, o4.__.__k[o4.__i] = o4, j(c4, o4, s5), o4.__e != e4 && C(o4)), i.length > u4 && i.sort(f));
    M.__r = 0;
  }
  function P(n2, l5, u4, t4, i4, o4, r3, f4, e4, c4, s5) {
    var a4, p5, y4, d5, w4, _4 = t4 && t4.__k || v, g3 = l5.length;
    for (u4.__d = e4, $(u4, l5, _4), e4 = u4.__d, a4 = 0; a4 < g3; a4++) null != (y4 = u4.__k[a4]) && (p5 = -1 === y4.__i ? h : _4[y4.__i] || h, y4.__i = a4, O(n2, y4, p5, i4, o4, r3, f4, e4, c4, s5), d5 = y4.__e, y4.ref && p5.ref != y4.ref && (p5.ref && N(p5.ref, null, y4), s5.push(y4.ref, y4.__c || d5, y4)), null == w4 && null != d5 && (w4 = d5), 65536 & y4.__u || p5.__k === y4.__k ? e4 = I(y4, e4, n2) : "function" == typeof y4.type && void 0 !== y4.__d ? e4 = y4.__d : d5 && (e4 = d5.nextSibling), y4.__d = void 0, y4.__u &= -196609);
    u4.__d = e4, u4.__e = w4;
  }
  function $(n2, l5, u4) {
    var t4, i4, o4, r3, f4, e4 = l5.length, c4 = u4.length, s5 = c4, a4 = 0;
    for (n2.__k = [], t4 = 0; t4 < e4; t4++) null != (i4 = l5[t4]) && "boolean" != typeof i4 && "function" != typeof i4 ? (r3 = t4 + a4, (i4 = n2.__k[t4] = "string" == typeof i4 || "number" == typeof i4 || "bigint" == typeof i4 || i4.constructor == String ? g(null, i4, null, null, null) : y(i4) ? g(b, { children: i4 }, null, null, null) : void 0 === i4.constructor && i4.__b > 0 ? g(i4.type, i4.props, i4.key, i4.ref ? i4.ref : null, i4.__v) : i4).__ = n2, i4.__b = n2.__b + 1, o4 = null, -1 !== (f4 = i4.__i = L(i4, u4, r3, s5)) && (s5--, (o4 = u4[f4]) && (o4.__u |= 131072)), null == o4 || null === o4.__v ? (-1 == f4 && a4--, "function" != typeof i4.type && (i4.__u |= 65536)) : f4 !== r3 && (f4 == r3 - 1 ? a4-- : f4 == r3 + 1 ? a4++ : (f4 > r3 ? a4-- : a4++, i4.__u |= 65536))) : i4 = n2.__k[t4] = null;
  ...
  function L(n2, l5, u4, t4) {
    var i4 = n2.key, o4 = n2.type, r3 = u4 - 1, f4 = u4 + 1, e4 = l5[u4];
    if (null === e4 || e4 && i4 == e4.key && o4 === e4.type && 0 == (131072 & e4.__u)) return u4;
    if (t4 > (null != e4 && 0 == (131072 & e4.__u) ? 1 : 0)) for (; r3 >= 0 || f4 < l5.length; ) {
      if (r3 >= 0) {
        if ((e4 = l5[r3]) && 0 == (131072 & e4.__u) && i4 == e4.key && o4 === e4.type) return r3;
        r3--;
      }
      if (f4 < l5.length) {
  ...
  function O(n2, u4, t4, i4, o4, r3, f4, e4, c4, s5) {
    var a4, h4, v5, p5, w4, _4, g3, m2, x3, C3, S2, M2, $2, I2, H, L2, T3 = u4.type;
    if (void 0 !== u4.constructor) return null;
    128 & t4.__u && (c4 = !!(32 & t4.__u), r3 = [e4 = u4.__e = t4.__e]), (a4 = l.__b) && a4(u4);
    n: if ("function" == typeof T3) try {
      if (m2 = u4.props, x3 = "prototype" in T3 && T3.prototype.render, C3 = (a4 = T3.contextType) && i4[a4.__c], S2 = a4 ? C3 ? C3.props.value : a4.__ : i4, t4.__c ? g3 = (h4 = u4.__c = t4.__c).__ = h4.__E : (x3 ? u4.__c = h4 = new T3(m2, S2) : (u4.__c = h4 = new k(m2, S2), h4.constructor = T3, h4.render = q), C3 && C3.sub(h4), h4.props = m2, h4.state || (h4.state = {}), h4.context = S2, h4.__n = i4, v5 = h4.__d = true, h4.__h = [], h4._sb = []), x3 && null == h4.__s && (h4.__s = h4.state), x3 && null != T3.getDerivedStateFromProps && (h4.__s == h4.state && (h4.__s = d({}, h4.__s)), d(h4.__s, T3.getDerivedStateFromProps(m2, h4.__s))), p5 = h4.props, w4 = h4.state, h4.__v = u4, v5) x3 && null == T3.getDerivedStateFromProps && null != h4.componentWillMount && h4.componentWillMount(), x3 && null != h4.componentDidMount && h4.__h.push(h4.componentDidMount);
      else {
        if (x3 && null == T3.getDerivedStateFromProps && m2 !== p5 && null != h4.componentWillReceiveProps && h4.componentWillReceiveProps(m2, S2), !h4.__e && (null != h4.shouldComponentUpdate && false === h4.shouldComponentUpdate(m2, h4.__s, S2) || u4.__v === t4.__v)) {
          for (u4.__v !== t4.__v && (h4.props = m2, h4.state = h4.__s, h4.__d = false), u4.__e = t4.__e, u4.__k = t4.__k, u4.__k.some(function(n3) {
            n3 && (n3.__ = u4);
          }), M2 = 0; M2 < h4._sb.length; M2++) h4.__h.push(h4._sb[M2]);
          h4._sb = [], h4.__h.length && f4.push(h4);
          break n;
        }
        null != h4.componentWillUpdate && h4.componentWillUpdate(m2, h4.__s, S2), x3 && null != h4.componentDidUpdate && h4.__h.push(function() {
          h4.componentDidUpdate(p5, w4, _4);
        });
      }
      if (h4.context = S2, h4.props = m2, h4.__P = n2, h4.__e = false, $2 = l.__r, I2 = 0, x3) {
      ...
      h4.state = h4.__s, null != h4.getChildContext && (i4 = d(d({}, i4), h4.getChildContext())), x3 && !v5 && null != h4.getSnapshotBeforeUpdate && (_4 = h4.getSnapshotBeforeUpdate(p5, w4)), P(n2, y(L2 = null != a4 && a4.type === b && null == a4.key ? a4.props.children : a4) ? L2 : [L2], u4, t4, i4, o4, r3, f4, e4, c4, s5), h4.base = u4.__e, u4.__u &= -161, h4.__h.length && f4.push(h4), g3 && (h4.__E = h4.__ = null);
    } catch (n3) {
      if (u4.__v = null, c4 || null != r3) {
        for (u4.__u |= c4 ? 160 : 128; e4 && 8 === e4.nodeType && e4.nextSibling; ) e4 = e4.nextSibling;
        r3[r3.indexOf(e4)] = null, u4.__e = e4;
      } else u4.__e = t4.__e, u4.__k = t4.__k;
      l.__e(n3, u4, t4);
    }
    else null == r3 && u4.__v === t4.__v ? (u4.__k = t4.__k, u4.__e = t4.__e) : u4.__e = z(t4.__e, u4, t4, i4, o4, r3, f4, c4, s5);
    (a4 = l.diffed) && a4(u4);
  }
  function j(n2, u4, t4) {
    u4.__d = void 0;
  ...
  function z(u4, t4, i4, o4, r3, f4, e4, c4, s5) {
    var a4, v5, p5, d5, _4, g3, m2, b3 = i4.props, k3 = t4.props, C3 = t4.type;
    ...
    if (null == u4) {
      ...
      u4 = document.createElementNS(r3, C3, k3.is && k3), c4 && (l.__m && l.__m(t4, f4), c4 = false), f4 = null;
    }
    if (null === C3) b3 === k3 || c4 && u4.data === k3 || (u4.data = k3);
    else {
      if (f4 = f4 && n.call(u4.childNodes), b3 = i4.props || h, !c4 && null != f4) for (b3 = {}, a4 = 0; a4 < u4.attributes.length; a4++) b3[(_4 = u4.attributes[a4]).name] = _4.value;
      ...
      for (a4 in k3) _4 = k3[a4], "children" == a4 ? d5 = _4 : "dangerouslySetInnerHTML" == a4 ? v5 = _4 : "value" == a4 ? g3 = _4 : "checked" == a4 ? m2 = _4 : c4 && "function" != typeof _4 || b3[a4] === _4 || A(u4, a4, _4, b3[a4], r3);
      if (v5) c4 || p5 && (v5.__html === p5.__html || v5.__html === u4.innerHTML) || (u4.innerHTML = v5.__html), t4.__k = [];
      else if (p5 && (u4.innerHTML = ""), P(u4, y(d5) ? d5 : [d5], t4, i4, o4, "foreignObject" === C3 ? "http://www.w3.org/1999/xhtml" : r3, f4, e4, f4 ? f4[0] : i4.__k && x(i4, 0), c4, s5), null != f4) for (a4 = f4.length; a4--; ) w(f4[a4]);
      c4 || (a4 = "value", "progress" === C3 && null == g3 ? u4.removeAttribute("value") : void 0 !== g3 && (g3 !== u4[a4] || "progress" === C3 && !g3 || "option" === C3 && g3 !== b3[a4]) && A(u4, a4, g3, b3[a4], r3), a4 = "checked", void 0 !== m2 && m2 !== u4[a4] && A(u4, a4, m2, b3[a4], r3));
    }
    return u4;
  }
  function N(n2, u4, t4) {
  ...
  function B(u4, t4, i4) {
    var o4, r3, f4, e4;
    l.__ && l.__(u4, t4), r3 = (o4 = "function" == typeof i4) ? null : i4 && i4.__k || t4.__k, f4 = [], e4 = [], O(t4, u4 = (!o4 && i4 || t4).__k = _(b, null, [u4]), r3 || h, h, t4.namespaceURI, !o4 && i4 ? [i4] : r3 ? null : t4.firstChild ? n.call(t4.childNodes) : null, f4, !o4 && i4 ? i4 : r3 ? r3.__e : t4.firstChild, o4, e4), j(f4, u4, e4);
  }
  function G(n2, l5) {
  ...
  n = v.slice, l = { __e: function(n2, l5, u4, t4) {
    for (var i4, o4, r3; l5 = l5.__; ) if ((i4 = l5.__c) && !i4.__) try {
      if ((o4 = i4.constructor) && null != o4.getDerivedStateFromError && (i4.setState(o4.getDerivedStateFromError(n2)), r3 = i4.__d), null != i4.componentDidCatch && (i4.componentDidCatch(n2, t4 || {}), r3 = i4.__d), r3) return i4.__E = i4;
    } catch (l6) {
      n2 = l6;
    }
    throw n2;
  ...
  function p2(n2, u4, i4) {
    ...
    if (o4.t = n2, !o4.__c && (o4.__ = [i4 ? i4(u4) : D(void 0, u4), function(n3) {
      ...
      var f4 = function(n3, t4, r3) {
        ...
        }), !(!i5 && o4.__c.props === n3) && (!c4 || c4.call(this, n3, t4, r3));
      };
      r2.u = true;
