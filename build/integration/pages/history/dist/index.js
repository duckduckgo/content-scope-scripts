...
(() => {
  ...
  function j(n3, u4, t4, i5, r4, o4, e4, f4, c4, s5) {
    var a4, h5, p5, v4, y5, g6, m4, b4, C3, S2, M3, P4, I2, A5, H3, L2, T4, F5 = u4.type;
    if (void 0 !== u4.constructor) return null;
    128 & t4.__u && (c4 = !!(32 & t4.__u), o4 = [f4 = u4.__e = t4.__e]), (a4 = l.__b) && a4(u4);
    n: if ("function" == typeof F5) try {
      if (b4 = u4.props, C3 = "prototype" in F5 && F5.prototype.render, S2 = (a4 = F5.contextType) && i5[a4.__c], M3 = a4 ? S2 ? S2.props.value : a4.__ : i5, t4.__c ? m4 = (h5 = u4.__c = t4.__c).__ = h5.__E : (C3 ? u4.__c = h5 = new F5(b4, M3) : (u4.__c = h5 = new x(b4, M3), h5.constructor = F5, h5.render = B), S2 && S2.sub(h5), h5.props = b4, h5.state || (h5.state = {}), h5.context = M3, h5.__n = i5, p5 = h5.__d = true, h5.__h = [], h5._sb = []), C3 && null == h5.__s && (h5.__s = h5.state), C3 && null != F5.getDerivedStateFromProps && (h5.__s == h5.state && (h5.__s = w({}, h5.__s)), w(h5.__s, F5.getDerivedStateFromProps(b4, h5.__s))), v4 = h5.props, y5 = h5.state, h5.__v = u4, p5) C3 && null == F5.getDerivedStateFromProps && null != h5.componentWillMount && h5.componentWillMount(), C3 && null != h5.componentDidMount && h5.__h.push(h5.componentDidMount);
      else {
        if (C3 && null == F5.getDerivedStateFromProps && b4 !== v4 && null != h5.componentWillReceiveProps && h5.componentWillReceiveProps(b4, M3), !h5.__e && (null != h5.shouldComponentUpdate && false === h5.shouldComponentUpdate(b4, h5.__s, M3) || u4.__v == t4.__v)) {
  ...
  function N(u4, t4, i5, r4, o4, e4, f4, c4, s5) {
    var a4, h5, v4, y5, w5, g6, m4, b4 = i5.props, k4 = t4.props, x3 = t4.type;
    ...
    if (null === x3) b4 === k4 || c4 && u4.data === k4 || (u4.data = k4);
      ...
      else if (v4 && (u4.innerHTML = ""), $(u4, d(y5) ? y5 : [y5], t4, i5, r4, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o4, e4, f4, e4 ? e4[0] : i5.__k && C(i5, 0), c4, s5), null != e4) for (a4 = e4.length; a4--; ) _(e4[a4]);
      c4 || (a4 = "value", "progress" == x3 && null == g6 ? u4.removeAttribute("value") : void 0 !== g6 && (g6 !== u4[a4] || "progress" == x3 && !g6 || "option" == x3 && g6 !== b4[a4]) && F(u4, a4, g6, b4[a4], o4), a4 = "checked", void 0 !== m4 && m4 !== u4[a4] && F(u4, a4, m4, b4[a4], o4));
    }
    return u4;
  }
  function V(n3, u4, t4) {
  ...
  m3("__e", function(i5, n3, r4, t4) {
    _4();
    h4 = void 0;
    i5(n3, r4, t4);
  });
  m3("diffed", function(i5, n3) {
    _4();
    h4 = void 0;
    var r4;
  ...
  var y4 = "undefined" == typeof requestAnimationFrame ? setTimeout : function(i5) {
    var n3 = function() {
      clearTimeout(r4);
      cancelAnimationFrame(t4);
      i5();
    }, r4 = setTimeout(n3, 100), t4 = requestAnimationFrame(n3);
  };
  var k3 = function(i5) {
  ...
  function F2() {
    if (1 === p4.push(this)) (l.requestAnimationFrame || k3)(w4);
  }
        ...
        switch (msg.method) {
          ...
          case "deleteRange": {
            ...
            if (confirm(lines)) {
              ...
              rangeMemory.ranges = rangeMemory.ranges.filter((x3) => {
                return x3.id !== msg.params.range;
              });
