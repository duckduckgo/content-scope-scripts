...
(() => {
  ...
  function L(n3, l5, u4, t4, i5, r4, o4, e4, f4, c4, a4) {
    var s4, h5, p5, v4, y5, _5, g6 = t4 && t4.__k || w, m5 = l5.length;
    for (f4 = T(u4, l5, g6, f4, m5), s4 = 0; s4 < m5; s4++) null != (p5 = u4.__k[s4]) && (h5 = -1 != p5.__i && g6[p5.__i] || d, p5.__i = s4, _5 = q(n3, p5, h5, i5, r4, o4, e4, f4, c4, a4), v4 = p5.__e, p5.ref && h5.ref != p5.ref && (h5.ref && J(h5.ref, null, p5), a4.push(p5.ref, p5.__c || v4, p5)), null == y5 && null != v4 && (y5 = v4), 4 & p5.__u ? (f4 = j(p5, f4, n3), h5.__e && (h5.__e = null)) : "function" == typeof p5.type && void 0 !== _5 ? f4 = _5 : v4 && (f4 = v4.nextSibling), p5.__u &= -7);
    return u4.__e = y5, f4;
  }
  ...
  function j(n3, l5, u4) {
    ...
    if ("function" == typeof n3.type) {
      for (t4 = n3.__k, i5 = 0; t4 && i5 < t4.length; i5++) t4[i5] && (t4[i5].__ = n3, l5 = j(t4[i5], l5, u4));
      return l5;
    }
  ...
  function O(n3, l5, u4, t4) {
    var i5, r4, o4, e4 = n3.key, f4 = n3.type, c4 = l5[u4], a4 = null != c4 && 0 == (2 & c4.__u);
  ...
  function q(n3, u4, t4, i5, r4, o4, e4, f4, c4, a4) {
    var s4, h5, p5, v4, y5, d5, _5, k4, x5, M3, I2, P4, A5, H3, T6, j5, F4 = u4.type;
    if (void 0 !== u4.constructor) return null;
    128 & t4.__u && (c4 = !!(32 & t4.__u), o4 = [f4 = u4.__e = t4.__e]), (s4 = l.__b) && s4(u4);
    n: if ("function" == typeof F4) {
      h5 = e4.length;
      try {
        if (x5 = u4.props, M3 = F4.prototype && F4.prototype.render, I2 = (s4 = F4.contextType) && i5[s4.__c], P4 = s4 ? I2 ? I2.props.value : s4.__ : i5, t4.__c ? k4 = (p5 = u4.__c = t4.__c).__ = p5.__E : (M3 ? u4.__c = p5 = new F4(x5, P4) : (u4.__c = p5 = new C(x5, P4), p5.constructor = F4, p5.render = Q), I2 && I2.sub(p5), p5.state || (p5.state = {}), p5.__n = i5, v4 = p5.__d = true, p5.__h = [], p5._sb = []), M3 && null == p5.__s && (p5.__s = p5.state), M3 && null != F4.getDerivedStateFromProps && (p5.__s == p5.state && (p5.__s = m({}, p5.__s)), m(p5.__s, F4.getDerivedStateFromProps(x5, p5.__s))), y5 = p5.props, d5 = p5.state, p5.__v = u4, v4) M3 && null == F4.getDerivedStateFromProps && null != p5.componentWillMount && p5.componentWillMount(), M3 && null != p5.componentDidMount && p5.__h.push(p5.componentDidMount);
        else {
          if (M3 && null == F4.getDerivedStateFromProps && x5 !== y5 && null != p5.componentWillReceiveProps && p5.componentWillReceiveProps(x5, P4), u4.__v == t4.__v || !p5.__e && null != p5.shouldComponentUpdate && false === p5.shouldComponentUpdate(x5, p5.__s, P4)) {
          ...
          null != p5.componentWillUpdate && p5.componentWillUpdate(x5, p5.__s, P4), M3 && null != p5.componentDidUpdate && p5.__h.push(function() {
            p5.componentDidUpdate(y5, d5, _5);
          });
        }
        if (p5.context = P4, p5.props = x5, p5.__P = n3, p5.__e = false, A5 = l.__r, H3 = 0, M3) p5.state = p5.__s, p5.__d = false, A5 && A5(u4), s4 = p5.render(p5.props, p5.state, p5.context), w.push.apply(p5.__h, p5._sb), p5._sb = [];
        else do {
          p5.__d = false, A5 && A5(u4), s4 = p5.render(p5.props, p5.state, p5.context), p5.state = p5.__s;
        } while (p5.__d && ++H3 < 25);
        p5.state = p5.__s, null != p5.getChildContext && (i5 = m(m({}, i5), p5.getChildContext())), M3 && !v4 && null != p5.getSnapshotBeforeUpdate && (_5 = p5.getSnapshotBeforeUpdate(y5, d5)), T6 = null != s4 && s4.type === S && null == s4.key ? E(s4.props.children) : s4, f4 = L(n3, g(T6) ? T6 : [T6], u4, t4, i5, r4, o4, e4, f4, c4, a4), p5.base = u4.__e, u4.__u &= -161, p5.__h.length && e4.push(p5), k4 && (p5.__E = p5.__ = null);
      } catch (n4) {
  ...
  function G(u4, t4, i5, r4, o4, e4, f4, c4, a4) {
    var s4, h5, p5, v4, y5, w5, _5, m5 = i5.props || d, k4 = t4.props, x5 = t4.type;
    if ("svg" == x5 ? o4 = "http://www.w3.org/2000/svg" : "math" == x5 ? o4 = "http://www.w3.org/1998/Math/MathML" : o4 || (o4 = "http://www.w3.org/1999/xhtml"), null != e4) {
      for (s4 = 0; s4 < e4.length; s4++) if ((y5 = e4[s4]) && "setAttribute" in y5 == !!x5 && (x5 ? y5.localName == x5 : 3 == y5.nodeType)) {
        u4 = y5, e4[s4] = null;
        break;
      }
    }
    if (null == u4) {
      ...
      u4 = document.createElementNS(o4, x5, k4.is && k4), c4 && (l.__m && l.__m(t4, e4), c4 = false), e4 = null;
    }
    if (null == x5) m5 === k4 || c4 && u4.data == k4 || (u4.data = k4);
    else {
      if (e4 = "textarea" == x5 && null != k4.defaultValue ? null : e4 && n.call(u4.childNodes), !c4 && null != e4) for (m5 = {}, s4 = 0; s4 < u4.attributes.length; s4++) m5[(y5 = u4.attributes[s4]).name] = y5.value;
      for (s4 in m5) y5 = m5[s4], "dangerouslySetInnerHTML" == s4 ? p5 = y5 : "children" == s4 || s4 in k4 || "value" == s4 && "defaultValue" in k4 || "checked" == s4 && "defaultChecked" in k4 || N(u4, s4, null, y5, o4);
      for (s4 in k4) y5 = k4[s4], "children" == s4 ? v4 = y5 : "dangerouslySetInnerHTML" == s4 ? h5 = y5 : "value" == s4 ? w5 = y5 : "checked" == s4 ? _5 = y5 : c4 && "function" != typeof y5 || m5[s4] === y5 || N(u4, s4, y5, m5[s4], o4);
      if (h5) c4 || p5 && (h5.__html == p5.__html || h5.__html == u4.innerHTML) || (u4.innerHTML = h5.__html), t4.__k = [];
      else if (p5 && (u4.innerHTML = ""), L("template" == t4.type ? u4.content : u4, g(v4) ? v4 : [v4], t4, i5, r4, "foreignObject" == x5 ? "http://www.w3.org/1999/xhtml" : o4, e4, f4, e4 ? e4[0] : i5.__k && $(i5, 0), c4, a4), null != e4) for (s4 = e4.length; s4--; ) b(e4[s4]);
      c4 && "textarea" != x5 || (s4 = "value", "progress" == x5 && null == w5 ? u4.removeAttribute("value") : null != w5 && (w5 !== u4[s4] || "progress" == x5 && !w5 || "option" == x5 && w5 != m5[s4]) && N(u4, s4, w5, m5[s4], o4), s4 = "checked", null != _5 && _5 != u4[s4] && N(u4, s4, _5, m5[s4], o4));
    }
    return u4;
  }
  function J(n3, u4, t4) {
  ...
  var i2;
  null != (i2 = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : void 0) && i2.__PREACT_DEVTOOLS__ && i2.__PREACT_DEVTOOLS__.attachPreact("10.29.8", l, { Fragment: S, Component: C });
  ...
  var capturedRegExpTest = RegExp2.prototype.test;
  var capturedMapGet = Map2.prototype.get;
  var capturedMapSet = Map2.prototype.set;
  var capturedStringSlice = globalThis.String.prototype.slice;
  var capturedStringTrim = globalThis.String.prototype.trim;
  function capturedGetter(proto, name) {
    return (
      /** @type {(this: any) => any} */
      proto && getOwnPropertyDescriptor(proto, name)?.get
    );
  }
  ...
  var getComputedStyle = (
    /** @type {(element: Element, pseudoElement?: string | null) => CSSStyleDeclaration} */
    globalThis.getComputedStyle?.bind(globalThis)
  );
  var documentQuerySelector = (
  ...
  var createXPathExpression = (
    /** @type {Document['createExpression']} */
    globalThis.document?.createExpression?.bind(globalThis.document)
  );
  var capturedElementQuerySelector = (
    /** @type {Element['querySelector']} */
    globalThis.Element?.prototype.querySelector
  );
  var capturedElementQuerySelectorAll = (
    /** @type {Element['querySelectorAll']} */
    globalThis.Element?.prototype.querySelectorAll
  );
  var capturedElementRemove = (
    /** @type {Element['remove']} */
    globalThis.Element?.prototype.remove
  );
  var capturedGetBoundingClientRect = (
    /** @type {Element['getBoundingClientRect']} */
    globalThis.Element?.prototype.getBoundingClientRect
  );
  var capturedEvaluateExpression = (
    /** @type {XPathExpression['evaluate']} */
    globalThis.XPathExpression?.prototype.evaluate
  );
  var capturedSnapshotItem = (
    /** @type {XPathResult['snapshotItem']} */
    globalThis.XPathResult?.prototype.snapshotItem
  );
  var capturedParseFromString = (
    /** @type {DOMParser['parseFromString']} */
    globalThis.DOMParser?.prototype.parseFromString
  );
  var capturedNodeListItem = (
    /** @type {NodeList['item']} */
    globalThis.NodeList?.prototype.item
  );
  var capturedGetPropertyValue = (
    /** @type {CSSStyleDeclaration['getPropertyValue']} */
    globalThis.CSSStyleDeclaration?.prototype.getPropertyValue
  );
  var capturedTextContent = capturedGetter(globalThis.Node?.prototype, "textContent");
  var capturedOuterHTML = capturedGetter(globalThis.Element?.prototype, "outerHTML");
  var capturedInnerText = capturedGetter(globalThis.HTMLElement?.prototype, "innerText");
  var capturedHidden = capturedGetter(globalThis.HTMLElement?.prototype, "hidden");
  var capturedIframeSrc = capturedGetter(globalThis.HTMLIFrameElement?.prototype, "src");
  var capturedDocumentElement = capturedGetter(globalThis.Document?.prototype, "documentElement");
  var capturedSnapshotLength = capturedGetter(globalThis.XPathResult?.prototype, "snapshotLength");
  var capturedNodeListLength = capturedGetter(globalThis.NodeList?.prototype, "length");
  var capturedRectWidth = capturedGetter(globalThis.DOMRect?.prototype, "width");
  var capturedRectHeight = capturedGetter(globalThis.DOMRect?.prototype, "height");
  ...
  var Messaging = class {
    ...
    notify(name, data = {}) {
      try {
        ...
        logNotificationError(this.messagingContext.env, name, data, e4);
      }
    }
    /**
    ...
    if (!(v3 > 1)) {
      ...
      !(function() {
        ...
        while (void 0 !== i6) {
          var t5 = i6.S;
          if (t5.v === i6.v) {
            for (var n4 = t5.t; void 0 !== n4; n4 = n4.x) if (n4.i === i6.i) n4.i = t5.i;
          }
          i6 = i6.o;
        }
      })();
  ...
  function QueryProvider({ children, query = { term: "" } }) {
    ...
    return /* @__PURE__ */ k(QueryContext.Provider, { value: queryState }, /* @__PURE__ */ k(QueryDispatch.Provider, { value: dispatcher }, children));
  }
  ...
  var MessagingContext2 = X(
    /** @type {import("../src/index.js").HistoryPage} */
    {}
  );
  var useMessaging = () => x2(MessagingContext2);
  var SettingsContext = X(new Settings({ platform: { name: "macos" } }));
  ...
  function SearchForm({ term, domain }) {
    ...
    return /* @__PURE__ */ k("form", { role: "search", class: Header_default.form, onSubmit: submit }, /* @__PURE__ */ k("label", { class: Header_default.label }, /* @__PURE__ */ k("span", { class: "sr-only" }, t4("search_your_history")), /* @__PURE__ */ k("span", { class: Header_default.searchIcon }, /* @__PURE__ */ k(SearchIcon, null)), /* @__PURE__ */ k(
      "input",
      {
  ...
  var HistoryServiceDispatchContext = X(defaultDispatch);
  var ResultsContext = X(
  ...
  function HistoryServiceProvider({ service, children, initial }) {
    ...
    function dispatch(action) {
      switch (action.kind) {
        ...
        case "delete-all": {
          service.deleteRange("all").then((x5) => {
            if (x5.kind === "delete") {
              service.refreshRanges();
            }
          }).catch(console.error);
    ...
    return /* @__PURE__ */ k(HistoryServiceDispatchContext.Provider, { value: dispatcher }, /* @__PURE__ */ k(RangesContext.Provider, { value: ranges }, /* @__PURE__ */ k(ResultsContext.Provider, { value: results }, children)));
  }
  ...
  var SelectionDispatchContext = X(
    /** @type {(a: Action) => void} */
    ((_5) => {
    })
  );
  var SelectionStateContext = X(
    /** @type {ReadonlySignal<SelectionState>} */
    y3({})
  );
  function SelectionProvider({ children }) {
    const { dispatch, state } = useSelectionStateApi();
    return /* @__PURE__ */ k(SelectionStateContext.Provider, { value: state }, /* @__PURE__ */ k(SelectionDispatchContext.Provider, { value: dispatch }, children));
  }
  ...
  function Header() {
    ...
    return /* @__PURE__ */ k("div", { class: Header_default.root }, /* @__PURE__ */ k("div", { class: Header_default.controls }, /* @__PURE__ */ k(Controls, { term, range, domain })), /* @__PURE__ */ k("div", { class: Header_default.search }, /* @__PURE__ */ k(SearchForm, { term, domain })));
  }
  function Controls({ term, range, domain }) {
    ...
    return /* @__PURE__ */ k("button", { class: Header_default.largeButton, onClick, "aria-disabled": ariaDisabled, title, tabindex: 0 }, /* @__PURE__ */ k(Trash, null), /* @__PURE__ */ k("span", null, buttonTxt));
  }
  ...
  var T5 = l.__b;
  l.__b = function(n3) {
    n3.type && n3.type.__f && n3.ref && (n3.props.ref = n3.ref, n3.ref = null), T5 && T5(n3);
  };
  ...
  l.unmount = function(n3) {
    ...
    var u4 = j4(r4.__v), o4 = false, i5 = function() {
      o4 || r4.__z || (o4 = true, e4.__R = null, u4 ? u4(f4) : f4());
    };
    e4.__R = i5;
    var l5 = e4.__P;
    e4.__P = null;
  ...
  (B3.prototype = new C()).__a = function(n3) {
    var t4 = this, e4 = j4(t4.__v), r4 = t4.l.get(n3);
    ...
    "string" == typeof n3.type && (function(n4) {
      ...
      for (var i5 in t4) {
        ...
        if (!("value" === i5 && "defaultValue" in t4 && null == l5 || Q2 && "children" === i5 && "noscript" === e4 || "class" === i5 || "className" === i5)) {
          ...
          "defaultValue" === i5 && "value" in t4 && null == t4.value ? i5 = "value" : "download" === i5 && true === l5 ? l5 = "" : "translate" === f4 && "no" === l5 ? l5 = false : "o" === f4[0] && "n" === f4[1] ? "ondoubleclick" === f4 ? i5 = "ondblclick" : "onchange" !== f4 || "input" !== e4 && "textarea" !== e4 || X2(t4.type) ? "onfocus" === f4 ? i5 = "onfocusin" : "onblur" === f4 ? i5 = "onfocusout" : J2.test(i5) && (i5 = f4) : f4 = i5 = "oninput" : o4 && G2.test(i5) ? i5 = i5.replace(K2, "-$&").toLowerCase() : null === l5 && (l5 = void 0), "oninput" === f4 && u4[i5 = f4] && (i5 = "oninputCapture"), u4[i5] = l5;
        }
      }
  ...
  function FaviconWithState({ defaultSize = 64, fallback, fallbackDark, faviconSrc, faviconMax, etldPlusOne, theme, displayKind }) {
    ...
    switch (state) {
      ...
      case states.using_fallback_text: {
        ...
        return /* @__PURE__ */ k("div", { class: (0, import_classnames.default)(FaviconWithState_default.favicon, sizeClass, FaviconWithState_default.faviconText), style, "data-state": state }, /* @__PURE__ */ k("span", { "aria-hidden": true }, chars[0]), /* @__PURE__ */ k("span", { "aria-hidden": true }, chars[1]));
      }
      /**
  ...
  var Item = N2(
    ...
    function Item2(props) {
      ...
      return /* @__PURE__ */ k(S, null, hasTitle && /* @__PURE__ */ k("div", { class: (0, import_classnames2.default)(Item_default.title), style: { viewTransitionName: `Item-title-${viewId}` } }, dateRelativeDay), /* @__PURE__ */ k(
        "div",
        {
        ...
        /* @__PURE__ */ k("div", { class: Item_default.favicon }, /* @__PURE__ */ k(
          FaviconWithState,
          {
        ...
        /* @__PURE__ */ k("a", { href: props.url, "data-url": props.url, class: Item_default.entryLink, tabindex: 0 }, title),
        /* @__PURE__ */ k("span", { class: Item_default.domain, "data-testid": "Item.domain", title: props.domain }, props.domain),
        dateTimeOfDay && /* @__PURE__ */ k("span", { className: Item_default.time }, dateTimeOfDay),
        /* @__PURE__ */ k("button", { class: Item_default.dots, "data-action": BTN_ACTION_ENTRIES_MENU, "data-index": index, value: props.id, tabindex: -1 }, /* @__PURE__ */ k(Dots, null))
      ));
    }
  );
  ...
  function Empty({ title, text }) {
    return /* @__PURE__ */ k("div", { class: (0, import_classnames3.default)(VirtualizedList_default.emptyState, VirtualizedList_default.emptyStateOffset) }, /* @__PURE__ */ k("div", { class: VirtualizedList_default.icons }, /* @__PURE__ */ k("img", { src: "icons/backdrop.svg", width: 128, height: 96, alt: "" }), /* @__PURE__ */ k("img", { src: "icons/clock.svg", width: 60, height: 60, alt: "", class: VirtualizedList_default.forground })), /* @__PURE__ */ k("h2", { class: VirtualizedList_default.emptyTitle }, title), /* @__PURE__ */ k("p", { class: VirtualizedList_default.emptyText }, text));
  }
  function EmptyState() {
    const { t: t4 } = useTypedTranslation();
    const results = useResultsData();
    ...
    if (hasSearch.value) {
      return /* @__PURE__ */ k(Empty, { title: t4("no_results_title", { term: `"${text.value}"` }), text: t4("no_results_text") });
    }
    return /* @__PURE__ */ k(Empty, { title: t4("empty_title"), text: t4("empty_text") });
  }
  ...
  function ResultsContainer() {
    ...
    return /* @__PURE__ */ k(Results, { results, selected, onChange });
  }
  function Results({ results, selected, onChange }) {
    if (results.value.items.length === 0) {
      return /* @__PURE__ */ k(EmptyState, null);
    }
    const totalHeight = results.value.heights.reduce((acc, item) => acc + item, 0);
    return /* @__PURE__ */ k("ul", { class: VirtualizedList_default.container, style: { height: totalHeight + "px" } }, /* @__PURE__ */ k(
      VisibleItems,
      {
        ...
        renderItem: ({ item, cssClassName, style, index }) => {
          ...
          return /* @__PURE__ */ k("li", { key: item.id, "data-id": item.id, class: cssClassName, style, "data-is-selected": isSelected }, /* @__PURE__ */ k(
            Item,
            {
              id: item.id,
              viewId,
  ...
  var MessagingContext3 = X(
    /** @type {import("../src/index.js").NewTabPage} */
    {}
  );
  var TelemetryContext = X(
  ...
  function Sidebar({ ranges }) {
    ...
    return /* @__PURE__ */ k("div", { class: Sidebar_default.stack }, /* @__PURE__ */ k("h1", { class: Sidebar_default.pageTitle }, t4("page_title")), /* @__PURE__ */ k("nav", { class: (0, import_classnames4.default)(Sidebar_default.nav, App_default.customScroller) }, ranges.value.map((range) => {
      return /* @__PURE__ */ k(Item3, { key: range.id, onClick, onDelete, current, range: range.id, count: range.count });
    })));
  }
  function Item3({ current, range, onClick, onDelete, count }) {
    ...
    return /* @__PURE__ */ k("div", { class: classNames, key: range }, /* @__PURE__ */ k(
      "button",
      {
      ...
      /* @__PURE__ */ k("span", { className: Sidebar_default.icon }, /* @__PURE__ */ k("img", { src: icons[range] })),
      titleMap[range](t4)
    ), /* @__PURE__ */ k(DeleteAllButton, { onClick: onDelete, ariaLabel: buttonLabel, range, count }));
  }
  ...
  function App() {
    ...
    return /* @__PURE__ */ k("div", { class: App_default.layout, "data-platform": platformName, "data-layout-mode": mode, onClick: clickAnywhere }, /* @__PURE__ */ k("aside", { class: App_default.aside }, /* @__PURE__ */ k(Sidebar, { ranges })), /* @__PURE__ */ k("header", { class: App_default.header }, /* @__PURE__ */ k(Header, null)), /* @__PURE__ */ k("main", { class: (0, import_classnames5.default)(App_default.main, App_default.customScroller), ref: mainRef, onClick }, /* @__PURE__ */ k(ResultsContainer, null)));
  }
  function AppLevelErrorBoundaryFallback({ children }) {
    return /* @__PURE__ */ k("div", { class: App_default.paddedError }, /* @__PURE__ */ k("p", null, children), /* @__PURE__ */ k("div", { class: App_default.paddedErrorRecovery }, "You can try to", " ", /* @__PURE__ */ k(
      "button",
      {
        onClick: () => {
  ...
  async function init(root2, messaging2, baseEnvironment2) {
    ...
    if (environment.display === "app") {
      R(
        /* @__PURE__ */ k(
          InlineErrorBoundary,
          {
            ...
            fallback: (message) => {
              return /* @__PURE__ */ k(AppLevelErrorBoundaryFallback, null, message);
            }
          },
          /* @__PURE__ */ k(
            EnvironmentProvider,
            ...
            /* @__PURE__ */ k(TranslationProvider, { translationObject: strings, fallback: history_default, textLength: environment.textLength }, /* @__PURE__ */ k(MessagingContext2.Provider, { value: messaging2 }, /* @__PURE__ */ k(ThemeProvider, { initialTheme: init2.theme, initialThemeVariant: init2.themeVariant }, /* @__PURE__ */ k(SettingsContext.Provider, { value: settings }, /* @__PURE__ */ k(QueryProvider, { query: query.query }, /* @__PURE__ */ k(HistoryServiceProvider, { service, initial }, /* @__PURE__ */ k(SelectionProvider, null, /* @__PURE__ */ k(App, null))))))))
          )
        ),
        root2
      );
      ...
      R(
        /* @__PURE__ */ k(EnvironmentProvider, { debugState: false, injectName: environment.injectName }, /* @__PURE__ */ k(TranslationProvider, { translationObject: strings, fallback: history_default, textLength: environment.textLength }, /* @__PURE__ */ k(Components, null))),
        root2
      );
    }
  }
  ...
  async function getStrings(environment) {
    return environment.locale === "en" ? history_default : await fetch(`./locales/${environment.locale}/history.json`).then((x5) => x5.json()).catch((e4) => {
  ...
  function generateSampleData({ count, offset }) {
    ...
    const baseDate = /* @__PURE__ */ new Date("2025-01-15T11:10:00");
    const value = [];
    for (let i5 = 0; i5 < count; i5++) {
      const id = i5 + offset;
      const dateOffset = Math.floor(i5 / domains.length);
      const date = new Date(baseDate);
      date.setDate(date.getDate() - dateOffset);
      const domainIndex = i5 % domains.length;
      value.push({
        ...
        dateTimeOfDay: date.toTimeString().split(" ")[0].slice(0, 5),
        // Format: "HH:MM"
      ...
      baseDate.setMinutes(baseDate.getMinutes() - 9);
    }
    return value;
  }
  function asResponse(items, offset, chunkSize = HistoryService.CHUNK_SIZE) {
        ...
        switch (msg.method) {
          ...
          case "deleteRange": {
            ...
            if (confirm(lines)) {
              ...
              rangeMemory.ranges = rangeMemory.ranges.filter((x5) => {
                return x5.id !== msg.params.range;
              });
    ...
    if ("term" in msg.params.query) {
      ...
      if (term !== "") {
        ...
        if (term.trim().match(/^\d+$/)) {
          ...
          const response2 = asResponse(memory.slice(0, int), msg.params.offset, msg.params.limit);
          response2.value = response2.value.map((item) => {
            return {
              ...item,
      ...
      response.value = response.value.map((item) => {
        if (!("range" in msg.params.query)) return item;
        return {
          ...item,
          dateTimeOfDay: msg.params.query.range === "sites" ? void 0 : item.dateTimeOfDay,
  ...
  init(root, historyPage, baseEnvironment).catch((e4) => {
    ...
    document.documentElement.dataset.fatalError = "true";
    const element = /* @__PURE__ */ k(S, null, /* @__PURE__ */ k("div", { style: "padding: 1rem;" }, /* @__PURE__ */ k("p", null, /* @__PURE__ */ k("strong", null, "A fatal error occurred:")), /* @__PURE__ */ k("br", null), /* @__PURE__ */ k("pre", { style: { whiteSpace: "prewrap", overflow: "auto" } }, /* @__PURE__ */ k("code", null, JSON.stringify({ message: e4.message }, null, 2)))));
