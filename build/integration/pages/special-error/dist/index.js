...
(() => {
  ...
  function N(u3, t3, i3, r3, o3, e3, f3, c3, s3) {
    var a3, h3, v3, y3, w3, g2, m3, b = i3.props, k3 = t3.props, x3 = t3.type;
    ...
    if (null === x3) b === k3 || c3 && u3.data === k3 || (u3.data = k3);
      ...
      c3 || (a3 = "value", "progress" == x3 && null == g2 ? u3.removeAttribute("value") : void 0 !== g2 && (g2 !== u3[a3] || "progress" == x3 && !g2 || "option" == x3 && g2 !== b[a3]) && F(u3, a3, g2, b[a3], o3), a3 = "checked", void 0 !== m3 && m3 !== u3[a3] && F(u3, a3, m3, b[a3], o3));
    }
    return u3;
  }
  function V(n2, u3, t3) {
  ...
  function MessagingProvider({ children, messaging: messaging2 }) {
    return /* @__PURE__ */ g(MessagingContext2.Provider, { value: { messaging: messaging2 } }, children);
  }
  ...
  function ErrorFallback() {
    return /* @__PURE__ */ g("h1", null, "Something went wrong");
  }
  ...
  function SpecialErrorProvider({ children, specialError }) {
    return /* @__PURE__ */ g(SpecialErrorContext.Provider, { value: specialError }, children);
  }
  ...
  function useWarningContent() {
    ...
    if (kind === "ssl") {
      ...
      return [/* @__PURE__ */ g(Trans, { str: t3("sslWarningText", { domain }), values: "" })];
    }
    throw new Error(`Unhandled error kind ${kind}`);
  }
  ...
  function useAdvancedInfoContent() {
    ...
    if (kind === "ssl") {
      ...
      switch (errorType) {
        case "expired":
          return [/* @__PURE__ */ g(Trans, { str: t3("sslExpiredAdvancedInfoText", { domain }), values: "" })];
        case "invalid":
          return [/* @__PURE__ */ g(Trans, { str: t3("sslInvalidAdvancedInfoText", { domain }), values: "" })];
        case "selfSigned":
          return [/* @__PURE__ */ g(Trans, { str: t3("sslSelfSignedAdvancedInfoText", { domain }), values: "" })];
        case "wrongHost":
          const { eTldPlus1 } = (
            /** @type {SSLWrongHost} */
            errorData
          );
          return [/* @__PURE__ */ g(Trans, { str: t3("sslWrongHostAdvancedInfoText", { domain, eTldPlus1 }), values: "" })];
        default:
  ...
  function Text({ as: Comp = "p", variant, strictSpacing = true, className, children }) {
    return /* @__PURE__ */ g(Comp, { className: (0, import_classnames.default)({ [Text_default[`${variant}`]]: variant, [Text_default.strictSpacing]: strictSpacing }, className) }, children);
  }
  ...
  function Warning({ advancedInfoVisible, advancedButtonHandler }) {
    return /* @__PURE__ */ g("section", { className: Warning_default.container }, /* @__PURE__ */ g(WarningHeading, null), /* @__PURE__ */ g(WarningContent, null), /* @__PURE__ */ g("div", { className: Warning_default.buttonContainer }, !advancedInfoVisible && /* @__PURE__ */ g(AdvancedInfoButton, { onClick: () => advancedButtonHandler() }), /* @__PURE__ */ g(LeaveSiteButton, null)));
  }
  ...
  function VisitSiteLink({ elemRef }) {
    const { t: t3 } = useTypedTranslation();
    const { messaging: messaging2 } = useMessaging();
    return /* @__PURE__ */ g("a", { className: AdvancedInfo_default.visitSite, onClick: () => messaging2?.visitSite(), ref: elemRef }, t3("visitSiteButton"));
  }
  ...
  function SpecialErrorView() {
    ...
    return /* @__PURE__ */ g("div", { className: App_default.container }, /* @__PURE__ */ g(Warning, { advancedInfoVisible, advancedButtonHandler }), advancedInfoVisible && /* @__PURE__ */ g(AdvancedInfo, null));
  }
  function PageTitle() {
    const { kind } = useErrorData();
    const { t: t3 } = useTypedTranslation();
  ...
  function App() {
    ...
    return /* @__PURE__ */ g("main", { className: App_default.main }, /* @__PURE__ */ g(PageTitle, null), /* @__PURE__ */ g(ErrorBoundary, { didCatch, fallback: /* @__PURE__ */ g(ErrorFallback, null) }, /* @__PURE__ */ g(SpecialErrorView, null), /* @__PURE__ */ g(WillThrow, null)));
  }
  function WillThrow() {
    const env = useEnv();
    if (env.willThrow) {
  ...
  function Components() {
    ...
    return /* @__PURE__ */ g("div", null, /* @__PURE__ */ g("div", { className: Components_default.selector }, /* @__PURE__ */ g("fieldset", null, /* @__PURE__ */ g("label", { for: "platform-select" }, "Platform:"), /* @__PURE__ */ g("select", { id: "platform-select", onChange: (e3) => handlePlatformChange(e3.currentTarget?.value) }, Object.entries(platforms).map(([id, name]) => {
  ...
  async function init(messaging2, baseEnvironment2) {
    ...
    if (environment.display === "app") {
      D(
        /* @__PURE__ */ g(EnvironmentProvider, { debugState: environment.debugState, injectName: environment.injectName, willThrow: environment.willThrow }, /* @__PURE__ */ g(UpdateEnvironment, { search: window.location.search }), /* @__PURE__ */ g(TranslationProvider, { translationObject: strings, fallback: special_error_default, textLength: environment.textLength }, /* @__PURE__ */ g(MessagingProvider, { messaging: messaging2 }, /* @__PURE__ */ g(SettingsProvider, { settings }, /* @__PURE__ */ g(SpecialErrorProvider, { specialError }, /* @__PURE__ */ g(App, null)))))),
        root
      );
    } else if (environment.display === "components") {
      D(
        /* @__PURE__ */ g(EnvironmentProvider, { debugState: false, injectName: environment.injectName }, /* @__PURE__ */ g(TranslationProvider, { translationObject: strings, fallback: special_error_default, textLength: environment.textLength }, /* @__PURE__ */ g(SettingsProvider, { settings }, /* @__PURE__ */ g(SpecialErrorProvider, { specialError }, /* @__PURE__ */ g(Components, null))))),
        root
      );
    }
  }
