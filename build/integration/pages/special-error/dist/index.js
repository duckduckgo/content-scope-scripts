...
(() => {
    ...
    switch (kind) {
      ...
      case "scam":
        const translationKey = (
          /** @type {"malwarePageHeading"|"phishingPageHeading"|"scamPageHeading"} */
          `${kind}PageHeading`
        );
  ...
  function useAdvancedInfoHeading() {
    ...
    switch (kind) {
      ...
      case "scam":
        ...
        const translationKey = (
          /** @type {"malwareAdvancedInfoHeading"|"phishingAdvancedInfoHeading"|"scamAdvancedInfoHeading"} */
  ...
  function App() {
    ...
    return /* @__PURE__ */ g("main", { className: App_default.main, "data-theme": isDarkMode ? "dark" : "light" }, /* @__PURE__ */ g(PageTitle, null), /* @__PURE__ */ g(ErrorBoundary, { didCatch: ({ error }) => didCatch(error), fallback: /* @__PURE__ */ g(ErrorFallback, null) }, /* @__PURE__ */ g(SpecialErrorView, null), /* @__PURE__ */ g(WillThrow, null)));
  }
  function WillThrow() {
    const env = useEnv();
    if (env.willThrow) {
