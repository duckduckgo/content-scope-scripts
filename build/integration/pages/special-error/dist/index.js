...
(() => {
  ...
  function App() {
    ...
    return /* @__PURE__ */ g("main", { className: App_default.main, "data-theme": isDarkMode ? "dark" : "light" }, /* @__PURE__ */ g(PageTitle, null), /* @__PURE__ */ g(ErrorBoundary, { didCatch, fallback: /* @__PURE__ */ g(ErrorFallback, null) }, /* @__PURE__ */ g(SpecialErrorView, null), /* @__PURE__ */ g(WillThrow, null)));
  }
  function WillThrow() {
    const env = useEnv();
    if (env.willThrow) {
