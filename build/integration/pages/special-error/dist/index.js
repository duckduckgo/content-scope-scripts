...
(() => {
  ...
  function V(t3, u3, i3, r3, o3, e3, f3, c3, s3) {
    ...
    if (null === x3) b === k3 || c3 && t3.data === k3 || (t3.data = k3);
      ...
      c3 || (a3 = "value", "progress" == x3 && null == _2 ? t3.removeAttribute("value") : void 0 !== _2 && (_2 !== t3[a3] || "progress" == x3 && !_2 || "option" == x3 && _2 !== b[a3]) && j(t3, a3, _2, b[a3], o3), a3 = "checked", void 0 !== m3 && m3 !== t3[a3] && j(t3, a3, m3, b[a3], o3));
    }
    return t3;
  }
  function q(n2, t3, u3) {
