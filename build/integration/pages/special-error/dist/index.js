...
(() => {
  ...
  function j(n2, t3, u3, i3, r3, o3, e3, f3, c3, s3) {
    var a3, h3, p3, v3, y3, _2, m3, b, S2, C3, M2, $2, P2, A3, H, L2, T3, F2 = t3.type;
  ...
  function N(t3, u3, i3, r3, o3, e3, f3, c3, s3) {
    var a3, h3, v3, y3, w3, _2, m3, b = i3.props, k3 = u3.props, x3 = u3.type;
    ...
    if (null === x3) b === k3 || c3 && t3.data === k3 || (t3.data = k3);
      ...
      for (a3 in k3) w3 = k3[a3], "children" == a3 ? y3 = w3 : "dangerouslySetInnerHTML" == a3 ? h3 = w3 : "value" == a3 ? _2 = w3 : "checked" == a3 ? m3 = w3 : c3 && "function" != typeof w3 || b[a3] === w3 || F(t3, a3, w3, b[a3], o3);
      ...
      c3 || (a3 = "value", "progress" == x3 && null == _2 ? t3.removeAttribute("value") : void 0 !== _2 && (_2 !== t3[a3] || "progress" == x3 && !_2 || "option" == x3 && _2 !== b[a3]) && F(t3, a3, _2, b[a3], o3), a3 = "checked", void 0 !== m3 && m3 !== t3[a3] && F(t3, a3, m3, b[a3], o3));
    }
    return t3;
  }
  function V(n2, t3, u3) {
