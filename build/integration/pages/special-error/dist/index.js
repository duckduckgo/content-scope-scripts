...
(() => {
  ...
  function I(n2, l3, u3, t3, i3, o3, r3, e3, f3, c3, s3) {
    ...
    for (f3 = P(u3, l3, m3, f3, b), a3 = 0; a3 < b; a3++) null != (y3 = u3.__k[a3]) && (h3 = -1 == y3.__i ? p : m3[y3.__i] || p, y3.__i = a3, g2 = O(n2, y3, h3, i3, o3, r3, e3, f3, c3, s3), d3 = y3.__e, y3.ref && h3.ref != y3.ref && (h3.ref && B(h3.ref, null, y3), s3.push(y3.ref, y3.__c || d3, y3)), null == w3 && null != d3 && (w3 = d3), (_2 = !!(4 & y3.__u)) || h3.__k === y3.__k ? f3 = A(y3, f3, n2, _2) : "function" == typeof y3.type && void 0 !== g2 ? f3 = g2 : d3 && (f3 = d3.nextSibling), y3.__u &= -7);
    return u3.__e = w3, f3;
  }
  ...
  function q(u3, t3, i3, o3, r3, e3, f3, c3, s3) {
    ...
    if (null == x3) b === k3 || c3 && u3.data == k3 || (u3.data = k3);
      ...
      for (a3 in k3) w3 = k3[a3], "children" == a3 ? y3 = w3 : "dangerouslySetInnerHTML" == a3 ? h3 = w3 : "value" == a3 ? _2 = w3 : "checked" == a3 ? m3 = w3 : c3 && "function" != typeof w3 || b[a3] === w3 || j(u3, a3, w3, b[a3], r3);
      ...
      c3 || (a3 = "value", "progress" == x3 && null == _2 ? u3.removeAttribute("value") : null != _2 && (_2 !== u3[a3] || "progress" == x3 && !_2 || "option" == x3 && _2 != b[a3]) && j(u3, a3, _2, b[a3], r3), a3 = "checked", null != m3 && m3 != u3[a3] && j(u3, a3, m3, b[a3], r3));
    }
    return u3;
  }
  function B(n2, u3, t3) {
