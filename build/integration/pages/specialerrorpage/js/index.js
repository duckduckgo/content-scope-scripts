...
(() => {
  ...
  // pages/specialerrorpage/src/img/Shield-Alert-96x96.data.svg
  ...
  // pages/specialerrorpage/src/js/template.js
  ...
  // pages/specialerrorpage/src/js/loadData.js
  var loadData = {
    ssl: {
      strings: {
  ...
  // pages/specialerrorpage/src/js/index.js
  var SpecialerrorpagePage = class {
    /**
  ...
  var page = new SpecialerrorpagePage(messaging);
