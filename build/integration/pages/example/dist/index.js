...
(() => {
  ...
  function j(n2, u3, t3, i3, r3, o3, e3, f3, c3, s3) {
    var a3, h3, p3, v3, y3, g2, m3, b, C3, S2, M2, P2, I2, A3, H, L2, T2, F2 = u3.type;
  ...
  function App() {
    ...
    return /* @__PURE__ */ g("main", { class: App_default.main }, t3("helloWorld"));
  }
  ...
  async function init(messaging2, baseEnvironment2) {
    ...
    if (environment.display === "app") {
      D(
        /* @__PURE__ */ g(EnvironmentProvider, { debugState: environment.debugState, injectName: environment.injectName, willThrow: environment.willThrow }, /* @__PURE__ */ g(UpdateEnvironment, { search: window.location.search }), /* @__PURE__ */ g(TranslationProvider, { translationObject: strings, fallback: example_default, textLength: environment.textLength }, /* @__PURE__ */ g(App, null))),
        root
      );
    } else if (environment.display === "components") {
      D(
        /* @__PURE__ */ g(EnvironmentProvider, { debugState: false, injectName: environment.injectName }, /* @__PURE__ */ g(TranslationProvider, { translationObject: strings, fallback: example_default, textLength: environment.textLength }, /* @__PURE__ */ g(Components, null))),
        root
      );
    }
  }
