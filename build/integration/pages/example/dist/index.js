...
(() => {
  ...
  function q(n2, u3, t3, i3, r3, o3, e3, f3, c3, a3) {
    var s3, h3, p3, v3, y3, d3, _2, k3, x3, M, I2, P2, A3, H2, T2, j3, F = u3.type;
    ...
    n: if ("function" == typeof F) {
      ...
      try {
        ...
        p3.state = p3.__s, null != p3.getChildContext && (i3 = m(m({}, i3), p3.getChildContext())), M && !v3 && null != p3.getSnapshotBeforeUpdate && (_2 = p3.getSnapshotBeforeUpdate(y3, d3)), T2 = null != s3 && s3.type === S && null == s3.key ? E(s3.props.children) : s3, f3 = L(n2, g(T2) ? T2 : [T2], u3, t3, i3, r3, o3, e3, f3, c3, a3), p3.base = u3.__e, u3.__u &= -161, p3.__h.length && e3.push(p3), k3 && (p3.__E = p3.__ = null);
      } catch (n3) {
  ...
  function App() {
    ...
    return /* @__PURE__ */ k("main", { class: App_default.main }, t3("helloWorld"));
  }
  ...
  async function init(messaging2, baseEnvironment2) {
    ...
    if (environment.display === "app") {
      R(
        /* @__PURE__ */ k(EnvironmentProvider, { debugState: environment.debugState, injectName: environment.injectName, willThrow: environment.willThrow }, /* @__PURE__ */ k(UpdateEnvironment, { search: window.location.search }), /* @__PURE__ */ k(TranslationProvider, { translationObject: strings, fallback: example_default, textLength: environment.textLength }, /* @__PURE__ */ k(App, null))),
        root
      );
    } else if (environment.display === "components") {
      R(
        /* @__PURE__ */ k(EnvironmentProvider, { debugState: false, injectName: environment.injectName }, /* @__PURE__ */ k(TranslationProvider, { translationObject: strings, fallback: example_default, textLength: environment.textLength }, /* @__PURE__ */ k(Components, null))),
        root
      );
    }
  }
