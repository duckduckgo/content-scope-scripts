...
(() => {
  ...
  // pages/example/src/locales/en/example.json
  var example_default = {
    smartling: {
      string_format: "icu",
      translate_paths: [
  ...
  function App() {
    ...
    return /* @__PURE__ */ y("main", { class: App_default.main }, t3("helloWorld"));
  }
    ...
    if (environment.display === "app") {
      q(
        /* @__PURE__ */ y(
          ...
          /* @__PURE__ */ y(TranslationProvider, { translationObject: strings, fallback: example_default, textLength: environment.textLength }, /* @__PURE__ */ y(App, null))
        ),
        root
      );
    } else if (environment.display === "components") {
      q(
        /* @__PURE__ */ y(EnvironmentProvider, { debugState: false, injectName: environment.injectName }, /* @__PURE__ */ y(TranslationProvider, { translationObject: strings, fallback: example_default, textLength: environment.textLength }, /* @__PURE__ */ y(Components, null))),
        root
      );
    }
  }

  // pages/example/src/js/index.js
