...
(() => {
  ...
  var set_as_default_default = {
    ...
    tabTitle: {
      ...
      note: "Browser tab title for the page that helps the user make DuckDuckGo their default browser in Windows settings."
    },
    setDefaultInstruction: {
      title: "Select the <strong>Set default button</strong> in Windows settings to make DuckDuckGo your default browser.",
  ...
  async function init(messaging2, baseEnvironment2) {
    ...
    if (environment.display === "app") {
      R(
        /* @__PURE__ */ k(InlineErrorBoundary, { messaging: messaging2, context: "Set as Default application" }, /* @__PURE__ */ k(
          EnvironmentProvider,
          {
          ...
          /* @__PURE__ */ k(TranslationProvider, { translationObject: strings, fallback: set_as_default_default, textLength: environment.textLength }, /* @__PURE__ */ k(App, null), /* @__PURE__ */ k(WillThrow, null))
        )),
        root
      );
