...
(() => {
  ...
  function j(n3, u4, t4, i5, r4, o4, e4, f4, c4, s5) {
    var a4, h4, p5, v5, y4, g5, m3, b3, C3, S2, M3, P4, I3, A3, H2, L2, T4, F4 = u4.type;
    ...
    n: if ("function" == typeof F4) try {
      ...
      if (h4.context = M3, h4.props = b3, h4.__P = n3, h4.__e = false, I3 = l.__r, A3 = 0, C3) {
        for (h4.state = h4.__s, h4.__d = false, I3 && I3(u4), a4 = h4.render(h4.props, h4.state, h4.context), H2 = 0; H2 < h4._sb.length; H2++) h4.__h.push(h4._sb[H2]);
        h4._sb = [];
      } else do {
  ...
  function DismissButton({ className, onClick }) {
    const { t: t4 } = useTypedTranslation();
    return /* @__PURE__ */ g("button", { class: (0, import_classnames6.default)(DismissButton_default.btn, className), onClick, "aria-label": t4("ntp_dismiss"), "data-testid": "dismissBtn" }, /* @__PURE__ */ g(Cross, null));
  }
  ...
  function NextStepsCardGroup({ types, expansion, toggle, action, dismiss }) {
    ...
    return /* @__PURE__ */ g("div", { class: (0, import_classnames9.default)(NextSteps_default.cardGroup, types.length <= 2 && NextSteps_default.bottomSpace), id: WIDGET_ID }, /* @__PURE__ */ g(NextStepsBubbleHeader, null), /* @__PURE__ */ g("div", { class: NextSteps_default.cardGrid }, alwaysShown.map((type) => /* @__PURE__ */ g(NextStepsCard, { key: type, type, dismiss, action })), expansion === "expanded" && types.length > 2 && types.slice(2).map((type) => /* @__PURE__ */ g(NextStepsCard, { key: type, type, dismiss, action }))), types.length > 2 && /* @__PURE__ */ g(
      "div",
      {
  ...
  function Heading({ expansion, trackerCompanies, onToggle, buttonAttrs = {} }) {
    ...
    )), recent === 0 && /* @__PURE__ */ g("p", { className: PrivacyStats_default.subtitle }, t4("stats_noActivity")), recent > 0 && /* @__PURE__ */ g("p", { className: (0, import_classnames10.default)(PrivacyStats_default.subtitle, PrivacyStats_default.uppercase) }, t4("stats_feedCountBlockedPeriod")));
  }
  ...
  function UpdateNotification({ notes, dismiss, version }) {
    return /* @__PURE__ */ g("div", { class: UpdateNotification_default.root, "data-reset-layout": "true" }, /* @__PURE__ */ g("div", { class: (0, import_classnames12.default)("layout-centered", UpdateNotification_default.body) }, notes.length > 0 ? /* @__PURE__ */ g(WithNotes, { notes, version }) : /* @__PURE__ */ g(WithoutNotes, { version })), /* @__PURE__ */ g(DismissButton, { onClick: dismiss, className: UpdateNotification_default.dismiss }));
  }
  ...
  function App({ children }) {
    ...
    return /* @__PURE__ */ g("div", { class: (0, import_classnames13.default)(App_default.layout), ref: wrapperRef, "data-drawer-visibility": visibility }, /* @__PURE__ */ g("main", { class: (0, import_classnames13.default)(App_default.main), "data-main-scroller": true, "data-customizer-kind": customizerKind }, /* @__PURE__ */ g("div", { class: App_default.tube, "data-platform": platformName }, /* @__PURE__ */ g(WidgetList, null), /* @__PURE__ */ g(CustomizerMenuPositionedFixed, null, customizerKind === "menu" && /* @__PURE__ */ g(Customizer, null), customizerKind === "drawer" && /* @__PURE__ */ g(
      CustomizerButton,
      {
        buttonId,
        menuId: drawerId,
