...
(() => {
  ...
  var init_PrivacyStats = __esm({
    "pages/new-tab/app/privacy-stats/components/PrivacyStats.module.css"() {
      PrivacyStats_default = {
        ...
        historyMsg: "PrivacyStats_historyMsg",
        dismissBtn: "PrivacyStats_dismissBtn",
        historyLink: "PrivacyStats_historyLink",
  ...
  function PrivacyStatsProvider(props) {
    ...
    useDataSubscription({ dispatch, service });
    const { toggle } = useConfigSubscription({ dispatch, service });
    const openHistory = q2(() => {
      service.current?.openHistory();
    }, [service]);
    const dismiss = q2(() => {
      service.current?.dismiss();
    }, [service]);
    return /* @__PURE__ */ _(PrivacyStatsContext.Provider, { value: { state, toggle } }, /* @__PURE__ */ _(PrivacyStatsDispatchContext.Provider, { value: dispatch }, /* @__PURE__ */ _(HistoryOnboardingContext.Provider, { value: { openHistory, dismiss } }, props.children)));
  }
  ...
  var PrivacyStatsContext, PrivacyStatsDispatchContext, HistoryOnboardingContext;
  ...
  function Heading({ expansion, canExpand, recent, onToggle, buttonAttrs = {} }) {
    ...
    )), recent === 0 && /* @__PURE__ */ _("p", { className: (0, import_classnames11.default)(PrivacyStats_default.subtitle) }, t4("stats_noActivity")), recent > 0 && /* @__PURE__ */ _("p", { className: (0, import_classnames11.default)(PrivacyStats_default.subtitle, PrivacyStats_default.uppercase) }, t4("stats_feedCountBlockedPeriod")), /* @__PURE__ */ _(HistoryOnboarding, null));
  }
  function HistoryOnboarding() {
    ...
    const { openHistory, dismiss } = x2(HistoryOnboardingContext);
    if (!state.config) return null;
    if (state.config.onboarding !== "history") return null;
    return /* @__PURE__ */ _("div", { className: PrivacyStats_default.historyMsg }, /* @__PURE__ */ _("p", null, t4("stats_historyMovedMessage"), " ", /* @__PURE__ */ _("a", { onClick: openHistory, className: PrivacyStats_default.historyLink, href: "#" }, t4("stats_history"))), /* @__PURE__ */ _(DismissButton, { className: PrivacyStats_default.dismissBtn, onClick: dismiss }));
  }
  ...
  var new_tab_default = {
    ...
    stats_historyMovedMessage: {
      title: "You can now see the tracking attempts we block while you browse. Access your recent activity anytime in",
      note: "Body text pointing user to a History menu"
    },
    stats_history: {
      title: "History",
      note: "Link text that finishes the stats_historyMovedMessage text"
    },
  ...
  var privacyStatsExamples = {
    ...
    "stats.few.collapsed": {
      factory: () => /* @__PURE__ */ _(PrivacyStatsMockProvider, { config: { expansion: "collapsed", onboarding: "history" } }, /* @__PURE__ */ _(PrivacyStatsConsumer, null))
    },
    "stats.single": {
