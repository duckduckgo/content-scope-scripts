...
(() => {
  ...
  function DuckDuckGoLogo() {
    return /* @__PURE__ */ g("span", { className: DuckDuckGoLogo_default.logo }, /* @__PURE__ */ g("span", { className: (0, import_classnames.default)(DuckDuckGoLogo_default.logo, "offscreen") }, "DuckDuckGo"));
  }
  ...
  function ErrorFallback() {
    ...
    return /* @__PURE__ */ g("h1", null, t3("somethingWentWrong"));
  }
  ...
  function Card({ className, children }) {
    return /* @__PURE__ */ g("section", { className: (0, import_classnames3.default)(Card_default.card, className) }, children);
  }
  ...
  function Text({ as: Comp = "p", variant, strictSpacing = true, className, children }) {
    return /* @__PURE__ */ g(Comp, { className: (0, import_classnames4.default)({ [Text_default[`${variant}`]]: variant, [Text_default.strictSpacing]: strictSpacing }, className) }, children);
  }
  ...
  function ContentPlaceholder() {
    return /* @__PURE__ */ g("div", { className: ContentPlaceholder_default.contentPlaceholder, "aria-hidden": "true", "data-testid": "placeholder" }, /* @__PURE__ */ g("h2", null), /* @__PURE__ */ g("p", null), /* @__PURE__ */ g("ul", null, /* @__PURE__ */ g("li", null, /* @__PURE__ */ g("p", null), /* @__PURE__ */ g("p", null)), /* @__PURE__ */ g("li", null, /* @__PURE__ */ g("p", null), /* @__PURE__ */ g("p", null))));
  }
  ...
  function PageTitle({ title }) {
    return /* @__PURE__ */ g("h1", { className: ReleaseNotes_default.title }, title);
  }
  function StatusText({ status, version, progress = 0 }) {
    ...
    return /* @__PURE__ */ g(Text, { variant: "title-2", className: ReleaseNotes_default.statusText }, t3("versionNumber", { version: `${version}` }), " \u2014 ", statusTexts[status]);
  }
  function StatusIcon({ status, className }) {
    ...
    return /* @__PURE__ */ g("div", { className: (0, import_classnames5.default)(ReleaseNotes_default.statusIcon, iconClasses[status], className) });
  }
  function StatusTimestamp({ timestamp }) {
    ...
    return /* @__PURE__ */ g(Text, { variant: "body", className: ReleaseNotes_default.statusTimestamp }, t3("lastChecked", { date: dateString }));
  }
  function UpdateStatus({ status, timestamp, version, progress }) {
    return /* @__PURE__ */ g("div", { className: ReleaseNotes_default.statusContainer }, /* @__PURE__ */ g(StatusIcon, { status, className: ReleaseNotes_default.gridIcon }), /* @__PURE__ */ g(StatusText, { status, version, progress }), /* @__PURE__ */ g(StatusTimestamp, { timestamp }));
  }
  function ReleaseNotesHeading({ title, version, showNewTag = false }) {
    const { t: t3 } = useTypedTranslation();
    return /* @__PURE__ */ g("header", { className: ReleaseNotes_default.notesHeading }, /* @__PURE__ */ g("h2", { className: ReleaseNotes_default.releaseTitle }, title, showNewTag && /* @__PURE__ */ g("span", { className: ReleaseNotes_default.newTag }, t3("new"))), /* @__PURE__ */ g(Text, { variant: "title-2", className: ReleaseNotes_default.releaseVersion }, t3("versionNumber", { version: `${version}` })));
  }
  function ReleaseNotesSubheading({ icon, title }) {
    return /* @__PURE__ */ g("div", { className: ReleaseNotes_default.notesSubheading }, icon && /* @__PURE__ */ g("span", { className: (0, import_classnames5.default)(ReleaseNotes_default.notesIcon, ReleaseNotes_default[`notesIcon${icon}`]) }), /* @__PURE__ */ g(Text, { as: "h3", variant: "headline" }, title));
  }
  function ReleaseNotesList({ notes }) {
    return /* @__PURE__ */ g("ul", { className: ReleaseNotes_default.list }, notes.map((note) => /* @__PURE__ */ g(Text, { as: "li", variant: "body", className: ReleaseNotes_default.listItem }, note)));
  }
  function ReleaseNotesContent({ title: releaseTitle, currentVersion, latestVersion, notes: releaseNotes }) {
    ...
    return /* @__PURE__ */ g(k, null, /* @__PURE__ */ g(ReleaseNotesHeading, { title: releaseTitle, version, showNewTag }), /* @__PURE__ */ g("div", { className: ReleaseNotes_default.listGrid }, releaseNotes.map(({ icon, title, notes }) => /* @__PURE__ */ g("div", { class: ReleaseNotes_default.listContainer }, title && /* @__PURE__ */ g(ReleaseNotesSubheading, { title, icon }), /* @__PURE__ */ g(ReleaseNotesList, { notes })))));
  }
  function CardContents({ releaseData }) {
    ...
    if (isLoading || status === "loadingError") {
      return /* @__PURE__ */ g(ContentPlaceholder, null);
    }
    const notes = [];
    ...
    if (releaseNotesPrivacyPro?.length) {
      notes.push({
        ...
        notes: [
          ...
          /* @__PURE__ */ g("span", null, "Not subscribed? Find out more at", " ", /* @__PURE__ */ g("a", { href: "https://duckduckgo.com/pro", target: "_blank" }, "duckduckgo.com/pro"))
        ]
      });
    }
    return /* @__PURE__ */ g(ReleaseNotesContent, { title: releaseTitle, currentVersion, latestVersion, notes });
  }
  function UpdateButton({ releaseData }) {
    ...
    if (status === "loadingError") {
      button = /* @__PURE__ */ g(Button, { onClick: () => messages?.retryFetchReleaseNotes(), variant: "accentBrand", size: platform === "macos" ? "lg" : "md" }, t3("retryGettingReleaseNotes"));
    }
    if (status === "updateError") {
      button = /* @__PURE__ */ g(Button, { onClick: () => messages?.retryUpdate(), variant: "accentBrand", size: platform === "macos" ? "lg" : "md" }, t3("retryUpdate"));
    }
    if (status === "updateReady" || status === "criticalUpdateReady") {
      ...
      button = /* @__PURE__ */ g(Button, { onClick: () => messages?.browserRestart(), variant: "accentBrand", size: platform === "macos" ? "lg" : "md" }, buttonText);
    }
    if (!button) return null;
    return /* @__PURE__ */ g("div", { className: ReleaseNotes_default.buttonContainer }, button);
  }
  function ReleaseNotes({ releaseData }) {
    ...
    return /* @__PURE__ */ g("article", { className: ReleaseNotes_default.article }, /* @__PURE__ */ g("header", { className: ReleaseNotes_default.heading }, /* @__PURE__ */ g("p", null, t3("thankyou")), /* @__PURE__ */ g(PageTitle, { title: t3("browserReleaseNotes") }), /* @__PURE__ */ g(UpdateStatus, { status, timestamp: timestampInMilliseconds, version: currentVersion, progress }), shouldShowButton && /* @__PURE__ */ g(UpdateButton, { releaseData })), status !== "loadingError" && /* @__PURE__ */ g(Card, { className: ReleaseNotes_default.card }, /* @__PURE__ */ g(CardContents, { releaseData })), /* @__PURE__ */ g("a", { href: "https://duckduckgo.com/updates", target: "_blank", className: ReleaseNotes_default.updatesLink }, t3("whatsNewAtDuckDuckGoLink"), /* @__PURE__ */ g("svg", { fill: "none", viewBox: "0 0 16 16", xmlns: "http://www.w3.org/2000/svg", className: ReleaseNotes_default.linkIcon }, /* @__PURE__ */ g(
      "path",
      {
        fill: "currentColor",
  ...
  function App({ children }) {
    ...
    return /* @__PURE__ */ g("main", { className: App_default.main, "data-theme": isDarkMode ? "dark" : "light" }, /* @__PURE__ */ g(ErrorBoundary, { didCatch: ({ error }) => didCatch(error), fallback: /* @__PURE__ */ g(ErrorFallback, null) }, /* @__PURE__ */ g("header", { className: App_default.header }, /* @__PURE__ */ g(DuckDuckGoLogo, null)), /* @__PURE__ */ g("div", { class: App_default.core }, releaseData && /* @__PURE__ */ g(ReleaseNotes, { releaseData })), /* @__PURE__ */ g(WillThrow, null), children));
  }
  function WillThrow() {
    const env = useEnv();
    if (env.willThrow) {
  ...
  function Components() {
    ...
    return /* @__PURE__ */ g("main", { className: Components_default.main, "data-theme": isDarkMode ? "dark" : "light" }, /* @__PURE__ */ g("h1", null, "Release Notes Components"), /* @__PURE__ */ g("h2", null, "DuckDuckGo Logo"), /* @__PURE__ */ g(DuckDuckGoLogo, null), /* @__PURE__ */ g("hr", null), /* @__PURE__ */ g("h2", null, "Page Title"), /* @__PURE__ */ g(PageTitle, { title: t3("browserReleaseNotes") }), /* @__PURE__ */ g("hr", null), /* @__PURE__ */ g("h2", null, "Update Status"), /* @__PURE__ */ g(UpdateStatus, { status: "loading", version: "1.0.1", timestamp: yesterdayInMilliseconds }), /* @__PURE__ */ g(UpdateStatus, { status: "loadingError", version: "1.0.1", timestamp: yesterdayInMilliseconds }), /* @__PURE__ */ g(UpdateStatus, { status: "loaded", version: "1.0.1", timestamp: todayInMilliseconds }), /* @__PURE__ */ g(UpdateStatus, { status: "updateReady", version: "1.2.0", timestamp: todayInMilliseconds }), /* @__PURE__ */ g(UpdateStatus, { status: "criticalUpdateReady", version: "1.2.0", timestamp: todayInMilliseconds }), /* @__PURE__ */ g(UpdateStatus, { status: "updateError", version: "1.2.0", timestamp: todayInMilliseconds }), /* @__PURE__ */ g(UpdateStatus, { status: "updateDownloading", version: "1.2.0", timestamp: todayInMilliseconds, progress: 0.35 }), /* @__PURE__ */ g(UpdateStatus, { status: "updatePreparing", version: "1.2.0", timestamp: todayInMilliseconds }), /* @__PURE__ */ g("hr", null), /* @__PURE__ */ g("h2", null, "Update Buttons"), /* @__PURE__ */ g("div", null, /* @__PURE__ */ g(Button, { variant: "accentBrand", size: platform === "macos" ? "lg" : "md" }, t3("retryGettingReleaseNotes"))), /* @__PURE__ */ g("div", null, /* @__PURE__ */ g(Button, { variant: "accentBrand", size: platform === "macos" ? "lg" : "md" }, t3("restartToUpdate"))), /* @__PURE__ */ g("div", null, /* @__PURE__ */ g(Button, { variant: "accentBrand", size: platform === "macos" ? "lg" : "md" }, t3("updateBrowser"))), /* @__PURE__ */ g("div", null, /* @__PURE__ */ g(Button, { variant: "accentBrand", size: platform === "macos" ? "lg" : "md" }, t3("retryUpdate"))), /* @__PURE__ */ g("hr", null), /* @__PURE__ */ g("h2", null, "Content Placeholder"), /* @__PURE__ */ g(ContentPlaceholder, null), /* @__PURE__ */ g("hr", null), /* @__PURE__ */ g("h2", null, "Release Notes Heading"), /* @__PURE__ */ g(ReleaseNotesHeading, { title: "May 10 2023", version: "1.0.0", showNewTag: false }), /* @__PURE__ */ g(ReleaseNotesHeading, { title: "May 10 2024", version: "1.2.0", showNewTag: true }), /* @__PURE__ */ g("hr", null), /* @__PURE__ */ g("h2", null, "Release Notes Subheading"), /* @__PURE__ */ g(ReleaseNotesSubheading, { title: "Release Notes Subheading without Icon" }), /* @__PURE__ */ g(ReleaseNotesSubheading, { icon: "PrivacyPro", title: "Release Notes Subheading with Privacy Pro Icon" }), /* @__PURE__ */ g("hr", null), /* @__PURE__ */ g("h2", null, "Release Notes List"), /* @__PURE__ */ g(ReleaseNotesList, { notes: sampleNotesData[0].notes }), /* @__PURE__ */ g("hr", null), /* @__PURE__ */ g("h2", null, "Content Placeholder Inside a Card"), /* @__PURE__ */ g(Card, { className: Components_default.card }, /* @__PURE__ */ g(ContentPlaceholder, null)), /* @__PURE__ */ g("hr", null), /* @__PURE__ */ g("h2", null, "Release Notes Inside a Card"), /* @__PURE__ */ g(Card, { className: Components_default.card }, /* @__PURE__ */ g(ReleaseNotesContent, { title: "May 10 2024", currentVersion: "1.0.1", latestVersion: "1.2.0", notes: sampleNotesData })), /* @__PURE__ */ g(ReleaseNotes, { releaseData: sampleData.loading }), /* @__PURE__ */ g(LoadingThen, null, /* @__PURE__ */ g(ReleaseNotes, { releaseData: sampleData.loaded })), /* @__PURE__ */ g(LoadingThen, null, /* @__PURE__ */ g(ReleaseNotes, { releaseData: sampleData.loadingError })), /* @__PURE__ */ g(LoadingThen, null, /* @__PURE__ */ g(ReleaseNotes, { releaseData: sampleData.updateDownloading })), /* @__PURE__ */ g(LoadingThen, null, /* @__PURE__ */ g(ReleaseNotes, { releaseData: sampleData.updatePreparing })), /* @__PURE__ */ g(LoadingThen, null, /* @__PURE__ */ g(ReleaseNotes, { releaseData: sampleData.updateError })), /* @__PURE__ */ g(LoadingThen, null, /* @__PURE__ */ g(ReleaseNotes, { releaseData: sampleData.updateReady })), /* @__PURE__ */ g(LoadingThen, null, /* @__PURE__ */ g(ReleaseNotes, { releaseData: sampleData.criticalUpdateReady })), /* @__PURE__ */ g(LoadingThen, null, /* @__PURE__ */ g(
      ReleaseNotes,
      {
        releaseData: (
  ...
  function LoadingThen({ children }) {
    ...
    return /* @__PURE__ */ g(ReleaseNotes, { releaseData: sampleData.loading });
  }
  ...
  async function init(messages, baseEnvironment2) {
    ...
    if (environment.display === "app") {
      D(
        /* @__PURE__ */ g(
          ...
          /* @__PURE__ */ g(SettingsProvider, { settings }, /* @__PURE__ */ g(TranslationProvider, { translationObject: strings, fallback: release_notes_default, textLength: environment.textLength }, /* @__PURE__ */ g(MessagingContext.Provider, { value: { messages } }, /* @__PURE__ */ g(App, null))))
        ),
        root
      );
    }
    if (environment.display === "components") {
      D(
        /* @__PURE__ */ g(EnvironmentProvider, { debugState: environment.debugState, injectName: environment.injectName, willThrow: environment.willThrow }, /* @__PURE__ */ g(SettingsProvider, { settings }, /* @__PURE__ */ g(TranslationProvider, { translationObject: strings, fallback: release_notes_default, textLength: environment.textLength }, /* @__PURE__ */ g(MessagingContext.Provider, { value: { messages } }, /* @__PURE__ */ g(Components, null))))),
        root
      );
    }
  }
