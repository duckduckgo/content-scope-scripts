...
(() => {
  ...
  // pages/special-error/src/mock-transport.js
      ...
      request(_msg) {
        ...
        switch (msg.method) {
          case "initialSetup": {
            ...
            const errorId2 = searchParams2.get("errorId");
            const platformName = searchParams2.get("platformName");
            ...
            if (platformName && supportedPlatforms.includes(platformName)) {
              platform = {
                name: (
                  /** @type {import('../types/special-error.js').InitialSetupResponse['platform']['name']} */
                  platformName
                )
              };
            }
  ...
  function L(n2, l3, u3, t3, i3, r3, o3, e3, f3, c3, a3) {
    ...
    for (f3 = T(u3, l3, g2, f3, m3), s3 = 0; s3 < m3; s3++) null != (p3 = u3.__k[s3]) && (h3 = -1 != p3.__i && g2[p3.__i] || d, p3.__i = s3, _2 = q(n2, p3, h3, i3, r3, o3, e3, f3, c3, a3), v3 = p3.__e, p3.ref && h3.ref != p3.ref && (h3.ref && J(h3.ref, null, p3), a3.push(p3.ref, p3.__c || v3, p3)), null == y3 && null != v3 && (y3 = v3), 4 & p3.__u ? (f3 = j(p3, f3, n2), h3.__e && (h3.__e = null)) : "function" == typeof p3.type && void 0 !== _2 ? f3 = _2 : v3 && (f3 = v3.nextSibling), p3.__u &= -7);
    return u3.__e = y3, f3;
  }
  ...
  function q(n2, u3, t3, i3, r3, o3, e3, f3, c3, a3) {
    var s3, h3, p3, v3, y3, d3, _2, k3, x3, M, I2, P2, A3, H2, T3, j3, F = u3.type;
  ...
  function G(u3, t3, i3, r3, o3, e3, f3, c3, a3) {
    ...
    if (null == x3) m3 === k3 || c3 && u3.data == k3 || (u3.data = k3);
      ...
      c3 && "textarea" != x3 || (s3 = "value", "progress" == x3 && null == w3 ? u3.removeAttribute("value") : null != w3 && (w3 !== u3[s3] || "progress" == x3 && !w3 || "option" == x3 && w3 != m3[s3]) && N(u3, s3, w3, m3[s3], o3), s3 = "checked", null != _2 && _2 != u3[s3] && N(u3, s3, _2, m3[s3], o3));
    }
    return u3;
  }
  function J(n2, u3, t3) {
  ...
  function MessagingProvider({ children, messaging: messaging2 }) {
    return /* @__PURE__ */ k(MessagingContext2.Provider, { value: { messaging: messaging2 } }, children);
  }
  ...
  var SpecialErrorContext = X(
    /** @type {import('../specialError.js').SpecialError} */
    {}
  );
  function SpecialErrorProvider({ children, specialError }) {
    return /* @__PURE__ */ k(SpecialErrorContext.Provider, { value: specialError }, children);
  }
  ...
  function Text({ as: Comp = "p", variant, strictSpacing = true, className, children }) {
    return /* @__PURE__ */ k(Comp, { className: (0, import_classnames.default)(Text_default.root, className, { [Text_default[`${variant}`]]: !!variant, [Text_default.strictSpacing]: strictSpacing }) }, children);
  }
  ...
  function useWarningContent() {
    ...
    if (kind === "phishing") {
      ...
      return [/* @__PURE__ */ k(Trans, { str: text, values: { a: helpPageAnchorTagParams } })];
    }
    if (kind === "malware") {
    ...
    if (kind === "ssl") {
      ...
      return [/* @__PURE__ */ k(Trans, { str: t3("sslWarningText", { domain }), values: "" })];
    }
    throw new Error(`Unhandled error kind ${kind}`);
  }
  ...
  function useAdvancedInfoContent() {
    ...
    if (kind === "ssl") {
      ...
      switch (errorType) {
        case "expired":
          return [/* @__PURE__ */ k(Trans, { str: t3("sslExpiredAdvancedInfoText", { domain }), values: "" })];
        case "invalid":
  ...
  function VisitSiteLink({ elemRef }) {
    ...
    return /* @__PURE__ */ k("a", { className: AdvancedInfo_default.visitSite, onClick: () => messaging2?.visitSite(), ref: elemRef }, t3("visitSiteButton"));
  }
  function AdvancedInfoHeading() {
    const heading = useAdvancedInfoHeading();
    if (!heading) return null;
    return /* @__PURE__ */ k("header", { className: AdvancedInfo_default.heading }, /* @__PURE__ */ k(Text, { as: "h2", variant: "body" }, heading));
  }
  function AdvancedInfoContent() {
    const content = useAdvancedInfoContent();
    if (!content.length) return null;
    return /* @__PURE__ */ k("div", { className: AdvancedInfo_default.content }, content.map((text) => /* @__PURE__ */ k(Text, { as: "p", variant: "body" }, text)));
  }
  function AdvancedInfo() {
    const { ref, trigger } = useScrollTarget();
    return /* @__PURE__ */ k("div", { className: AdvancedInfo_default.wrapper }, /* @__PURE__ */ k("div", { className: AdvancedInfo_default.animationContainer, onAnimationEnd: trigger }, /* @__PURE__ */ k("div", { className: AdvancedInfo_default.container }, /* @__PURE__ */ k(AdvancedInfoHeading, null), /* @__PURE__ */ k(AdvancedInfoContent, null), /* @__PURE__ */ k(VisitSiteLink, { elemRef: ref }))));
  }
  ...
  function ErrorFallback() {
    return /* @__PURE__ */ k("h1", null, "Something went wrong");
  }
  ...
  function AdvancedInfoButton({ onClick }) {
    ...
    return /* @__PURE__ */ k(Button, { variant: buttonVariant, className: (0, import_classnames3.default)(Warning_default.button, Warning_default.advanced), onClick }, isMobile ? t3("advancedButton") : t3("advancedEllipsisButton"));
  }
  function LeaveSiteButton() {
    ...
    return /* @__PURE__ */ k(Button, { variant: buttonVariant, className: (0, import_classnames3.default)(Warning_default.button, Warning_default.leaveSite), onClick: () => messaging2?.leaveSite() }, t3("leaveSiteButton"));
  }
  function WarningHeading() {
    ...
    return /* @__PURE__ */ k("header", { className: (0, import_classnames3.default)(Warning_default.heading, Warning_default[kind]) }, /* @__PURE__ */ k("i", { className: Warning_default.icon, "aria-hidden": "true" }), /* @__PURE__ */ k(Text, { as: "h1", variant: textVariant, strictSpacing: isMobile, className: Warning_default.title }, heading));
  }
  function WarningContent() {
    const content = useWarningContent();
    if (!content.length) return null;
    return /* @__PURE__ */ k("div", { className: Warning_default.content }, content.map((text) => /* @__PURE__ */ k(Text, { as: "p", variant: "body" }, text)));
  }
  function Warning({ advancedInfoVisible, advancedButtonHandler }) {
    return /* @__PURE__ */ k("section", { className: Warning_default.container }, /* @__PURE__ */ k(WarningHeading, null), /* @__PURE__ */ k(WarningContent, null), /* @__PURE__ */ k("div", { className: Warning_default.buttonContainer }, !advancedInfoVisible && /* @__PURE__ */ k(AdvancedInfoButton, { onClick: () => advancedButtonHandler() }), /* @__PURE__ */ k(LeaveSiteButton, null)));
  }
  ...
  function SpecialErrorView() {
    ...
    return /* @__PURE__ */ k("div", { className: App_default.container }, /* @__PURE__ */ k(Warning, { advancedInfoVisible, advancedButtonHandler }), advancedInfoVisible && /* @__PURE__ */ k(AdvancedInfo, null));
  }
  function PageTitle() {
    const { kind } = useErrorData();
    const { t: t3 } = useTypedTranslation();
  ...
  function App() {
    ...
    return /* @__PURE__ */ k("main", { className: App_default.main }, /* @__PURE__ */ k(PageTitle, null), /* @__PURE__ */ k(ErrorBoundary, { didCatch: ({ error }) => didCatch(error), fallback: /* @__PURE__ */ k(ErrorFallback, null) }, /* @__PURE__ */ k(SpecialErrorView, null), /* @__PURE__ */ k(WillThrow, null)));
  }
  function WillThrow() {
    const env = useEnv();
    if (env.willThrow) {
  ...
  function Components() {
    ...
    return /* @__PURE__ */ k("div", null, /* @__PURE__ */ k("nav", { className: Components_default.selector }, /* @__PURE__ */ k("fieldset", null, /* @__PURE__ */ k("label", { for: "platform-select" }, "Platform:"), /* @__PURE__ */ k("select", { id: "platform-select", onChange: (e3) => handlePlatformChange(e3.currentTarget?.value) }, Object.entries(platforms).map(([id, name]) => {
      return /* @__PURE__ */ k("option", { value: id, selected: id === platformName }, name);
    }))), /* @__PURE__ */ k("fieldset", null, /* @__PURE__ */ k("label", { for: "error-select" }, "Error Type:"), /* @__PURE__ */ k("select", { id: "error-select", onChange: (e3) => handleErrorTypeChange(e3.currentTarget?.value) }, Object.entries(sampleData).map(([id, data]) => {
      return /* @__PURE__ */ k("option", { value: id, selected: id === idForError(errorData) }, data.name);
    })))), /* @__PURE__ */ k("main", { class: Components_default.main, "data-platform-name": platformName, "data-theme": isDarkMode ? "dark" : "light" }, /* @__PURE__ */ k("h1", null, "Special Error Components"), /* @__PURE__ */ k("section", null, /* @__PURE__ */ k("h2", null, "Warning Heading"), /* @__PURE__ */ k("div", null, /* @__PURE__ */ k(WarningHeading, null))), /* @__PURE__ */ k("section", null, /* @__PURE__ */ k("h2", null, "Warning Content"), /* @__PURE__ */ k("div", null, /* @__PURE__ */ k(WarningContent, null))), /* @__PURE__ */ k("section", null, /* @__PURE__ */ k("h2", null, "Advanced Info Heading"), /* @__PURE__ */ k("div", null, /* @__PURE__ */ k(AdvancedInfoHeading, null))), /* @__PURE__ */ k("section", null, /* @__PURE__ */ k("h2", null, "Advanced Info Content"), /* @__PURE__ */ k("div", null, /* @__PURE__ */ k(AdvancedInfoContent, null))), /* @__PURE__ */ k("section", null, /* @__PURE__ */ k("h2", null, "Leave Site Button"), /* @__PURE__ */ k("div", null, /* @__PURE__ */ k(LeaveSiteButton, null))), /* @__PURE__ */ k("section", null, /* @__PURE__ */ k("h2", null, "Advanced Info Button"), /* @__PURE__ */ k("div", null, /* @__PURE__ */ k(AdvancedInfoButton, { onClick: () => {
    } }))), /* @__PURE__ */ k("section", null, /* @__PURE__ */ k("h2", null, "Visit Site Link"), /* @__PURE__ */ k("div", null, /* @__PURE__ */ k(VisitSiteLink, null))), /* @__PURE__ */ k("section", null, /* @__PURE__ */ k("h2", null, "Warning"), /* @__PURE__ */ k("div", null, /* @__PURE__ */ k(Warning, { advancedInfoVisible: false, advancedButtonHandler: () => {
    } }))), /* @__PURE__ */ k("section", null, /* @__PURE__ */ k("h2", null, "Advanced Info"), /* @__PURE__ */ k("div", null, /* @__PURE__ */ k(AdvancedInfo, null))), /* @__PURE__ */ k("section", null, /* @__PURE__ */ k("h2", null, "Special Error View"), /* @__PURE__ */ k("div", null, /* @__PURE__ */ k(SpecialErrorView, null)))));
  }
  ...
  async function init(messaging2, baseEnvironment2) {
    ...
    if (environment.display === "app") {
      R(
        /* @__PURE__ */ k(EnvironmentProvider, { debugState: environment.debugState, injectName: environment.injectName, willThrow: environment.willThrow }, /* @__PURE__ */ k(UpdateEnvironment, { search: window.location.search }), /* @__PURE__ */ k(TranslationProvider, { translationObject: strings, fallback: special_error_default, textLength: environment.textLength }, /* @__PURE__ */ k(MessagingProvider, { messaging: messaging2 }, /* @__PURE__ */ k(ThemeProvider, { initialTheme: init2.theme, initialThemeVariant: init2.themeVariant }, /* @__PURE__ */ k(SettingsProvider, { settings }, /* @__PURE__ */ k(SpecialErrorProvider, { specialError }, /* @__PURE__ */ k(App, null))))))),
        root
      );
    } else if (environment.display === "components") {
      R(
        /* @__PURE__ */ k(EnvironmentProvider, { debugState: false, injectName: environment.injectName }, /* @__PURE__ */ k(TranslationProvider, { translationObject: strings, fallback: special_error_default, textLength: environment.textLength }, /* @__PURE__ */ k(ThemeProvider, { initialTheme: init2.theme, initialThemeVariant: init2.themeVariant }, /* @__PURE__ */ k(SettingsProvider, { settings }, /* @__PURE__ */ k(SpecialErrorProvider, { specialError }, /* @__PURE__ */ k(Components, null)))))),
        root
      );
    }
  }
