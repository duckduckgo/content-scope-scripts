...
(() => {
  ...
  // pages/release-notes/app/components/EasterEgg.module.css
  var EasterEgg_default = {
    container: "EasterEgg_container",
    overlay: "EasterEgg_overlay",
    iframe: "EasterEgg_iframe"
  };

  // pages/release-notes/app/components/EasterEgg.js
  function Overlay({ onClick }) {
    return /* @__PURE__ */ y("div", { className: EasterEgg_default.overlay, onClick }, /* @__PURE__ */ y("h1", null, "Want to help us squash bugs?"), /* @__PURE__ */ y("p", null, "Click to start"));
  }
  function EasterEgg() {
    const [started, setStarted] = h2(false);
    const ref = _(null);
    const clickHandler = () => {
      setStarted(true);
    };
    ...
    return /* @__PURE__ */ y("div", { className: EasterEgg_default.container }, started ? /* @__PURE__ */ y("iframe", { src: "game/index.html", className: EasterEgg_default.iframe, ref, onLoad: loadHandler }) : /* @__PURE__ */ y(Overlay, { onClick: clickHandler }));
  }
  ...
  function ReleaseNotes({ releaseData }) {
    ...
    ), status === "loaded" && /* @__PURE__ */ y(EasterEgg, null)));
  }
  ...
  function Components() {
    ...
    return /* @__PURE__ */ y("main", { className: Components_default.main }, /* @__PURE__ */ y(LoadingThen, null, /* @__PURE__ */ y(ReleaseNotes, { releaseData: sampleData.loaded })));
  }
