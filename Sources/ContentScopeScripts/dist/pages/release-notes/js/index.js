...
(() => {
  ...
  function $(n2, l3, u3, t3, i3, r3, o3, e3, f3, c3, s3) {
    ...
    for (f3 = I(u3, l3, g2, f3), a3 = 0; a3 < m3; a3++) null != (y3 = u3.__k[a3]) && (h3 = -1 === y3.__i ? p : g2[y3.__i] || p, y3.__i = a3, _2 = j(n2, y3, h3, i3, r3, o3, e3, f3, c3, s3), d3 = y3.__e, y3.ref && h3.ref != y3.ref && (h3.ref && V(h3.ref, null, y3), s3.push(y3.ref, y3.__c || d3, y3)), null == w3 && null != d3 && (w3 = d3), 4 & y3.__u || h3.__k === y3.__k ? f3 = H(y3, f3, n2) : "function" == typeof y3.type && void 0 !== _2 ? f3 = _2 : d3 && (f3 = d3.nextSibling), y3.__u &= -7);
    return u3.__e = w3, f3;
  }
  ...
  function j(n2, u3, t3, i3, r3, o3, e3, f3, c3, s3) {
    var a3, h3, p3, v3, y3, g2, m3, b, C3, S2, M2, P2, I2, H2, L, T2, A3, F2 = u3.type;
    ...
    n: if ("function" == typeof F2) try {
      ...
      h3.state = h3.__s, null != h3.getChildContext && (i3 = w(w({}, i3), h3.getChildContext())), C3 && !p3 && null != h3.getSnapshotBeforeUpdate && (g2 = h3.getSnapshotBeforeUpdate(v3, y3)), f3 = $(n2, d(T2 = null != a3 && a3.type === k && null == a3.key ? a3.props.children : a3) ? T2 : [T2], u3, t3, i3, r3, o3, e3, f3, c3, s3), h3.base = u3.__e, u3.__u &= -161, h3.__h.length && e3.push(h3), m3 && (h3.__E = h3.__ = null);
    } catch (n3) {
  ...
  function Text({ as: Comp = "p", variant, strictSpacing = true, className, children }) {
    return /* @__PURE__ */ g(Comp, { className: (0, import_classnames2.default)({ [Text_default[`${variant}`]]: variant, [Text_default.strictSpacing]: strictSpacing }, className) }, children);
  }
  ...
  function UpdateButton({ releaseData }) {
    ...
    if (status === "updateError") {
      button = /* @__PURE__ */ g(Button, { onClick: () => messages?.retryUpdate() }, t3("retryUpdate"));
    }
    if (status === "updateReady" || status === "criticalUpdateReady") {
      ...
      button = /* @__PURE__ */ g(Button, { onClick: () => messages?.browserRestart() }, buttonText);
    }
  ...
  async function init(messages, baseEnvironment2) {
    ...
    if (environment.display === "app") {
      D(
        /* @__PURE__ */ g(EnvironmentProvider, { debugState: environment.debugState, injectName: environment.injectName, willThrow: environment.willThrow }, /* @__PURE__ */ g(TranslationProvider, { translationObject: strings, fallback: release_notes_default, textLength: environment.textLength }, /* @__PURE__ */ g(MessagingContext.Provider, { value: { messages } }, /* @__PURE__ */ g(App, null)))),
        root
      );
    }
    if (environment.display === "components") {
      D(
        /* @__PURE__ */ g(EnvironmentProvider, { debugState: environment.debugState, injectName: environment.injectName, willThrow: environment.willThrow }, /* @__PURE__ */ g(TranslationProvider, { translationObject: strings, fallback: release_notes_default, textLength: environment.textLength }, /* @__PURE__ */ g(MessagingContext.Provider, { value: { messages } }, /* @__PURE__ */ g(Components, null)))),
        root
      );
    }
  }
