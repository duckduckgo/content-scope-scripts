...
(() => {
  ...
  function O(n2, t3, u3, i3, r3, o3, e3, f3, c3, s3) {
    var a3, h3, p3, v3, y3, _3, m3, b, S2, C3, M2, $2, P2, A3, H, L2, T3, j3 = t3.type;
  ...
  function V(t3, u3, i3, r3, o3, e3, f3, c3, s3) {
    ...
    if (null === x3) b === k3 || c3 && t3.data === k3 || (t3.data = k3);
      ...
      for (a3 in k3) w3 = k3[a3], "children" == a3 ? y3 = w3 : "dangerouslySetInnerHTML" == a3 ? h3 = w3 : "value" == a3 ? _3 = w3 : "checked" == a3 ? m3 = w3 : c3 && "function" != typeof w3 || b[a3] === w3 || j(t3, a3, w3, b[a3], o3);
      ...
      c3 || (a3 = "value", "progress" == x3 && null == _3 ? t3.removeAttribute("value") : void 0 !== _3 && (_3 !== t3[a3] || "progress" == x3 && !_3 || "option" == x3 && _3 !== b[a3]) && j(t3, a3, _3, b[a3], o3), a3 = "checked", void 0 !== m3 && m3 !== t3[a3] && j(t3, a3, m3, b[a3], o3));
    }
    return t3;
  }
  function q(n2, t3, u3) {
