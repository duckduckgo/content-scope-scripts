...
(() => {
  ...
  // pages/duckplayer/app/components/PlaybackControl.jsx
  var EVENT_PLAY = "ddg-duckplayer-play";
  var EVENT_PAUSE = "ddg-duckplayer-pause";
  ...
  // pages/duckplayer/app/features/playback-events.js
  var PlaybackEvents = class {
    /**
     * @param {HTMLIFrameElement} iframe
     */
    iframeDidLoad(iframe) {
      const document2 = iframe.contentWindow?.document;
      const playHandler = () => document2?.querySelector("video")?.play();
      window.addEventListener(EVENT_PLAY, playHandler);
      const pauseHandler = () => document2?.querySelector("video")?.pause();
