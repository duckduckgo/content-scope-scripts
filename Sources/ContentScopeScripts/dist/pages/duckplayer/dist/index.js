...
(() => {
  ...
  var duckplayer_default = {
    ...
    noEmbedErrorMessage1: {
      title: "The creator of this video has chosen not to allow it to be viewed outside of YouTube.",
      note: "Explanation on why the error is happening."
    },
    noEmbedErrorMessage2: {
      title: "You can still watch it on YouTube, but without the added privacy of Duck Player.",
      note: "A message explaining that the blocked video can be watched directly on YouTube."
    },
    signInRequiredErrorHeading: {
      title: "Sorry, but YouTube thinks you\u2019re a bot!",
      note: "Message shown when YouTube has blocked playback of a video"
    },
    signInRequiredErrorMessage1: {
      title: "This sometimes happens when you\u2019re using a VPN. If that\u2019s the case, try turning it off and reloading this page.",
      note: "Explanation on why the error is happening and a suggestions on how to solve it."
    },
    signInRequiredErrorMessage2: {
      title: "No luck? You can still watch this video, but you\u2019ll have to sign in and watch it on YouTube without the added privacy of Duck Player.",
  ...
  function useErrorStrings(kind) {
    ...
    switch (kind) {
      case "sign-in-required":
        return {
          heading: t3("signInRequiredErrorHeading"),
          messages: [t3("signInRequiredErrorMessage1"), t3("signInRequiredErrorMessage2")],
          variant: "paragraphs"
        };
      case "age-restricted":
        return {
          heading: t3("ageRestrictedErrorHeading"),
          messages: [t3("ageRestrictedErrorMessage1"), t3("ageRestrictedErrorMessage2")],
          variant: "paragraphs"
        };
      case "no-embed":
        return {
          heading: t3("noEmbedErrorHeading"),
          messages: [t3("noEmbedErrorMessage1"), t3("noEmbedErrorMessage2")],
          variant: "paragraphs"
        };
      case "unknown":
      default:
        return {
          heading: t3("unknownErrorHeading"),
          messages: [t3("unknownErrorMessage1"), t3("unknownErrorMessage2")],
          variant: "paragraphs"
        };
    }
  }
  function YouTubeError({ kind, layout, embed }) {
    const { t: t3 } = useTypedTranslation();
    const openOnYoutube = useOpenOnYoutubeHandler();
