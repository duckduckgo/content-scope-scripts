...
(() => {
  ...
  function j(n2, u3, t3, i3, r3, o3, e3, f3, c3, s3) {
    var a3, h3, p3, v3, y3, g2, m3, b, C3, S2, M2, P2, I2, H2, L, T3, A3, F2 = u3.type;
  ...
  function useWarningContent() {
    ...
    const { kind } = useErrorData();
    if (kind === "phishing") {
      return [/* @__PURE__ */ g(Trans, { str: t3("phishingWarningText"), values: { a: phishingAnchorTagValues } })];
    }
    if (kind === "ssl") {
      const { domain } = (
        /** @type {SSLError}} */
  ...
  function useAdvancedInfoContent() {
    ...
    if (kind === "phishing") {
      return [t3("phishingAdvancedInfoText_1"), /* @__PURE__ */ g(Trans, { str: t3("phishingAdvancedInfoText_2"), values: { a: phishingAnchorTagValues } })];
    }
    if (kind === "ssl") {
