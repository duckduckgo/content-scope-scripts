...
(() => {
  ...
  // pages/special-error/app/providers/ErrorDataProvider.js
  var ErrorDataContext = F({
  ...
  function ErrorDataProvider({ children, platformName: initialPlatformName, errorData: initialErrorData }) {
    const [platformName, setPlatformName] = h2(initialPlatformName);
    const [errorData, setErrorData] = h2(initialErrorData);
    const updatePlatformName = (value) => {
      setPlatformName(value);
    };
    const updateErrorData = (value) => setErrorData(value);
    return /* @__PURE__ */ y(ErrorDataContext.Provider, { value: { platformName, updatePlatformName, errorData, updateErrorData } }, children);
  }
  function useErrorData() {
    const { errorData, updateErrorData } = q2(ErrorDataContext);
    return { errorData, updateErrorData };
  }
  function usePlatformName() {
    const context = q2(ErrorDataContext);
  ...
  // pages/special-error/app/providers/UIProvider.js
  var UIContext = F({
  ...
  function UIProvider({ children }) {
    const [showAdvancedInfo, setShowAdvancedInfo] = h2(false);
    const advancedButtonHandler = () => setShowAdvancedInfo((value) => !value);
    return /* @__PURE__ */ y(UIContext.Provider, { value: { showAdvancedInfo, advancedButtonHandler } }, children);
  }
  function useAdvancedInfo() {
    const { showAdvancedInfo, advancedButtonHandler } = q2(UIContext);
  ...
  // shared/components/Text/Text.js
  function Text({ as: Comp = "p", variant, className, children, onClick }) {
    return /* @__PURE__ */ y(
      Comp,
      {
        className: (0, import_classnames.default)({ [Text_default[`${variant}`]]: variant }, className),
        onClick: (
          /**
  ...
  function WarningHeading() {
    ...
    return /* @__PURE__ */ y("header", { className: Warning_default.heading }, /* @__PURE__ */ y("i", { className: (0, import_classnames3.default)(Warning_default.icon, Warning_default[kind]), "aria-hidden": "true" }), /* @__PURE__ */ y(Text, { as: "h1", variant: "title-2" }, heading));
  }
  ...
  function Warning() {
    return /* @__PURE__ */ y("section", { className: Warning_default.container }, /* @__PURE__ */ y(WarningHeading, null), /* @__PURE__ */ y(WarningContent, null), /* @__PURE__ */ y("div", { className: Warning_default.buttonContainer }, /* @__PURE__ */ y(AdvancedInfoButton, null), /* @__PURE__ */ y(LeaveSiteButton, null)));
  }
  ...
  function VisitSiteLink() {
    const { messaging: messaging2 } = useMessaging();
    const { t: t3 } = useTypedTranslation();
    return /* @__PURE__ */ y(Text, { as: "a", variant: "body", className: AdvancedInfo_default.visitSite, onClick: () => messaging2?.visitSite() }, t3("visitSiteButton"));
  }
  ...
  function AdvancedInfo() {
    return /* @__PURE__ */ y("div", { className: AdvancedInfo_default.container }, /* @__PURE__ */ y(AdvancedInfoHeading, null), /* @__PURE__ */ y(AdvancedInfoContent, null), /* @__PURE__ */ y(VisitSiteLink, null));
  }
  ...
  function SpecialError() {
    ...
    return /* @__PURE__ */ y("div", { className: App_default.container }, /* @__PURE__ */ y(Warning, null), showAdvancedInfo && /* @__PURE__ */ y(AdvancedInfo, null));
  }
  function App() {
    const { messaging: messaging2 } = useMessaging();
    const { platformName } = usePlatformName();
    ...
    return /* @__PURE__ */ y("main", { className: App_default.main, "data-platform-name": platformName }, /* @__PURE__ */ y(ErrorBoundary, { didCatch, fallback: /* @__PURE__ */ y(ErrorFallback, null) }, /* @__PURE__ */ y(SpecialError, null), /* @__PURE__ */ y(WillThrow, null)));
  }
  function WillThrow() {
    const env = useEnv();
    if (env.willThrow) {
  ...
  async function init(messaging2, baseEnvironment2) {
    ...
    const { errorData, platform } = init2;
    ...
    const strings = environment.locale === "en" ? special_error_default : await fetch(`./locales/${environment.locale}/special-error.json`).then((resp) => {
      if (!resp.ok) {
    ...
    if (environment.display === "app") {
      q(
        /* @__PURE__ */ y(
          ...
          /* @__PURE__ */ y(TranslationProvider, { translationObject: strings, fallback: special_error_default, textLength: environment.textLength }, /* @__PURE__ */ y(MessagingProvider, { messaging: messaging2 }, /* @__PURE__ */ y(ErrorDataProvider, { errorData, platformName: platform.name }, /* @__PURE__ */ y(UIProvider, null, /* @__PURE__ */ y(App, null)))))
        ),
        root
      );
    } else if (environment.display === "components") {
      q(
        /* @__PURE__ */ y(EnvironmentProvider, { debugState: false, platform: environment.platform }, /* @__PURE__ */ y(TranslationProvider, { translationObject: strings, fallback: special_error_default, textLength: environment.textLength }, /* @__PURE__ */ y(ErrorDataProvider, { errorData, platformName: "macos" }, /* @__PURE__ */ y(UIProvider, null, /* @__PURE__ */ y(Components, null))))),
        root
      );
    }
  }
  ...
  var specialErrorPage = baseEnvironment.platform === "integration" ? new IntegrationSpecialErrorPage(messaging, baseEnvironment.platform) : new SpecialErrorPage(messaging, baseEnvironment.platform);
