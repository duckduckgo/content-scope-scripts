...
(() => {
  ...
  // pages/new-tab/app/next-steps/NextSteps.module.css
  ...
  var init_NextSteps = __esm({
    "pages/new-tab/app/next-steps/NextSteps.module.css"() {
      NextSteps_default = {
        ...
        nextStepsCardGroup: "NextSteps_nextStepsCardGroup",
        nextStepsCardGrid: "NextSteps_nextStepsCardGrid",
        nextStepsBubble: "NextSteps_nextStepsBubble"
      };
    }
  });

  // pages/new-tab/app/next-steps/nextsteps.data2.js
  var variants;
  var init_nextsteps_data2 = __esm({
    "pages/new-tab/app/next-steps/nextsteps.data2.js"() {
      "use strict";
      variants = {
        // /**
        ...
        addAppDockMac: (t3) => ({
          ...
          confirmationText: t3("nextSteps_addAppDockMac_actionText")
        }),
        pinAppToTaskbarWindows: (t3) => ({
          ...
          confirmationText: t3("nextSteps_pinAppToTaskbarWindows_actionText")
          // this is only available >= Windows 11 users
        })
      };
    }
  });

  // pages/new-tab/app/next-steps/NextStepsCard.js
  function NextStepsCard({ type, dismiss, action }) {
    const { t: t3 } = useTypedTranslation();
    const message = variants[type]?.(t3);
    console.log({ message });
    return /* @__PURE__ */ _("div", { class: NextSteps_default.root }, /* @__PURE__ */ _("img", { src: `./icons/${message.icon}-128.svg`, alt: "", class: NextSteps_default.icon }), /* @__PURE__ */ _("p", { class: NextSteps_default.title }, message.title), /* @__PURE__ */ _("p", { class: NextSteps_default.description }, message.summary), /* @__PURE__ */ _("button", { class: NextSteps_default.btn, onClick: () => action(message.id) }, message.actionText), /* @__PURE__ */ _("button", { class: (0, import_classnames2.default)(NextSteps_default.btn, NextSteps_default.dismissBtn), onClick: () => dismiss(message.id), "aria-label": "Close" }, /* @__PURE__ */ _(Cross, null)));
  }
  ...
  var init_NextStepsCard = __esm({
    "pages/new-tab/app/next-steps/NextStepsCard.js"() {
      ...
      init_NextSteps();
      init_Icons2();
      init_nextsteps_data2();
      init_types();
    }
  });

  // pages/new-tab/app/next-steps/NextStepsGroup.js
  function NextStepsCardGroup({ types, expansion, toggle, action, dismiss, animation = "none" }) {
    const shownCards = expansion === "expanded" ? types : types.slice(0, 2);
    console.log({ types, shownCards });
    return /* @__PURE__ */ _("div", { class: (0, import_classnames3.default)(NextSteps_default.nextStepsCardGroup) }, /* @__PURE__ */ _(NextStepsBubbleHeader, null), /* @__PURE__ */ _("div", { class: NextSteps_default.nextStepsCardGrid }, shownCards.map((type) => /* @__PURE__ */ _(NextStepsCard, { key: type, type, dismiss, action }))), types.length > 2 && /* @__PURE__ */ _("button", null, expansion === "expanded" ? "Show Less" : "Show More"));
  }
  function NextStepsBubbleHeader() {
    return /* @__PURE__ */ _("div", { class: (0, import_classnames3.default)(NextSteps_default.nextStepsBubble) }, /* @__PURE__ */ _("svg", { xmlns: "http://www.w3.org/2000/svg", width: "12", height: "26", viewBox: "0 0 12 26", fill: "none" }, /* @__PURE__ */ _(
      "path",
      {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
    ...
    )), /* @__PURE__ */ _("p", null, "Next Steps"), /* @__PURE__ */ _("svg", { xmlns: "http://www.w3.org/2000/svg", width: "10", height: "20", viewBox: "0 0 10 20", fill: "none" }, /* @__PURE__ */ _(
      "path",
      {
  ...
  var mainExamples = {
    ...
    "next-steps.addToDockWindows": {
      factory: () => /* @__PURE__ */ _(NextStepsCard, { type: "pinAppToTaskbar", dismiss: noop("dismiss"), action: noop("action") })
    },
    "next-steps.bubble": {
