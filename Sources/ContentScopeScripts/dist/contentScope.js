(() => {
  ...
  (function() {
    "use strict";
    var _bundledConfig, _args, _messaging, _isDebugFlagSet, _importConfig, _activeShareRequest, _activeScreenLockRequest;
    ...
    async function init(args) {
      ...
      features.forEach(({ featureInstance: featureInstance2, featureName }) => {
