  ...
  (function() {
    ...
    class ContentFeature {
      constructor(featureName) {
        ...
        __privateAdd(this, _messagingContext, void 0);
        /** @type {import('../packages/messaging').Messaging} */
        __privateAdd(this, _debugMessaging, void 0);
        /** @type {boolean} */
      ...
      get messagingContext() {
        if (__privateGet(this, _messagingContext))
          return __privateGet(this, _messagingContext);
        const contextName = "contentScopeScripts";
        __privateSet(this, _messagingContext, new MessagingContext({
          context: contextName,
      ...
      get debugMessaging() {
        if (__privateGet(this, _debugMessaging))
          return __privateGet(this, _debugMessaging);
        if (this.platform?.name === "extension" && true) {
          __privateSet(this, _debugMessaging, createMessaging({ name: "debug", isDebug: this.isDebug }, "apple"));
          return __privateGet(this, _debugMessaging);
        } else {
          return null;
        }
