...
(function () {
    ...
    const Symbol$1 = globalThis.Symbol;
    ...
    const ddgShimMark = Symbol('ddgShimMark');
    ...
    class ContentFeature extends ConfigFeature {
        /** @type {import('./utils.js').RemoteConfig | undefined} */
     ...
     * @return {HTMLElement | null}
     */
    function getElementByName(doc = document, name) {
     ...
     * @returns {string|null} - The parameter value or null
     */
    function getUrlHashParameter(url, param) {
        if (!url || false) {
            return null;
        }
     ...
     */
    function injectTokenIntoElement({ root, elementName, token }) {
     ...
     */
    function getCaptchaProvider(captchaDiv, captchaType) {
     ...
     * @param {string} captchaType
     */
    function getCaptchaSolveProvider(root, captchaType) {
        const captchaProvider = captchaFactory.getProviderByType(captchaType);
        if (!captchaProvider) {
     ...
     * @return {import('../types.js').ActionResponse}
     */
    function getCaptchaInfo$1(action, root = document) {
     ...
     * @return {import('../types.js').ActionResponse}
     */
    function solveCaptcha$1(action, token, root = document) {
    ...
    var deprecatedCaptchaHandlers = /*#__PURE__*/Object.freeze({
        __proto__: null,
        getCaptchaInfo: getCaptchaInfo$1,
        solveCaptcha: solveCaptcha$1
    });
    ...
    function getCaptchaInfo(action, root = document) {
        ...
        if (!captchaType) {
            // ensures backward compatibility with old actions
            return getCaptchaInfo$1(action, root);
        }
    ...
    function solveCaptcha(action, token, root = document) {
        ...
        if (!captchaType) {
            // ensures backward compatibility with old actions
            return solveCaptcha$1(action, token, root);
        }
    ...
    var captchaHandlers = /*#__PURE__*/Object.freeze({
        __proto__: null,
     ...
     */
    function resolveActionHandlers({ useWebViewActionsV2 }) {
        return {
            extract,
            fillForm,
            click,
     ...
     * @param {boolean} [options.useWebViewActionsV2] - optional flag to use new action handlers
     * @return {Promise<import('./types.js').ActionResponse>}
     */
    async function execute(action, inputData, root = document, options = {}) {
        try {
            const { useWebViewActionsV2 = false } = options;
