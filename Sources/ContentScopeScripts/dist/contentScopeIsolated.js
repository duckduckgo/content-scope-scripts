...
(function () {
    ...
    var arrow = "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"18\" height=\"35\" viewBox=\"0 0 18 35\" fill=\"none\">\n    <path d=\"M16.2203 27.9795C12.9204 25.2907 5.68283 18.979 0.384148 11.3598C-0.837923 9.60255 1.06753 7.52233 3.12657 8.10019C11.5322 10.4592 15.5862 7.52235 17.1627 5.76432C17.7842 5.07129 17.99 4.14006 17.99 3.20859L18 2.75V32L17.99 31.6366C17.99 30.2137 17.3224 28.8776 16.2203 27.9795Z\"\n          fill=\"currentColor\" />\n</svg>\n";
    ...
    class DDGVideoOverlay extends HTMLElement {
        ...
        constructor ({ environment, params, ui, manager, layout = 'desktop' }) {
             ...
             */
            const style = document.createElement('style');
            style.innerText = this.layout === 'desktop' ? css$2 : mobilecss;
