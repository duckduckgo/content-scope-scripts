...
`;
  ...
  // src/features/web-detection.js
  var _detectors, _matchedDetectors, _timers;
  var WebDetection = class extends ContentFeature {
    ...
    _scheduleAutoRunDetectors() {
      ...
      for (const [interval, detectors] of detectorsByInterval.entries()) {
        ...
        __privateGet(this, _timers).push(timerId);
      }
    }
    /**
    ...
    urlChanged() {
      this._clearTimers();
      __privateGet(this, _matchedDetectors).clear();
      this._scheduleAutoRunDetectors();
    }
    /**
     ...
     */
    _clearTimers() {
      for (const timerId of __privateGet(this, _timers)) {
        clearTimeout(timerId);
      }
      __privateSet(this, _timers, []);
    }
    /**
