...
`;
  ...
  var DuckPlayerNativeMessages = class {
    ...
    subscribeToMediaControl(callback) {
      return this.messaging.subscribe(MSG_NAME_MEDIA_CONTROL, (value) => callback(
    ...
    subscribeToMuteAudio(callback) {
      return this.messaging.subscribe(MSG_NAME_MUTE_AUDIO, (value) => callback(
        /** @type {MuteSettings} */
        value
      ));
    }
    ...
    subscribeToURLChange(callback) {
      return this.messaging.subscribe(MSG_NAME_URL_CHANGE, (value) => callback(
        /** @type {UrlChangeSettings} */
        value
      ));
    }
    /**
