...
(() => {
  ...
  function getInitArgs(processedConfig) {
    const {
      platform,
      site,
      bundledConfig,
  ...
  var ConfigFeature = class {
    ...
    matchConditionalFeatureSetting(featureKeyName) {
      ...
      return conditionalChanges.filter((rule) => {
        ...
        if (condition2 === void 0 && "domain" in rule && rule.domain !== void 0) {
          condition2 = this._domainToConditonBlocks(rule.domain);
        }
        if (condition2 === void 0) return !("domain" in rule);
  ...
  function createPolicy() {
    const tt = (
      /** @type {{trustedTypes?: TrustedTypePolicyFactory}} */
