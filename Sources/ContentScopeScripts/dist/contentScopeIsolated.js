...
`;
  ...
  var _detectors, _detectorsDetailed, _combinedTotalMs, _emitted, _singleRunThresholdsMs, _totalPerPageThresholdsMs, _combinedThresholdsMs, _detectorOverrides, _severeCount, _maxSeverePerPage, _severeDebugLog;
  var DetectorPerf = class extends ContentFeature {
    ...
    _checkSevere(name, durationMs, stats, attributed, thresholds) {
      ...
      const combinedEdge = __privateGet(this, _combinedThresholdsMs)[__privateGet(this, _combinedThresholdsMs).length - 1];
      if (singleEdge !== void 0 && durationMs > singleEdge) {
        this._emitSevere("single", attributed, singleEdge);
      }
      if (totalEdge !== void 0 && stats.totalMs > totalEdge) {
        this._emitSevere("total", name, totalEdge);
      }
      if (combinedEdge !== void 0 && __privateGet(this, _combinedTotalMs) > combinedEdge) {
     ...
     */
    async _dispatch(type, data2) {
      try {
        if (data2 === void 0) {
          await this.callFeatureMethod("webEvents", "fireEvent", { type });
        } else {
          await this.callFeatureMethod("webEvents", "fireEvent", { type, data: data2 });
        }
      } catch {
      }
    }
  ...
  // src/features/web-detection.js
  var _detectors2, _matchedDetectors;
