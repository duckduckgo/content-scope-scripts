...
(function () {
     ...
     * @type {FeatureName[]}
     */
    const featuresExemptFromProtectionToggle = [];
     ...
     */
    function load(args, featuresToLoad) {
    ...
    function initCode() {
        ...
        // prettier-ignore
        const featuresToLoad = isGloballyDisabled(processedConfig)
            ? featuresExemptFromProtectionToggle
            : processedConfig.site.enabledFeatures;
