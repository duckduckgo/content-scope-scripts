...
`;
  ...
  function captchaCallback(args) {
    ...
    function findRecaptchaClients(target) {
      ...
      const cfg = (
        /** @type {{ clients?: Record<string, Record<string, unknown>> }} */
        target.___grecaptcha_cfg
      );
      return Object.entries(cfg.clients || {}).map(([cid, client]) => {
        ...
        objects.forEach(([toplevelKey, toplevel]) => {
          ...
          if (found) {
            ...
            const sublevelObj = (
              /** @type {{ sitekey?: string; [key: string]: unknown }} */
              sublevel
            );
            data2.sitekey = sublevelObj.sitekey;
            ...
            if (!callback || typeof callback !== "function") {
              ...
              data2.function = /** @type {(token: string) => void} */
              callback;
