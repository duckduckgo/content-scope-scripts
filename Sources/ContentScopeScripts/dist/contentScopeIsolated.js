...
`;
  ...
  // src/features/web-events/experiments.js
  init_define_import_meta_trackerLookup();
  function buildExperimentsParameter(assignments, matchExperiments) {
    let regex = null;
    if (matchExperiments) {
      try {
  ...
  var WebEvents = class extends ContentFeature {
    constructor() {
      super(...arguments);
      __publicField(this, "_exposedMethods", this._declareExposedMethods(["fireEvent", "getExperiments"]));
    }
    init() {
    }
    /**
