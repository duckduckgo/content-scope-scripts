...
`;
  ...
  // src/features/broker-protection/actions/resolve-url-from-data-source.js
  init_define_import_meta_trackerLookup();
  var isValidUrl = (value) => {
    try {
      const _2 = new URL(value);
      return true;
    } catch (e) {
      return false;
    }
  };
  var canNavigateToUrl = (value) => {
    try {
  ...
  var resolveUrlFromDataSource = (action, userData) => {
