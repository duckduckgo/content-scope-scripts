...
const config = {
    ...
    entryPoints: [
        ...
        'injected/src/features/broker-protection/metrics-reporting/pir-metrics-reporting.js',
        'injected/src/features/broker-protection/metrics-reporting/types.d.ts',
