...
| `promoSelectors`         | CSS selector strings for Chrome promo banners to hide. Plain strings, not entries: promo hiding is CSS-only, so xpath is not representable here.                                                                                        |
