...
describe('Helpers checks', () => {
    ...
    it('applies local featureOverrides when debug is true', () => {
        const configIn = {
            features: {
                testFeature: {
                    state: 'enabled',
        ...
        expect(processedConfig.featureSettings).toEqual({ testFeature: {}, previewFeature: { overridden: true } });
    });

    it('ignores local featureOverrides when debug/internal are false', () => {
        const configIn = {
            features: {
                testFeature: {
                    state: 'enabled',
