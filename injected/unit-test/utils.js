...
describe('Helpers checks', () => {
    ...
    it('processes config in expected way for maxSupportedVersion and numeric versions', () => {
        const configIn = {
            features: {
                testFeature: {
                    state: 'enabled',
        ...
        expect(processedConfig).toEqual({
            site: {
                ...
                enabledFeatures: ['testFeature', 'testFeatureHigh', 'testFeatureHigher'],
            },
            featureSettings: {
                testFeature: {
                    beep: 'boop',
    ...
    it('processes config in expected way for maxSupportedVersion and string versions', () => {
        const configIn = {
            features: {
                testFeature: {
                    state: 'enabled',
                ...
                testFeatureTooLow: {
                    state: 'enabled',
                    maxSupportedVersion: '0.9.8',
                    settings: {},
                    exceptions: [],
                },
                testFeatureHigh: {
                    state: 'enabled',
                    maxSupportedVersion: '0.9.9',
                    settings: {},
                    exceptions: [],
                },
                testFeatureHigher: {
