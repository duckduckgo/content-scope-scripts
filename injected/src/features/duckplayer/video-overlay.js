...
export class VideoOverlay {
    ...
    appendMobileOverlay(targetElement, params) {
        ...
        this.sideEffects.add(`appending ${DDGVideoOverlayMobile.CUSTOM_TAG_NAME} to the page`, () => {
            ...
            elem.addEventListener(DDGVideoOverlayMobile.OPT_OUT, /** @type {EventListener} */ ((/** @type {CustomEvent<{remember: boolean}>} */ e) => {
                return this.mobileOptOut(e.detail.remember).catch(console.error);
            }));
            elem.addEventListener(DDGVideoOverlayMobile.OPT_IN, /** @type {EventListener} */ ((/** @type {CustomEvent<{remember: boolean}>} */ e) => {
    ...
    appendMobileDrawer(targetElement, drawerTargetElement, params) {
        ...
        this.sideEffects.add(
            ...
            () => {
                ...
                drawer.addEventListener(DDGVideoDrawerMobile.OPT_OUT, /** @type {EventListener} */ ((/** @type {CustomEvent<{remember: boolean}>} */ e) => {
                    return this.mobileOptOut(e.detail.remember).catch(console.error);
                }));
                ...
                drawer.addEventListener(DDGVideoDrawerMobile.OPT_IN, /** @type {EventListener} */ ((/** @type {CustomEvent<{remember: boolean}>} */ e) => {
                    return this.mobileOptIn(e.detail.remember, params).catch(console.error);
                }));
