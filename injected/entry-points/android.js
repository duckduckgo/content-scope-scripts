/**
 * @module Android integration (addDocumentStartJavaScript + addWebMessageListener)
 */
...
async function sendInitialPingAndUpdate(messagingConfig, processedConfig) {
    ...
    try {
        ...
        if (processedConfig.debug) {
            console.log('Android: Sending initial ping...');
        }
        ...
        if (processedConfig.debug) {
            console.error('Android: Initial ping failed:', error);
        }
    }
}
